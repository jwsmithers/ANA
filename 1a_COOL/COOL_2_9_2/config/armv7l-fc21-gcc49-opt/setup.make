...
#     use CoolKernel v*  (no_version_directory)
# use RelationalCool v*  (no_version_directory)
# use PyCool v*  (no_version_directory)
...
# use PyCoolUtilities v*  (no_version_directory)
#   use PyCool v*  (no_version_directory)
# use Examples v*  (no_version_directory)
#   use CoolKernel v*  (no_version_directory)
#   use CoolApplication v*  (no_version_directory)
# use CoolDBDiscovery v* Utilities (no_version_directory)
#   use CoolKernel v*  (no_version_directory)
# use ACE v* Utilities (no_version_directory)
#   use CoolApplication v*  (no_version_directory)
#   use Qt v* LCG_Interfaces (no_version_directory) (native_version=4.8.4)
#     use LCG_Configuration v*  (no_version_directory)
#     use LCG_Settings v*  (no_version_directory)
# use COOL v* LCG_Interfaces (no_version_directory) (native_version=COOL_2_9_4)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
#   use CORAL v* LCG_Interfaces (no_version_directory) (native_version=CORAL_2_4_4)
#   use Python v* LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=2.7.6)
#   use ROOT v* LCG_Interfaces (no_version_directory) (native_version=5.34.24)
#     use LCG_Configuration v*  (no_version_directory)
#     use LCG_Settings v*  (no_version_directory)
...
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
# use QMtest v* LCG_Interfaces (no_version_directory) (native_version=2.4.1_python2.7)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
...
use Qt v* LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use xrootd v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
...
use ROOT v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
...
use COOL v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
...
use CoolDBDiscovery v1 Utilities (/home/jwsmith/HDD/COOL/COOL_2_9_2)
use RelationalCool v1  (/home/jwsmith/HDD/COOL/COOL_2_9_2)
use CoolApplication v1  (/home/jwsmith/HDD/COOL/COOL_2_9_2)
use ACE v1 Utilities (/home/jwsmith/HDD/COOL/COOL_2_9_2)
use Examples v1  (/home/jwsmith/HDD/COOL/COOL_2_9_2)
use PyCool v1  (/home/jwsmith/HDD/COOL/COOL_2_9_2)
use PyCoolUtilities v1  (/home/jwsmith/HDD/COOL/COOL_2_9_2)
----------> tags
...
NEEDS_COOL_FACTORY (from package COOL) applied [config] activated config
NEEDS_PYCOOL (from package COOL) applied [config] activated config
----------> CMTPATH
