...
#cmt_local_tagfile = $(CoolApplication_tag).make
cmt_local_tagfile = $(bin)$(CoolApplication_tag).make
...
lcg_CoolApplication_extratags = -tag_add=target_lcg_CoolApplication
...
not_lcg_CoolApplicationcompile_dependencies = { n=0; for p in $?; do m=0; for d in $(lcg_CoolApplicationcompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
lcg_CoolApplicationdirs :
	@if test ! -d $(bin)lcg_CoolApplication; then $(mkdir) -p $(bin)lcg_CoolApplication; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)lcg_CoolApplication
else
lcg_CoolApplicationdirs : ;
endif
...
ifndef QUICK
$(cmt_local_lcg_CoolApplication_makefile) : $(lcg_CoolApplicationcompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_CoolApplication.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_CoolApplication_extratags) build constituent_config -out=$(cmt_local_lcg_CoolApplication_makefile) lcg_CoolApplication
else
$(cmt_local_lcg_CoolApplication_makefile) : $(lcg_CoolApplicationcompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_CoolApplication) ] || \
	  [ ! -f $(cmt_final_setup_lcg_CoolApplication) ] || \
	  $(not_lcg_CoolApplicationcompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building lcg_CoolApplication.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_CoolApplication_extratags) build constituent_config -out=$(cmt_local_lcg_CoolApplication_makefile) lcg_CoolApplication; \
	  fi
endif
...
$(cmt_local_lcg_CoolApplication_makefile) : $(lcg_CoolApplicationcompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_CoolApplication.make"; \
	  $(cmtexe) -f=$(bin)lcg_CoolApplication.in -tag=$(tags) $(lcg_CoolApplication_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_lcg_CoolApplication_makefile) lcg_CoolApplication
else
$(cmt_local_lcg_CoolApplication_makefile) : $(lcg_CoolApplicationcompile_dependencies) $(cmt_build_library_linksstamp) $(bin)lcg_CoolApplication.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_CoolApplication) ] || \
	  [ ! -f $(cmt_final_setup_lcg_CoolApplication) ] || \
	  $(not_lcg_CoolApplicationcompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(lcg_CoolApplication_extratags) build constituent_makefile -out=$(cmt_local_lcg_CoolApplication_makefile) lcg_CoolApplication

lcg_CoolApplication :: lcg_CoolApplicationcompile lcg_CoolApplicationinstall ;

ifdef cmt_lcg_CoolApplication_has_prototypes

lcg_CoolApplicationprototype : $(lcg_CoolApplicationprototype_dependencies) $(cmt_local_lcg_CoolApplication_makefile) dirs lcg_CoolApplicationdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_CoolApplication_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoolApplication_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_CoolApplication_makefile) $@
	$(echo) "(constituents.make) $@ done"

lcg_CoolApplicationcompile : lcg_CoolApplicationprototype

endif

lcg_CoolApplicationcompile : $(lcg_CoolApplicationcompile_dependencies) $(cmt_local_lcg_CoolApplication_makefile) dirs lcg_CoolApplicationdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_CoolApplication_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoolApplication_makefile) $@; \
	  fi
...
lcg_CoolApplicationclean :: $(lcg_CoolApplicationclean_dependencies) ##$(cmt_local_lcg_CoolApplication_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_CoolApplication_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoolApplication_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_lcg_CoolApplication_makefile) lcg_CoolApplicationclean

##	  /bin/rm -f $(cmt_local_lcg_CoolApplication_makefile) $(bin)lcg_CoolApplication_dependencies.make

install :: lcg_CoolApplicationinstall ;

lcg_CoolApplicationinstall :: lcg_CoolApplicationcompile $(lcg_CoolApplication_dependencies) $(cmt_local_lcg_CoolApplication_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_CoolApplication_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoolApplication_makefile) $@; \
	  fi
...
$(foreach d,$(lcg_CoolApplication_dependencies),$(eval $(d)uninstall_dependencies += lcg_CoolApplicationuninstall))

lcg_CoolApplicationuninstall : $(lcg_CoolApplicationuninstall_dependencies) ##$(cmt_local_lcg_CoolApplication_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_CoolApplication_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoolApplication_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_CoolApplication_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: lcg_CoolApplicationuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ lcg_CoolApplication"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ lcg_CoolApplication done"
endif
...
cmt_local_tagfile_install_includes = $(bin)$(CoolApplication_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(CoolApplication_tag).make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(CoolApplication_tag)_install_pythonmods.make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(CoolApplication_tag).make
...
cmt_local_tagfile_make = $(bin)$(CoolApplication_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(CoolApplication_tag).make
...
cmt_local_tagfile_tests = $(bin)$(CoolApplication_tag)_tests.make
...
cmt_local_tagfile_tests = $(bin)$(CoolApplication_tag).make
...
cmt_local_tagfile_utilities = $(bin)$(CoolApplication_tag)_utilities.make
...
cmt_local_tagfile_utilities = $(bin)$(CoolApplication_tag).make
...
cmt_local_tagfile_examples = $(bin)$(CoolApplication_tag)_examples.make
...
cmt_local_tagfile_examples = $(bin)$(CoolApplication_tag).make
