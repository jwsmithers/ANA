...
class TestChannels( unittest.TestCase ):
    ...
    def setUp(self):
        try:
            if self.spec is None:
                ...
                svMode = cool.FolderVersioning.SINGLE_VERSION
                self.fSpec = cool.FolderSpecification( svMode, self.spec )
    ...
    def test_all(self):
        ...
        self.assertEquals( self.dummyPayload( 1 ), obj.payload().attributeList() )
        # Test browseObject
