...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=CoolDBDiscovery -version=v1 -path=/home/jwsmith/HDD/COOL/COOL_2_9_2/Utilities  $* >${cmtCoolDBDiscoverytempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=CoolDBDiscovery -version=v1 -path=/home/jwsmith/HDD/COOL/COOL_2_9_2/Utilities  $* >${cmtCoolDBDiscoverytempfile}"
