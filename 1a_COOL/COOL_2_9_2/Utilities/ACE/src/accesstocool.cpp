...
//    cool::DatabaseId dbId("oracle://devdb10;schema=atlas_trig_dev;dbname=TEST");
    ...
    spec.extend("Bool",cool::StorageType::Bool);
    spec.extend("UChar",cool::StorageType::UChar);
    spec.extend("Int16",cool::StorageType::Int16);
    spec.extend("UInt16",cool::StorageType::UInt16);
    spec.extend("Int32",cool::StorageType::Int32);
    spec.extend("UInt32",cool::StorageType::UInt32);
    spec.extend("UInt63",cool::StorageType::UInt63);
    spec.extend("Int64",cool::StorageType::Int64);
    spec.extend("Float",cool::StorageType::Float);
    spec.extend("Double",cool::StorageType::Double);
    spec.extend("String255",cool::StorageType::String255);
    spec.extend("String4k",cool::StorageType::String4k);
    spec.extend("String64k",cool::StorageType::String64k);
    spec.extend("String16M",cool::StorageType::String16M);
    spec.extend("Blob64k",cool::StorageType::Blob64k);
    spec.extend("Blob16M",cool::StorageType::Blob16M);

    // Create folder
    FolderSpecification fSpec( FolderVersioning::MULTI_VERSION, spec );
