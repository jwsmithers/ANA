...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=RelationalCool -version=v1 -path=/home/jwsmith/HDD/COOL/COOL_2_9_2  $* >${cmtRelationalCooltempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=RelationalCool -version=v1 -path=/home/jwsmith/HDD/COOL/COOL_2_9_2  $* >${cmtRelationalCooltempfile}"
  cmtcleanupstatus=2
