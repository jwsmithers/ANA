// $Id: RelationalDatabase.cpp,v 1.223 2013-05-07 15:09:38 avalassi Exp $
...
#if defined(COOL300)
        // This release (3.0.0) can read 3.0.0
        ( db_rel_version == "3.0.0" ) ||
#endif
        // This release (2.9.2) can read 2.9.x
        ( db_rel_version >= "2.9.0" && db_rel_version <= "2.9.2" ) ||
#endif
