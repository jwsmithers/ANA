// $Id: RelationalObjectIterator.cpp,v 1.35 2012-06-29 15:30:49 avalassi Exp $
  ...
  , m_payloadMode( folder.payloadMode() )
{
  ...
  if ( m_pq.get() != 0  && m_payloadMode == PayloadMode::VECTORPAYLOAD )
...
bool RelationalObjectIterator::goToNext()
{
  ...
  else if ( m_payloadMode == PayloadMode::VECTORPAYLOAD )
  {
