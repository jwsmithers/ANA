...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=ConnectionService -version=ConnectionService-2-9-1 -path=/home/jwsmith/HDD/CORAL/CORAL-2-4-2  $* >${cmtConnectionServicetempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=ConnectionService -version=ConnectionService-2-9-1 -path=/home/jwsmith/HDD/CORAL/CORAL-2-4-2  $* >${cmtConnectionServicetempfile}"
  cmtcleanupstatus=2
