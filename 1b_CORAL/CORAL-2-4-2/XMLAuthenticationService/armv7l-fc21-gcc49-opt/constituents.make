...
#cmt_local_tagfile = $(XMLAuthenticationService_tag).make
cmt_local_tagfile = $(bin)$(XMLAuthenticationService_tag).make
...
lcg_XMLAuthenticationService_extratags = -tag_add=target_lcg_XMLAuthenticationService
...
not_lcg_XMLAuthenticationServicecompile_dependencies = { n=0; for p in $?; do m=0; for d in $(lcg_XMLAuthenticationServicecompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
lcg_XMLAuthenticationServicedirs :
	@if test ! -d $(bin)lcg_XMLAuthenticationService; then $(mkdir) -p $(bin)lcg_XMLAuthenticationService; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)lcg_XMLAuthenticationService
else
lcg_XMLAuthenticationServicedirs : ;
endif
...
ifndef QUICK
$(cmt_local_lcg_XMLAuthenticationService_makefile) : $(lcg_XMLAuthenticationServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_XMLAuthenticationService.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_XMLAuthenticationService_extratags) build constituent_config -out=$(cmt_local_lcg_XMLAuthenticationService_makefile) lcg_XMLAuthenticationService
else
$(cmt_local_lcg_XMLAuthenticationService_makefile) : $(lcg_XMLAuthenticationServicecompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_XMLAuthenticationService) ] || \
	  [ ! -f $(cmt_final_setup_lcg_XMLAuthenticationService) ] || \
	  $(not_lcg_XMLAuthenticationServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building lcg_XMLAuthenticationService.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_XMLAuthenticationService_extratags) build constituent_config -out=$(cmt_local_lcg_XMLAuthenticationService_makefile) lcg_XMLAuthenticationService; \
	  fi
endif
...
$(cmt_local_lcg_XMLAuthenticationService_makefile) : $(lcg_XMLAuthenticationServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_XMLAuthenticationService.make"; \
	  $(cmtexe) -f=$(bin)lcg_XMLAuthenticationService.in -tag=$(tags) $(lcg_XMLAuthenticationService_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_lcg_XMLAuthenticationService_makefile) lcg_XMLAuthenticationService
else
$(cmt_local_lcg_XMLAuthenticationService_makefile) : $(lcg_XMLAuthenticationServicecompile_dependencies) $(cmt_build_library_linksstamp) $(bin)lcg_XMLAuthenticationService.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_XMLAuthenticationService) ] || \
	  [ ! -f $(cmt_final_setup_lcg_XMLAuthenticationService) ] || \
	  $(not_lcg_XMLAuthenticationServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(lcg_XMLAuthenticationService_extratags) build constituent_makefile -out=$(cmt_local_lcg_XMLAuthenticationService_makefile) lcg_XMLAuthenticationService

lcg_XMLAuthenticationService :: lcg_XMLAuthenticationServicecompile lcg_XMLAuthenticationServiceinstall ;

ifdef cmt_lcg_XMLAuthenticationService_has_prototypes

lcg_XMLAuthenticationServiceprototype : $(lcg_XMLAuthenticationServiceprototype_dependencies) $(cmt_local_lcg_XMLAuthenticationService_makefile) dirs lcg_XMLAuthenticationServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_XMLAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_XMLAuthenticationService_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_XMLAuthenticationService_makefile) $@
	$(echo) "(constituents.make) $@ done"

lcg_XMLAuthenticationServicecompile : lcg_XMLAuthenticationServiceprototype

endif

lcg_XMLAuthenticationServicecompile : $(lcg_XMLAuthenticationServicecompile_dependencies) $(cmt_local_lcg_XMLAuthenticationService_makefile) dirs lcg_XMLAuthenticationServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_XMLAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_XMLAuthenticationService_makefile) $@; \
	  fi
...
lcg_XMLAuthenticationServiceclean :: $(lcg_XMLAuthenticationServiceclean_dependencies) ##$(cmt_local_lcg_XMLAuthenticationService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_XMLAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_XMLAuthenticationService_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_lcg_XMLAuthenticationService_makefile) lcg_XMLAuthenticationServiceclean

##	  /bin/rm -f $(cmt_local_lcg_XMLAuthenticationService_makefile) $(bin)lcg_XMLAuthenticationService_dependencies.make

install :: lcg_XMLAuthenticationServiceinstall ;

lcg_XMLAuthenticationServiceinstall :: lcg_XMLAuthenticationServicecompile $(lcg_XMLAuthenticationService_dependencies) $(cmt_local_lcg_XMLAuthenticationService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_XMLAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_XMLAuthenticationService_makefile) $@; \
	  fi
...
$(foreach d,$(lcg_XMLAuthenticationService_dependencies),$(eval $(d)uninstall_dependencies += lcg_XMLAuthenticationServiceuninstall))

lcg_XMLAuthenticationServiceuninstall : $(lcg_XMLAuthenticationServiceuninstall_dependencies) ##$(cmt_local_lcg_XMLAuthenticationService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_XMLAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_XMLAuthenticationService_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_XMLAuthenticationService_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: lcg_XMLAuthenticationServiceuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ lcg_XMLAuthenticationService"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ lcg_XMLAuthenticationService done"
endif

#-- end of constituent_app_lib ------
#-- start of constituent_app_lib ------

cmt_test_unit_XMLAuthenticationService_LoadService_has_no_target_tag = 1
cmt_test_unit_XMLAuthenticationService_LoadService_has_prototypes = 1

#--------------------------------------

ifdef cmt_test_unit_XMLAuthenticationService_LoadService_has_target_tag

cmt_local_tagfile_test_unit_XMLAuthenticationService_LoadService = $(bin)$(XMLAuthenticationService_tag)_test_unit_XMLAuthenticationService_LoadService.make
cmt_final_setup_test_unit_XMLAuthenticationService_LoadService = $(bin)setup_test_unit_XMLAuthenticationService_LoadService.make
cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile = $(bin)test_unit_XMLAuthenticationService_LoadService.make

test_unit_XMLAuthenticationService_LoadService_extratags = -tag_add=target_test_unit_XMLAuthenticationService_LoadService

else

cmt_local_tagfile_test_unit_XMLAuthenticationService_LoadService = $(bin)$(XMLAuthenticationService_tag).make
cmt_final_setup_test_unit_XMLAuthenticationService_LoadService = $(bin)setup.make
cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile = $(bin)test_unit_XMLAuthenticationService_LoadService.make

endif

not_test_unit_XMLAuthenticationService_LoadServicecompile_dependencies = { n=0; for p in $?; do m=0; for d in $(test_unit_XMLAuthenticationService_LoadServicecompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
test_unit_XMLAuthenticationService_LoadServicedirs :
	@if test ! -d $(bin)test_unit_XMLAuthenticationService_LoadService; then $(mkdir) -p $(bin)test_unit_XMLAuthenticationService_LoadService; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)test_unit_XMLAuthenticationService_LoadService
else
test_unit_XMLAuthenticationService_LoadServicedirs : ;
endif
...
ifndef QUICK
$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) : $(test_unit_XMLAuthenticationService_LoadServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_XMLAuthenticationService_LoadService.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_XMLAuthenticationService_LoadService_extratags) build constituent_config -out=$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) test_unit_XMLAuthenticationService_LoadService
else
$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) : $(test_unit_XMLAuthenticationService_LoadServicecompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_XMLAuthenticationService_LoadService) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_XMLAuthenticationService_LoadService) ] || \
	  $(not_test_unit_XMLAuthenticationService_LoadServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building test_unit_XMLAuthenticationService_LoadService.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_XMLAuthenticationService_LoadService_extratags) build constituent_config -out=$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) test_unit_XMLAuthenticationService_LoadService; \
	  fi
endif
...
$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) : $(test_unit_XMLAuthenticationService_LoadServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_XMLAuthenticationService_LoadService.make"; \
	  $(cmtexe) -f=$(bin)test_unit_XMLAuthenticationService_LoadService.in -tag=$(tags) $(test_unit_XMLAuthenticationService_LoadService_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) test_unit_XMLAuthenticationService_LoadService
else
$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) : $(test_unit_XMLAuthenticationService_LoadServicecompile_dependencies) $(cmt_build_library_linksstamp) $(bin)test_unit_XMLAuthenticationService_LoadService.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_XMLAuthenticationService_LoadService) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_XMLAuthenticationService_LoadService) ] || \
	  $(not_test_unit_XMLAuthenticationService_LoadServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(test_unit_XMLAuthenticationService_LoadService_extratags) build constituent_makefile -out=$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) test_unit_XMLAuthenticationService_LoadService

test_unit_XMLAuthenticationService_LoadService :: test_unit_XMLAuthenticationService_LoadServicecompile test_unit_XMLAuthenticationService_LoadServiceinstall ;

ifdef cmt_test_unit_XMLAuthenticationService_LoadService_has_prototypes

test_unit_XMLAuthenticationService_LoadServiceprototype : $(test_unit_XMLAuthenticationService_LoadServiceprototype_dependencies) $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) dirs test_unit_XMLAuthenticationService_LoadServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) $@
	$(echo) "(constituents.make) $@ done"

test_unit_XMLAuthenticationService_LoadServicecompile : test_unit_XMLAuthenticationService_LoadServiceprototype

endif

test_unit_XMLAuthenticationService_LoadServicecompile : $(test_unit_XMLAuthenticationService_LoadServicecompile_dependencies) $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) dirs test_unit_XMLAuthenticationService_LoadServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) $@; \
	  fi
...
clean :: test_unit_XMLAuthenticationService_LoadServiceclean ;

test_unit_XMLAuthenticationService_LoadServiceclean :: $(test_unit_XMLAuthenticationService_LoadServiceclean_dependencies) ##$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) test_unit_XMLAuthenticationService_LoadServiceclean

##	  /bin/rm -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) $(bin)test_unit_XMLAuthenticationService_LoadService_dependencies.make

install :: test_unit_XMLAuthenticationService_LoadServiceinstall ;

test_unit_XMLAuthenticationService_LoadServiceinstall :: test_unit_XMLAuthenticationService_LoadServicecompile $(test_unit_XMLAuthenticationService_LoadService_dependencies) $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) $@; \
	  fi
...
uninstall : test_unit_XMLAuthenticationService_LoadServiceuninstall

$(foreach d,$(test_unit_XMLAuthenticationService_LoadService_dependencies),$(eval $(d)uninstall_dependencies += test_unit_XMLAuthenticationService_LoadServiceuninstall))

test_unit_XMLAuthenticationService_LoadServiceuninstall : $(test_unit_XMLAuthenticationService_LoadServiceuninstall_dependencies) ##$(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_XMLAuthenticationService_LoadService_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: test_unit_XMLAuthenticationService_LoadServiceuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ test_unit_XMLAuthenticationService_LoadService"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ test_unit_XMLAuthenticationService_LoadService done"
endif
...
cmt_local_tagfile_install_includes = $(bin)$(XMLAuthenticationService_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(XMLAuthenticationService_tag).make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(XMLAuthenticationService_tag)_install_pythonmods.make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(XMLAuthenticationService_tag).make
...
cmt_local_tagfile_make = $(bin)$(XMLAuthenticationService_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(XMLAuthenticationService_tag).make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(XMLAuthenticationService_tag)_lcg_mkdir.make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(XMLAuthenticationService_tag).make
...
cmt_local_tagfile_utilities = $(bin)$(XMLAuthenticationService_tag)_utilities.make
...
cmt_local_tagfile_utilities = $(bin)$(XMLAuthenticationService_tag).make
...
cmt_local_tagfile_examples = $(bin)$(XMLAuthenticationService_tag)_examples.make
...
cmt_local_tagfile_examples = $(bin)$(XMLAuthenticationService_tag).make
