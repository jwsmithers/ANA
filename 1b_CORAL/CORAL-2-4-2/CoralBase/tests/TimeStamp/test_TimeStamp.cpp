...
int main( int, char** )
{
  try
  {
    ...
    std::cout << "1. CORAL Nanoseconds from epoch should be 123456789 ns and is " << epoch123456789.total_nanoseconds()
              << " ns " << std::endl; // The result depends on the platform precision compiled in BOOST
