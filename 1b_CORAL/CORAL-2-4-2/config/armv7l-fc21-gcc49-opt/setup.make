----------> uses
# use CoralBase *  (no_version_directory)
...
# use RelationalAccess *  (no_version_directory)
#   use CoralBase v*  (no_version_directory)
# use CoralKernel *  (no_version_directory)
#   use CoralBase v*  (no_version_directory)
# use CoralCommon *  (no_version_directory)
#   use CoralKernel v*  (no_version_directory)
#   use RelationalAccess v*  (no_version_directory)
# use PyCoral *  (no_version_directory)
# use ConnectionService *  (no_version_directory)
# use RelationalService *  (no_version_directory)
# use MonitoringService *  (no_version_directory)
# use XMLAuthenticationService *  (no_version_directory)
# use EnvironmentAuthenticationService *  (no_version_directory)
# use XMLLookupService *  (no_version_directory)
# use OracleAccess *  (no_version_directory)
# use MySQLAccess *  (no_version_directory)
# use SQLiteAccess *  (no_version_directory)
# use FrontierAccess *  (no_version_directory)
# use Tests *  (no_version_directory)
...
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
# use Frontier_Client v* LCG_Interfaces (no_version_directory) (native_version=2.8.10)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
#   use Expat v* LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=2.0.1)
#     use LCG_Configuration v*  (no_version_directory)
#     use LCG_Settings v*  (no_version_directory)
# use CppUnit v* LCG_Interfaces (no_version_directory) (native_version=1.12.1_p1)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
# use QMtest * LCG_Interfaces (no_version_directory) (native_version=2.4.1_python2.7)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
...
#     use LCG_Settings v*  (no_version_directory)
#   use CppUnit v* LCG_Interfaces (no_version_directory) (native_version=1.12.1_p1)
# use valgrind * LCG_Interfaces (no_version_directory) (native_version=3.10.0)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
# use igprof * LCG_Interfaces (no_version_directory) (native_version=5.9.11)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
#   use libunwind v* LCG_Interfaces (no_version_directory) (native_version=5c2cade)
#     use LCG_Configuration v*  (no_version_directory)
#     use LCG_Settings v*  (no_version_directory)
# use tcmalloc * LCG_Interfaces (no_version_directory) (native_version=1.7p3)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
#   use libunwind v* LCG_Interfaces (no_version_directory) (native_version=5c2cade)
#
...
use Tests CoralTests-0-0-3  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use FrontierAccess FrontierAccess-1-8-1  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use SQLiteAccess SQLiteAccess-1-7-0  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use MySQLAccess MySQLAccess-1-7-2  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use OracleAccess OracleAccess-1-7-3  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use XMLLookupService XMLLookupService-1-1-X-back  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use EnvironmentAuthenticationService EnvironmentAuthenticationService-1-2-0  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use XMLAuthenticationService XMLAuthenticationService-1-2-X-back  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use MonitoringService MonitoringService-1-1-0  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use RelationalService RelationalService-1-1-0  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use ConnectionService ConnectionService-2-9-1  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use PyCoral PyCoral-1-1-1  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
...
use libunwind v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use tcmalloc v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use igprof v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use valgrind v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use CppUnit v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use Expat v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71) (no_auto_imports)
use Frontier_Client v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use sqlite v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use mysql v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use oracle v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use XercesC v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use uuid v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use Python v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
use QMtest v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71)
...
use CoralCommon CoralCommon-1-6-X-back  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
----------> tags
...
jwsmith_without_installarea (from PROJECT) excludes [jwsmith_with_installarea]
