...
#cmt_local_tagfile = $(MonitoringService_tag).make
cmt_local_tagfile = $(bin)$(MonitoringService_tag).make
...
lcg_MonitoringService_extratags = -tag_add=target_lcg_MonitoringService
...
not_lcg_MonitoringServicecompile_dependencies = { n=0; for p in $?; do m=0; for d in $(lcg_MonitoringServicecompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
lcg_MonitoringServicedirs :
	@if test ! -d $(bin)lcg_MonitoringService; then $(mkdir) -p $(bin)lcg_MonitoringService; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)lcg_MonitoringService
else
lcg_MonitoringServicedirs : ;
endif
...
ifndef QUICK
$(cmt_local_lcg_MonitoringService_makefile) : $(lcg_MonitoringServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_MonitoringService.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_MonitoringService_extratags) build constituent_config -out=$(cmt_local_lcg_MonitoringService_makefile) lcg_MonitoringService
else
$(cmt_local_lcg_MonitoringService_makefile) : $(lcg_MonitoringServicecompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_MonitoringService) ] || \
	  [ ! -f $(cmt_final_setup_lcg_MonitoringService) ] || \
	  $(not_lcg_MonitoringServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building lcg_MonitoringService.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_MonitoringService_extratags) build constituent_config -out=$(cmt_local_lcg_MonitoringService_makefile) lcg_MonitoringService; \
	  fi
endif
...
$(cmt_local_lcg_MonitoringService_makefile) : $(lcg_MonitoringServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_MonitoringService.make"; \
	  $(cmtexe) -f=$(bin)lcg_MonitoringService.in -tag=$(tags) $(lcg_MonitoringService_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_lcg_MonitoringService_makefile) lcg_MonitoringService
else
$(cmt_local_lcg_MonitoringService_makefile) : $(lcg_MonitoringServicecompile_dependencies) $(cmt_build_library_linksstamp) $(bin)lcg_MonitoringService.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_MonitoringService) ] || \
	  [ ! -f $(cmt_final_setup_lcg_MonitoringService) ] || \
	  $(not_lcg_MonitoringServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(lcg_MonitoringService_extratags) build constituent_makefile -out=$(cmt_local_lcg_MonitoringService_makefile) lcg_MonitoringService

lcg_MonitoringService :: lcg_MonitoringServicecompile lcg_MonitoringServiceinstall ;

ifdef cmt_lcg_MonitoringService_has_prototypes

lcg_MonitoringServiceprototype : $(lcg_MonitoringServiceprototype_dependencies) $(cmt_local_lcg_MonitoringService_makefile) dirs lcg_MonitoringServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_MonitoringService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_MonitoringService_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_MonitoringService_makefile) $@
	$(echo) "(constituents.make) $@ done"

lcg_MonitoringServicecompile : lcg_MonitoringServiceprototype

endif

lcg_MonitoringServicecompile : $(lcg_MonitoringServicecompile_dependencies) $(cmt_local_lcg_MonitoringService_makefile) dirs lcg_MonitoringServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_MonitoringService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_MonitoringService_makefile) $@; \
	  fi
...
lcg_MonitoringServiceclean :: $(lcg_MonitoringServiceclean_dependencies) ##$(cmt_local_lcg_MonitoringService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_MonitoringService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_MonitoringService_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_lcg_MonitoringService_makefile) lcg_MonitoringServiceclean

##	  /bin/rm -f $(cmt_local_lcg_MonitoringService_makefile) $(bin)lcg_MonitoringService_dependencies.make

install :: lcg_MonitoringServiceinstall ;

lcg_MonitoringServiceinstall :: lcg_MonitoringServicecompile $(lcg_MonitoringService_dependencies) $(cmt_local_lcg_MonitoringService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_MonitoringService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_MonitoringService_makefile) $@; \
	  fi
...
$(foreach d,$(lcg_MonitoringService_dependencies),$(eval $(d)uninstall_dependencies += lcg_MonitoringServiceuninstall))

lcg_MonitoringServiceuninstall : $(lcg_MonitoringServiceuninstall_dependencies) ##$(cmt_local_lcg_MonitoringService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_MonitoringService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_MonitoringService_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_MonitoringService_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: lcg_MonitoringServiceuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ lcg_MonitoringService"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ lcg_MonitoringService done"
endif

#-- end of constituent_app_lib ------
#-- start of constituent_app_lib ------

cmt_test_unit_MonitoringService_Report_has_no_target_tag = 1
cmt_test_unit_MonitoringService_Report_has_prototypes = 1

#--------------------------------------

ifdef cmt_test_unit_MonitoringService_Report_has_target_tag

cmt_local_tagfile_test_unit_MonitoringService_Report = $(bin)$(MonitoringService_tag)_test_unit_MonitoringService_Report.make
cmt_final_setup_test_unit_MonitoringService_Report = $(bin)setup_test_unit_MonitoringService_Report.make
cmt_local_test_unit_MonitoringService_Report_makefile = $(bin)test_unit_MonitoringService_Report.make

test_unit_MonitoringService_Report_extratags = -tag_add=target_test_unit_MonitoringService_Report

else

cmt_local_tagfile_test_unit_MonitoringService_Report = $(bin)$(MonitoringService_tag).make
cmt_final_setup_test_unit_MonitoringService_Report = $(bin)setup.make
cmt_local_test_unit_MonitoringService_Report_makefile = $(bin)test_unit_MonitoringService_Report.make

endif

not_test_unit_MonitoringService_Reportcompile_dependencies = { n=0; for p in $?; do m=0; for d in $(test_unit_MonitoringService_Reportcompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
test_unit_MonitoringService_Reportdirs :
	@if test ! -d $(bin)test_unit_MonitoringService_Report; then $(mkdir) -p $(bin)test_unit_MonitoringService_Report; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)test_unit_MonitoringService_Report
else
test_unit_MonitoringService_Reportdirs : ;
endif
...
ifndef QUICK
$(cmt_local_test_unit_MonitoringService_Report_makefile) : $(test_unit_MonitoringService_Reportcompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_MonitoringService_Report.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_MonitoringService_Report_extratags) build constituent_config -out=$(cmt_local_test_unit_MonitoringService_Report_makefile) test_unit_MonitoringService_Report
else
$(cmt_local_test_unit_MonitoringService_Report_makefile) : $(test_unit_MonitoringService_Reportcompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_MonitoringService_Report) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_MonitoringService_Report) ] || \
	  $(not_test_unit_MonitoringService_Reportcompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building test_unit_MonitoringService_Report.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_MonitoringService_Report_extratags) build constituent_config -out=$(cmt_local_test_unit_MonitoringService_Report_makefile) test_unit_MonitoringService_Report; \
	  fi
endif
...
$(cmt_local_test_unit_MonitoringService_Report_makefile) : $(test_unit_MonitoringService_Reportcompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_MonitoringService_Report.make"; \
	  $(cmtexe) -f=$(bin)test_unit_MonitoringService_Report.in -tag=$(tags) $(test_unit_MonitoringService_Report_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_test_unit_MonitoringService_Report_makefile) test_unit_MonitoringService_Report
else
$(cmt_local_test_unit_MonitoringService_Report_makefile) : $(test_unit_MonitoringService_Reportcompile_dependencies) $(cmt_build_library_linksstamp) $(bin)test_unit_MonitoringService_Report.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_MonitoringService_Report) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_MonitoringService_Report) ] || \
	  $(not_test_unit_MonitoringService_Reportcompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(test_unit_MonitoringService_Report_extratags) build constituent_makefile -out=$(cmt_local_test_unit_MonitoringService_Report_makefile) test_unit_MonitoringService_Report

test_unit_MonitoringService_Report :: test_unit_MonitoringService_Reportcompile test_unit_MonitoringService_Reportinstall ;

ifdef cmt_test_unit_MonitoringService_Report_has_prototypes

test_unit_MonitoringService_Reportprototype : $(test_unit_MonitoringService_Reportprototype_dependencies) $(cmt_local_test_unit_MonitoringService_Report_makefile) dirs test_unit_MonitoringService_Reportdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_MonitoringService_Report_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_MonitoringService_Report_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_MonitoringService_Report_makefile) $@
	$(echo) "(constituents.make) $@ done"

test_unit_MonitoringService_Reportcompile : test_unit_MonitoringService_Reportprototype

endif

test_unit_MonitoringService_Reportcompile : $(test_unit_MonitoringService_Reportcompile_dependencies) $(cmt_local_test_unit_MonitoringService_Report_makefile) dirs test_unit_MonitoringService_Reportdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_MonitoringService_Report_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_MonitoringService_Report_makefile) $@; \
	  fi
...
clean :: test_unit_MonitoringService_Reportclean ;

test_unit_MonitoringService_Reportclean :: $(test_unit_MonitoringService_Reportclean_dependencies) ##$(cmt_local_test_unit_MonitoringService_Report_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_MonitoringService_Report_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_MonitoringService_Report_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_test_unit_MonitoringService_Report_makefile) test_unit_MonitoringService_Reportclean

##	  /bin/rm -f $(cmt_local_test_unit_MonitoringService_Report_makefile) $(bin)test_unit_MonitoringService_Report_dependencies.make

install :: test_unit_MonitoringService_Reportinstall ;

test_unit_MonitoringService_Reportinstall :: test_unit_MonitoringService_Reportcompile $(test_unit_MonitoringService_Report_dependencies) $(cmt_local_test_unit_MonitoringService_Report_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_MonitoringService_Report_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_MonitoringService_Report_makefile) $@; \
	  fi
...
uninstall : test_unit_MonitoringService_Reportuninstall

$(foreach d,$(test_unit_MonitoringService_Report_dependencies),$(eval $(d)uninstall_dependencies += test_unit_MonitoringService_Reportuninstall))

test_unit_MonitoringService_Reportuninstall : $(test_unit_MonitoringService_Reportuninstall_dependencies) ##$(cmt_local_test_unit_MonitoringService_Report_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_MonitoringService_Report_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_MonitoringService_Report_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_MonitoringService_Report_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: test_unit_MonitoringService_Reportuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ test_unit_MonitoringService_Report"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ test_unit_MonitoringService_Report done"
endif
...
cmt_local_tagfile_install_includes = $(bin)$(MonitoringService_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(MonitoringService_tag).make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(MonitoringService_tag)_install_pythonmods.make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(MonitoringService_tag).make
...
cmt_local_tagfile_make = $(bin)$(MonitoringService_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(MonitoringService_tag).make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(MonitoringService_tag)_lcg_mkdir.make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(MonitoringService_tag).make
...
cmt_local_tagfile_utilities = $(bin)$(MonitoringService_tag)_utilities.make
...
cmt_local_tagfile_utilities = $(bin)$(MonitoringService_tag).make
...
cmt_local_tagfile_examples = $(bin)$(MonitoringService_tag)_examples.make
...
cmt_local_tagfile_examples = $(bin)$(MonitoringService_tag).make
