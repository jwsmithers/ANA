...
MonitoringService_cmtpath=/home/jwsmith/HDD
MonitoringService_offset=CORAL/CORAL-2-4-2
MonitoringService_project=jwsmith
MonitoringService_project_release=HDD
CoralCommon_tag=$(tag)
...
use_cppflags=  $(MonitoringService_cppflags)  $(CoralCommon_cppflags)  $(CoralKernel_cppflags)  $(RelationalAccess_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
lcg_MonitoringService_shlibflags=$(libraryshr_linkopts) $(use_linkopts) 
...
constituents= lcg_MonitoringService install_includes install_pythonmods 
tests_constituents=lcg_mkdir  test_unit_MonitoringService_Report 
test_unit_MonitoringService_Report_dependencies=lcg_mkdir
test_unit_MonitoringService_Reportlinkopts= $(MonitoringService_linkopts) $(MonitoringService_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
run_install_pythonmods=do_install_pythonmods
tag=armv7l-fc21-gcc49-opt
package=MonitoringService
version=MonitoringService-1-1-0
PACKAGE_ROOT=$(MONITORINGSERVICEROOT)
srcdir=../src
bin=../$(MonitoringService_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/MonitoringService/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_stamps=  $(MonitoringService_stamps)  $(CoralCommon_stamps)  $(CoralKernel_stamps)  $(RelationalAccess_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(MonitoringService_cflags)  $(CoralCommon_cflags)  $(CoralKernel_cflags)  $(RelationalAccess_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(MonitoringService_pp_cflags)  $(CoralCommon_pp_cflags)  $(CoralKernel_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(MonitoringService_pp_cppflags)  $(CoralCommon_pp_cppflags)  $(CoralKernel_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(MonitoringService_fflags)  $(CoralCommon_fflags)  $(CoralKernel_fflags)  $(RelationalAccess_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(MonitoringService_pp_fflags)  $(CoralCommon_pp_fflags)  $(CoralKernel_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
...
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/MonitoringService" $(use_includes)
fincludes= $(includes)
lcg_MonitoringService_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lcg_MonitoringService_use_linkopts=  $(MonitoringService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
test_unit_MonitoringService_Report_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_MonitoringService_Report_use_linkopts=  $(MonitoringService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_MonitoringServiceclean 
...
tests_constituentsclean= test_unit_MonitoringService_Reportclean 
lcg_MonitoringServiceprototype_dependencies= $(lcg_MonitoringServicecompile_dependencies)
test_unit_MonitoringService_Reportcompile_dependencies= lcg_mkdir
test_unit_MonitoringService_Reportprototype_dependencies= $(test_unit_MonitoringService_Reportcompile_dependencies)
