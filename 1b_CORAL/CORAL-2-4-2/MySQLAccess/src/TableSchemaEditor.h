// $Id: TableSchemaEditor.h,v 1.12 2012-06-20 15:36:01 avalassi Exp $
...
namespace coral
{
  ...
  namespace MySQLAccess
  {
    ...
    public:
       ...
       * Constructor
       *///
      TableSchemaEditor( const std::string& tableName, boost::shared_ptr<const SessionProperties> sessionProperties, ISchemaProperties& schemaProperties, bool refresh=true );
    ...
    private:
      ...
      TableSchemaEditor( const TableSchemaEditor& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      TableSchemaEditor& operator=( const TableSchemaEditor& rhs );
