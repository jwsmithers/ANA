// $Id: TableSchemaEditor.cpp,v 1.32 2012-06-26 14:59:05 avalassi Exp $
...
namespace coral
{
  ...
  {
    TableSchemaEditor::TableSchemaEditor( const std::string& tableName, boost::shared_ptr<const SessionProperties> sessionProperties, ISchemaProperties& schemaProperties, bool refresh /*=true*/ )
    ...
    void TableSchemaEditor::insertColumn( const std::string& name, const std::string& type, int size /*= 0*/, bool fixedSize /*= true*/, std::string /*tableSpaceName = ""*/ )
    {
      ...
      if( mysql_query( m_sessionProperties->connectionHandle(), sql.c_str() ) )
      {
        ...
        throw coral::SessionException( errorHandler.message(), "MySQLAccess::TableSchemaEditor", m_sessionProperties->domainServiceName() );
      }
    }
    ...
    unsigned int TableSchemaEditor::checkEnvClobPrefixLength() const
    {
      ...
      // Fix Coverity SECURE_CODING (bug #95678):
      // drop support for CORAL_MYSQL_CLOB_PREFIX_LEN
      /*
