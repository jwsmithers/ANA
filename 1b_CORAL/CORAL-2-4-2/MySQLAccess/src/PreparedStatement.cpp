// $Id: PreparedStatement.cpp,v 1.19 2012-03-06 16:56:49 avalassi Exp $
...
namespace coral
{
  ...
  {
    PreparedStatement::PreparedStatement( const SessionProperties& sessionProperties, const std::string& sql )
    ...
    void PreparedStatement::prepare( const std::string& sqlStatement="" )
    {
      ...
      if( (m_preparedSqlStatement = mysql_stmt_init( m_sessionProperties.connectionHandle())) == 0 )
      {
        ...
        throw coral::SessionException( "Out of memory!" , "MySQLAccess::PreparedStatement", m_sessionProperties.domainServiceName() );
      }
      ...
      if( mysql_stmt_prepare( m_preparedSqlStatement, m_markedSqlStatement.c_str(), m_markedSqlStatement.size() ) )
      {
        ...
        throw coral::SessionException( errHandler.stmtMessage() , "MySQLAccess::PreparedStatement", m_sessionProperties.domainServiceName() );
      }
#endif
