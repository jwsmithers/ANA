// $Id: Statement.h,v 1.12 2012-06-26 14:27:07 avalassi Exp $
#ifndef CORAL_MYSQLACCESS_STATEMENT_H
#define CORAL_MYSQLACCESS_STATEMENT_H 1
...
namespace coral
{
  ...
  namespace MySQLAccess
  {
    ...
    public:
       ...
       *///
      Statement( boost::shared_ptr<const SessionProperties>, const std::string&  );
       ...
       * Throws in case of errors (fix Coverity CHECKED_RETURN bug #95676)
       *///
      void execute( const coral::AttributeList& );
