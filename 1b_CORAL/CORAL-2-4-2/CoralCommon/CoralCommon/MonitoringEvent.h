// -*- C++ -*-
// $Id: MonitoringEvent.h,v 1.9 2012-10-10 16:43:58 avalassi Exp $
  ...
  namespace monitor
  {
    namespace Event
    {
      ...
      public:
        ...
        virtual Payload* clone() const = 0; // fix bug #98081
      };
      ...
      public:
        ...
        Payload* clone() const // fix bug #98081
        {
          return new RealPayload( m_data );
        }        
