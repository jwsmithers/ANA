...
namespace coral
{
  ...
  namespace OracleAccess
  {
    ...
    public:
       ...
       * [The failOutsideTx flag is only needed for ORA-01466 bug #87935...]
       *
       *///
      bool fetchNext( bool failOutsideTx=true );
    ...
    private:
      ...
      OracleStatement( const OracleStatement& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      OracleStatement& operator=( const OracleStatement& rhs );
