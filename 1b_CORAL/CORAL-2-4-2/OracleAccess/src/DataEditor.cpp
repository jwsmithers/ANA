  ...
  m_tableDescription( description )
{
  ...
  std::cout << "Create DataEditor " << this << std::endl; // debug bug #98736
#endif
}


coral::OracleAccess::DataEditor::~DataEditor()
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Delete DataEditor " << this << std::endl; // debug bug #98736
#endif
}
