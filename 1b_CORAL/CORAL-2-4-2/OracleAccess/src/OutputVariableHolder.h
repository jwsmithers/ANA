...
namespace coral
{
  ...
  namespace OracleAccess
  {
    ...
    private:
      ...
      OutputVariableHolder( const OutputVariableHolder& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      OutputVariableHolder& operator=( const OutputVariableHolder& rhs );
    ...
    template<> inline ub2 OutputVariableHolder<float>::dty() const { return (m_sessionProperties->majorServerVersion() > 9) ? SQLT_BFLOAT : SQLT_FLT; }
    template<> inline ub2 OutputVariableHolder<double>::dty() const { return (m_sessionProperties->majorServerVersion() > 9) ? SQLT_BDOUBLE : SQLT_FLT; }
    template<> inline ub2 OutputVariableHolder<long double>::dty() const { return (m_sessionProperties->majorServerVersion() > 9) ? SQLT_BDOUBLE : SQLT_FLT; }
    ...
    private:
      ...
      /// Copy constructor is private (fix Coverity MISSING_COPY)
      DateOutputVariableHolder( const DateOutputVariableHolder& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      DateOutputVariableHolder& operator=( const DateOutputVariableHolder& rhs );
    ...
    private:
      ...
      /// Copy constructor is private (fix Coverity MISSING_COPY)
      TimeOutputVariableHolder( const TimeOutputVariableHolder& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      TimeOutputVariableHolder& operator=( const TimeOutputVariableHolder& rhs );
    ...
    private:
      ...
      /// Copy constructor is private (fix Coverity MISSING_COPY)
      NumberOutputVariableHolder( const NumberOutputVariableHolder& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      NumberOutputVariableHolder& operator=( const NumberOutputVariableHolder& rhs );
    ...
    private:
      ...
      /// Copy constructor is private (fix Coverity MISSING_COPY)
      BlobOutputVariableHolder( const BlobOutputVariableHolder& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      BlobOutputVariableHolder& operator=( const BlobOutputVariableHolder& rhs );
    ...
    private:
      ...
      /// Copy constructor is private (fix Coverity MISSING_COPY)
      ClobOutputVariableHolder( const ClobOutputVariableHolder& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      ClobOutputVariableHolder& operator=( const ClobOutputVariableHolder& rhs );
    ...
    private:
      ...
      /// Copy constructor is private (fix Coverity MISSING_COPY)
      StringOutputVariableHolder( const StringOutputVariableHolder& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      StringOutputVariableHolder& operator=( const StringOutputVariableHolder& rhs );
    ...
    private:
      ...
      /// Copy constructor is private (fix Coverity MISSING_COPY)
      LongStringOutputVariableHolder( const LongStringOutputVariableHolder& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      LongStringOutputVariableHolder& operator=( const LongStringOutputVariableHolder& rhs );
