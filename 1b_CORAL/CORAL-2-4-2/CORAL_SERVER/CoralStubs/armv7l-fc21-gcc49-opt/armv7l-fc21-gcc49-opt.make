...
CoralStubs_tag=$(tag)
CORALSTUBSROOT=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralStubs
CoralStubs_root=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralStubs
CORALSTUBSVERSION=v1
CoralStubs_cmtpath=/home/jwsmith/HDD
CoralStubs_offset=CORAL/CORAL-2-4-2/CORAL_SERVER
CoralStubs_project=jwsmith
CoralStubs_project_release=HDD
CoralCommon_tag=$(tag)
...
use_cppflags=  $(CoralStubs_cppflags)  $(CoralCommon_cppflags)  $(CoralKernel_cppflags)  $(CoralServerBase_cppflags)  $(RelationalAccess_cppflags)  $(CoralMonitor_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
CoralStubs_linkopts= -llcg_CoralStubs 
lcg_CoralStubs_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(lcg_CoralStubs_use_linkopts) 
lcg_CoralStubs_use_linkopts=    $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
constituents= lcg_CoralStubs  install_pythonmods 
CppUnit_tag=$(tag)
...
tests_constituents=lcg_mkdir lcg_mkdir lcg_mkdir  test_unit_CoralStubs_AllParts test_unit_CoralStubs_RequestHandler test_unit_CoralStubs_StreamBuffer 
test_unit_CoralStubs_AllParts_dependencies=lcg_mkdir
test_unit_CoralStubs_AllPartslinkopts= $(CoralStubs_linkopts) $(CoralStubs_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
test_unit_CoralStubs_RequestHandler_dependencies=lcg_mkdir
test_unit_CoralStubs_RequestHandlerlinkopts= $(CoralStubs_linkopts) $(CoralStubs_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
test_unit_CoralStubs_StreamBuffer_dependencies=lcg_mkdir
test_unit_CoralStubs_StreamBufferlinkopts= $(CoralStubs_linkopts) $(CoralStubs_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
run_install_pythonmods=do_install_pythonmods
tag=armv7l-fc21-gcc49-opt
package=CoralStubs
version=v1
PACKAGE_ROOT=$(CORALSTUBSROOT)
srcdir=../src
bin=../$(CoralStubs_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralStubs/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_linkopts= $(cmt_installarea_linkopts)   $(CoralStubs_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(CoralStubs_stamps)  $(CoralCommon_stamps)  $(CoralKernel_stamps)  $(CoralServerBase_stamps)  $(RelationalAccess_stamps)  $(CoralMonitor_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(CoralStubs_cflags)  $(CoralCommon_cflags)  $(CoralKernel_cflags)  $(CoralServerBase_cflags)  $(RelationalAccess_cflags)  $(CoralMonitor_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(CoralStubs_pp_cflags)  $(CoralCommon_pp_cflags)  $(CoralKernel_pp_cflags)  $(CoralServerBase_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralMonitor_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(CoralStubs_pp_cppflags)  $(CoralCommon_pp_cppflags)  $(CoralKernel_pp_cppflags)  $(CoralServerBase_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralMonitor_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(CoralStubs_fflags)  $(CoralCommon_fflags)  $(CoralKernel_fflags)  $(CoralServerBase_fflags)  $(RelationalAccess_fflags)  $(CoralMonitor_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(CoralStubs_pp_fflags)  $(CoralCommon_pp_fflags)  $(CoralKernel_pp_fflags)  $(CoralServerBase_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralMonitor_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(CoralCommon_libraries)  $(CoralKernel_libraries)  $(CoralServerBase_libraries)  $(RelationalAccess_libraries)  $(CoralMonitor_libraries)  $(CoralBase_libraries)  $(LCG_Policy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(CppUnit_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralStubs" $(use_includes)
fincludes= $(includes)
lcg_CoralStubs_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralStubs_AllParts_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralStubs_AllParts_use_linkopts=  $(CoralStubs_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_unit_CoralStubs_AllParts_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_unit_CoralStubs_AllParts_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_unit_CoralStubs_AllParts_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_unit_CoralStubs_AllParts_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_unit_CoralStubs_AllParts_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_unit_CoralStubs_AllParts_pp_fflags=  $(CppUnit_pp_fflags) 
test_unit_CoralStubs_AllParts_stamps=  $(CppUnit_stamps) 
test_unit_CoralStubs_RequestHandler_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralStubs_RequestHandler_use_linkopts=  $(CoralStubs_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_unit_CoralStubs_RequestHandler_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_unit_CoralStubs_RequestHandler_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_unit_CoralStubs_RequestHandler_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_unit_CoralStubs_RequestHandler_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_unit_CoralStubs_RequestHandler_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_unit_CoralStubs_RequestHandler_pp_fflags=  $(CppUnit_pp_fflags) 
test_unit_CoralStubs_RequestHandler_stamps=  $(CppUnit_stamps) 
test_unit_CoralStubs_StreamBuffer_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralStubs_StreamBuffer_use_linkopts=  $(CoralStubs_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_unit_CoralStubs_StreamBuffer_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_unit_CoralStubs_StreamBuffer_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_unit_CoralStubs_StreamBuffer_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_unit_CoralStubs_StreamBuffer_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_unit_CoralStubs_StreamBuffer_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_unit_CoralStubs_StreamBuffer_pp_fflags=  $(CppUnit_pp_fflags) 
test_unit_CoralStubs_StreamBuffer_stamps=  $(CppUnit_stamps) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_CoralStubsclean 
...
tests_constituentsclean= test_unit_CoralStubs_StreamBufferclean test_unit_CoralStubs_RequestHandlerclean test_unit_CoralStubs_AllPartsclean 
test_unit_CoralStubs_AllPartscompile_dependencies= lcg_mkdir
test_unit_CoralStubs_AllPartsprototype_dependencies= $(test_unit_CoralStubs_AllPartscompile_dependencies)
test_unit_CoralStubs_RequestHandlercompile_dependencies= lcg_mkdir
test_unit_CoralStubs_RequestHandlerprototype_dependencies= $(test_unit_CoralStubs_RequestHandlercompile_dependencies)
test_unit_CoralStubs_StreamBuffercompile_dependencies= lcg_mkdir
test_unit_CoralStubs_StreamBufferprototype_dependencies= $(test_unit_CoralStubs_StreamBuffercompile_dependencies)
