...
CORALAUTHENTICATIONSERVICEROOT=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralAuthenticationService
CoralAuthenticationService_root=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralAuthenticationService
CORALAUTHENTICATIONSERVICEVERSION=CoralAuthenticationService-0-0-1
CoralAuthenticationService_cmtpath=/home/jwsmith/HDD
CoralAuthenticationService_offset=CORAL/CORAL-2-4-2/CORAL_SERVER
CoralAuthenticationService_project=jwsmith
CoralAuthenticationService_project_release=HDD
CoralCommon_tag=$(tag)
...
use_cppflags=  $(CoralAuthenticationService_cppflags)  $(CoralCommon_cppflags)  $(CoralKernel_cppflags)  $(RelationalAccess_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(XercesC_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
CoralAuthenticationService_linkopts= -llcg_CoralAuthenticationService 
lcg_CoralAuthenticationService_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(lcg_CoralAuthenticationService_use_linkopts) 
lcg_CoralAuthenticationService_use_linkopts=    $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
constituents= lcg_CoralAuthenticationService install_includes install_pythonmods 
CppUnit_tag=$(tag)
...
tests_constituents=lcg_mkdir lcg_mkdir  test_unit_CoralAuthenticationService_OpenSSLCipher test_unit_CoralAuthenticationService_QueryMgr 
test_unit_CoralAuthenticationService_OpenSSLCipher_dependencies=lcg_mkdir
test_unit_CoralAuthenticationService_OpenSSLCipherlinkopts= $(CoralAuthenticationService_linkopts) $(CoralAuthenticationService_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
test_unit_CoralAuthenticationService_QueryMgr_dependencies=lcg_mkdir
test_unit_CoralAuthenticationService_QueryMgrlinkopts= $(CoralAuthenticationService_linkopts) $(CoralAuthenticationService_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
coralDemolinkopts= $(CoralAuthenticationService_linkopts) $(CoralAuthenticationService_utilities_linkopts) $(gcov_linkopts) $(icc_linkopts)  -llcg_CoralAuthenticationService 
coralCredentialsManagerlinkopts= $(CoralAuthenticationService_linkopts) $(CoralAuthenticationService_utilities_linkopts) $(gcov_linkopts) $(icc_linkopts)  -llcg_CoralAuthenticationService 
run_install_pythonmods=do_install_pythonmods
tag=armv7l-fc21-gcc49-opt
package=CoralAuthenticationService
version=CoralAuthenticationService-0-0-1
PACKAGE_ROOT=$(CORALAUTHENTICATIONSERVICEROOT)
srcdir=../src
bin=../$(CoralAuthenticationService_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralAuthenticationService/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_linkopts= $(cmt_installarea_linkopts)   $(CoralAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(CoralCommon_root)/cmt/requirements $(CoralKernel_root)/cmt/requirements $(RelationalAccess_root)/cmt/requirements $(CoralBase_root)/cmt/requirements $(LCG_Policy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(XercesC_root)/cmt/requirements $(CppUnit_root)/cmt/requirements $(LCG_Settings_root)/cmt/requirements $(LCG_Configuration_root)/cmt/requirements $(LCG_Platforms_root)/cmt/requirements 
...
use_stamps=  $(CoralAuthenticationService_stamps)  $(CoralCommon_stamps)  $(CoralKernel_stamps)  $(RelationalAccess_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(XercesC_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(CoralAuthenticationService_cflags)  $(CoralCommon_cflags)  $(CoralKernel_cflags)  $(RelationalAccess_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(XercesC_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(CoralAuthenticationService_pp_cflags)  $(CoralCommon_pp_cflags)  $(CoralKernel_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(XercesC_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(CoralAuthenticationService_pp_cppflags)  $(CoralCommon_pp_cppflags)  $(CoralKernel_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(XercesC_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(CoralAuthenticationService_fflags)  $(CoralCommon_fflags)  $(CoralKernel_fflags)  $(RelationalAccess_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(XercesC_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(CoralAuthenticationService_pp_fflags)  $(CoralCommon_pp_fflags)  $(CoralKernel_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(XercesC_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(CoralCommon_libraries)  $(CoralKernel_libraries)  $(RelationalAccess_libraries)  $(CoralBase_libraries)  $(LCG_Policy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(XercesC_libraries)  $(CppUnit_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralAuthenticationService" $(use_includes)
fincludes= $(includes)
lcg_CoralAuthenticationService_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralAuthenticationService_OpenSSLCipher_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralAuthenticationService_OpenSSLCipher_use_linkopts=  $(CoralAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_unit_CoralAuthenticationService_OpenSSLCipher_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_unit_CoralAuthenticationService_OpenSSLCipher_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_unit_CoralAuthenticationService_OpenSSLCipher_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_unit_CoralAuthenticationService_OpenSSLCipher_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_unit_CoralAuthenticationService_OpenSSLCipher_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_unit_CoralAuthenticationService_OpenSSLCipher_pp_fflags=  $(CppUnit_pp_fflags) 
test_unit_CoralAuthenticationService_OpenSSLCipher_stamps=  $(CppUnit_stamps) 
test_unit_CoralAuthenticationService_QueryMgr_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralAuthenticationService_QueryMgr_use_linkopts=  $(CoralAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_unit_CoralAuthenticationService_QueryMgr_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_unit_CoralAuthenticationService_QueryMgr_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_unit_CoralAuthenticationService_QueryMgr_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_unit_CoralAuthenticationService_QueryMgr_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_unit_CoralAuthenticationService_QueryMgr_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_unit_CoralAuthenticationService_QueryMgr_pp_fflags=  $(CppUnit_pp_fflags) 
test_unit_CoralAuthenticationService_QueryMgr_stamps=  $(CppUnit_stamps) 
coralDemo_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
coralDemo_use_linkopts=  $(CoralAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
coralCredentialsManager_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
coralCredentialsManager_use_linkopts=  $(CoralAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_CoralAuthenticationServiceclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituentsclean= examplesclean lcg_mkdirclean makeclean 
tests_constituentsclean= test_unit_CoralAuthenticationService_QueryMgrclean test_unit_CoralAuthenticationService_OpenSSLCipherclean 
utilities_constituents= coralDemo coralCredentialsManager 
utilities_constituentsclean= coralCredentialsManagerclean coralDemoclean 
test_unit_CoralAuthenticationService_OpenSSLCiphercompile_dependencies= lcg_mkdir
test_unit_CoralAuthenticationService_OpenSSLCipherprototype_dependencies= $(test_unit_CoralAuthenticationService_OpenSSLCiphercompile_dependencies)
test_unit_CoralAuthenticationService_QueryMgrcompile_dependencies= lcg_mkdir
test_unit_CoralAuthenticationService_QueryMgrprototype_dependencies= $(test_unit_CoralAuthenticationService_QueryMgrcompile_dependencies)
coralDemoprototype_dependencies= $(coralDemocompile_dependencies)
coralCredentialsManagerprototype_dependencies= $(coralCredentialsManagercompile_dependencies)
