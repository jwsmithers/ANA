...
TPCManager::operator() ()
{
  ...
  ClientConnManager connMgr ( serverReaderFactory, clientReaderFactory, rcvQueue, serverQueue, clientQueue, routing ) ;
  ...
  boost::thread serverWriterThread( ServerWriter ( serverQueue, connMgr ) ) ;
