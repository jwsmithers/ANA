// $Id: ISocket.h,v 1.5.2.1.2.1 2012-06-07 12:19:56 avalassi Exp $
...
namespace coral {
  ...
  namespace CoralSockets {
    ...
    public:
      ...
      void setSContext( boost::shared_ptr<SocketContext> context)
      {
        m_sContext = context;
      }

      boost::shared_ptr<SocketContext> getSContext() const
      {
        return m_sContext;
      }
    ...
    private:
      ...
      boost::shared_ptr<SocketContext> m_sContext;
    };
