// $Id: ReplyManager.h,v 1.9.2.5.2.2 2013-02-08 09:40:09 avalassi Exp $
...
namespace coral
{
  ...
  namespace CoralSockets
  {
    ...
    private:
      ...
      /// mutex with which the thread is locked and sleeping
      coral::mutex m_mutex;

      /// conditional variable with which the thread is locked and sleeping
      coral::condition_variable m_cond;
