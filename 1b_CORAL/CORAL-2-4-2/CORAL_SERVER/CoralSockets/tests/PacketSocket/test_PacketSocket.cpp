// $Id: test_PacketSocket.cpp,v 1.15.2.6.2.1 2012-06-07 12:19:58 avalassi Exp $
  ...
  public:
    ...
    void createSockets( ISocketPtr &src, ISocketPtr &dst)
    {
      ...
      while ( listenSocket.get() == 0 )
      {
        try
        {
          listenSocket = TcpSocket::listenOn( "localhost", getTestPort() );
        }
      ...
      src = TcpSocket::connectTo( "localhost", getTestPort() );
