// $Id: TableDescriptionProxy.cpp,v 1.8.2.1.2.2 2013-02-05 09:24:04 avalassi Exp $
...
const coral::ITableDescription& TableDescriptionProxy::proxiedTableDescription() const
{
  if ( ! m_pDesc )
  {
    if ( !m_isView )
    {
      SCOPED_TIMER( "CoralAccess::TableDescProxy::fetchTD" );
    ...
    {
      SCOPED_TIMER( "CoralAccess::TableDescProxy::fetchVD" );
