// $Id: CoralServerFacadeService.h,v 1.26.2.1.2.1 2012-12-21 13:24:30 avalassi Exp $
...
namespace coral
{
  ...
  namespace CoralServer
  {
    ...
    public:
      ...
      /// row and memory cache sizes are given in #rows and MBs, respectively.
      ...
      {
        return m_facade.fetchRows( sessionID, qd, pOutputBuffer, rowCacheSize, memoryCacheSize );
      }
      ...
      IRowIteratorPtr fetchRows( Token sessionID,
                                 ...
                                 unsigned int memoryCacheSize ) const
      {
        return m_facade.fetchRows( sessionID, qd, outputTypes, rowCacheSize, memoryCacheSize );
      }
