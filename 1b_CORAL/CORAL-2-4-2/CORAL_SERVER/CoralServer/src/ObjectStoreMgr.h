// $Id: ObjectStoreMgr.h,v 1.5.2.2.2.1 2012-06-28 12:12:45 avalassi Exp $
...
namespace coral
{
  ...
  namespace CoralServer
  {
    ...
    private:
      ...
      ObjectStoreMgr( const ObjectStoreMgr& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      ObjectStoreMgr& operator=( const ObjectStoreMgr& rhs );
