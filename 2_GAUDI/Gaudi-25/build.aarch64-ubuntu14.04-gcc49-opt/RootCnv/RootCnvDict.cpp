...
#include "/home/jwsmith/ANA/2_GAUDI/Gaudi/RootCnv/dict/RootCnv_dict.h"
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::UCharDbArray*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("UCharDbArray", "RootCnv/PoolClasses.h", 27,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::pool::Token*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("pool::Token", "RootCnv/PoolClasses.h", 14,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PoolDbLinkManager*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PoolDbLinkManager", "RootCnv/PoolClasses.h", 77,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PoolDbTokenWrap*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PoolDbTokenWrap", "RootCnv/PoolClasses.h", 49,
...
namespace ROOT {
   static TClass *PoolDbNTupleDescriptor_Dictionary();
   static void PoolDbNTupleDescriptor_TClassManip(TClass*);
   static void *new_PoolDbNTupleDescriptor(void *p = 0);
   static void *newArray_PoolDbNTupleDescriptor(Long_t size, void *p);
   static void delete_PoolDbNTupleDescriptor(void *p);
   static void deleteArray_PoolDbNTupleDescriptor(void *p);
   static void destruct_PoolDbNTupleDescriptor(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PoolDbNTupleDescriptor*)
   {
      ::PoolDbNTupleDescriptor *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::PoolDbNTupleDescriptor));
      static ::ROOT::TGenericClassInfo 
         instance("PoolDbNTupleDescriptor", "invalid", 48,
                  typeid(::PoolDbNTupleDescriptor), DefineBehavior(ptr, ptr),
                  &PoolDbNTupleDescriptor_Dictionary, isa_proxy, 0,
                  sizeof(::PoolDbNTupleDescriptor) );
      instance.SetNew(&new_PoolDbNTupleDescriptor);
      instance.SetNewArray(&newArray_PoolDbNTupleDescriptor);
      instance.SetDelete(&delete_PoolDbNTupleDescriptor);
      instance.SetDeleteArray(&deleteArray_PoolDbNTupleDescriptor);
      instance.SetDestructor(&destruct_PoolDbNTupleDescriptor);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::PoolDbNTupleDescriptor*)
   {
      return GenerateInitInstanceLocal((::PoolDbNTupleDescriptor*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::PoolDbNTupleDescriptor*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *PoolDbNTupleDescriptor_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::PoolDbNTupleDescriptor*)0x0)->GetClass();
      PoolDbNTupleDescriptor_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_PoolDbNTupleDescriptor(void *p) {
      return  p ? new(p) ::PoolDbNTupleDescriptor : new ::PoolDbNTupleDescriptor;
   }
   static void *newArray_PoolDbNTupleDescriptor(Long_t nElements, void *p) {
      return p ? new(p) ::PoolDbNTupleDescriptor[nElements] : new ::PoolDbNTupleDescriptor[nElements];
   }
   // Wrapper around operator delete
   static void delete_PoolDbNTupleDescriptor(void *p) {
      delete ((::PoolDbNTupleDescriptor*)p);
   }
   static void deleteArray_PoolDbNTupleDescriptor(void *p) {
      delete [] ((::PoolDbNTupleDescriptor*)p);
   }
   static void destruct_PoolDbNTupleDescriptor(void *p) {
      typedef ::PoolDbNTupleDescriptor current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::PoolDbNTupleDescriptor
...
"/home/seuster/LCGStack/lcgcmake-install/ROOT/6.02.99/aarch64-ubuntu14.04-gcc49-opt/include",
"/home/jwsmith/ANA/2_GAUDI/Gaudi/build.aarch64-ubuntu14.04-gcc49-opt/RootCnv/",
0
    };
...
struct __attribute__((annotate("$clingAutoload$RootCnv/PoolClasses.h")))  PoolDbTokenWrap;
...
"PoolDbNTupleDescriptor", payloadCode, "@",
