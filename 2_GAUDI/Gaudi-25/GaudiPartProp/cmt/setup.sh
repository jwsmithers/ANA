...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=GaudiPartProp -version=v2r1 -path=/home/jwsmith/HDD/Gaudi  -no_cleanup $* >${cmtGaudiPartProptempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=GaudiPartProp -version=v2r1 -path=/home/jwsmith/HDD/Gaudi  -no_cleanup $* >${cmtGaudiPartProptempfile}"
  cmtsetupstatus=2
