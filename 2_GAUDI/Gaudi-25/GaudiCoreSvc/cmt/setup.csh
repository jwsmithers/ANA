...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=GaudiCoreSvc -version=v3r1 -path=/home/jwsmith/HDD/Gaudi  -no_cleanup $* >${cmtGaudiCoreSvctempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=GaudiCoreSvc -version=v3r1 -path=/home/jwsmith/HDD/Gaudi  -no_cleanup $* >${cmtGaudiCoreSvctempfile}"
