...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=GaudiPython -version=v13r2 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtGaudiPythontempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=GaudiPython -version=v13r2 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtGaudiPythontempfile}"
