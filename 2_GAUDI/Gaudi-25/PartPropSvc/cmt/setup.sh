...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=PartPropSvc -version=v5r1 -path=/home/jwsmith/HDD/Gaudi  -no_cleanup $* >${cmtPartPropSvctempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=PartPropSvc -version=v5r1 -path=/home/jwsmith/HDD/Gaudi  -no_cleanup $* >${cmtPartPropSvctempfile}"
  cmtsetupstatus=2
