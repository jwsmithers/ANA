...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=GaudiKernel -version=v31r0 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtGaudiKerneltempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=GaudiKernel -version=v31r0 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtGaudiKerneltempfile}"
  cmtcleanupstatus=2
