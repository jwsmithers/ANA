...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=RootHistCnv -version=v12r1 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtRootHistCnvtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=RootHistCnv -version=v12r1 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtRootHistCnvtempfile}"
