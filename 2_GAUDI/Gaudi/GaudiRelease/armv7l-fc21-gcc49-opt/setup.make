----------> uses
# use GaudiPolicy v15r0  (no_version_directory)
...
# use Gaudi v25r3  (no_version_directory)
...
#       use LCG_Configuration v*  (no_version_directory)
#       use LCG_Settings v*  (no_version_directory)
# use GaudiPluginService v1r2  (no_version_directory)
# use GaudiKernel v31r0  (no_version_directory)
# use GaudiCoreSvc v3r1  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
...
#   use AIDA * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=3.2.1)
#   use Boost * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=1.55.0_python2.7)
# use GaudiGSL v8r2  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
...
#     use LCG_Settings v*  (no_version_directory)
#   use AIDA * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=3.2.1)
# use GaudiUtils v5r2  (no_version_directory)
# use GaudiPartProp v2r1  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
# use RootCnv v1r22p2  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
#   use GaudiUtils *  (no_version_directory)
#   use ROOT * LCG_Interfaces (no_version_directory) (native_version=v5-34-21)
# use RootHistCnv v12r1  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
#   use AIDA * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=3.2.1)
#   use ROOT * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=v5-34-21)
# use GaudiPython v13r2  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
#   use GaudiAlg *  (no_version_directory)
#   use GaudiUtils *  (no_version_directory)
...
#   use CLHEP * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=1.9.4.7)
#   use Python * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=2.7.6)
# use GaudiSys v25r3  (no_version_directory)
# use GaudiMonitor v5r1  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
# use GaudiProfiling v2r1  (no_version_directory)
...
# use GaudiMP v3r2  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
#   use GaudiAlg *  (no_version_directory)
#   use GaudiPython *  (no_auto_imports) (no_version_directory)
#   use Python * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=2.7.6)
#   use ROOT * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=v5-34-21)
#   use Boost * LCG_Interfaces (no_auto_imports) (no_version_directory) (native_version=1.55.0_python2.7)
# use GaudiExamples v25r3  (no_version_directory)
#   use ROOT * LCG_Interfaces (no_version_directory) (native_version=v5-34-21)
...
#     use LCG_Configuration v*  (no_version_directory)
#     use LCG_Settings v*  (no_version_directory)
# use PartPropSvc v5r1  (no_version_directory)
#   use GaudiPolicy *  (no_version_directory)
#   use GaudiKernel *  (no_version_directory)
#   use HepPDT * LCG_Interfaces (no_version_directory) (native_version=2.06.01)
#
...
use RELAX v1 LCG_Interfaces (/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71) (no_auto_imports)
...
use PartPropSvc v5r1  (/home/jwsmith/HDD/Gaudi)
use GaudiMonitor v5r1  (/home/jwsmith/HDD/Gaudi)
use RootHistCnv v12r1  (/home/jwsmith/HDD/Gaudi)
use GaudiPartProp v2r1  (/home/jwsmith/HDD/Gaudi)
use GaudiSvc v21r3  (/home/jwsmith/HDD/Gaudi)
use GaudiUtils v5r2  (/home/jwsmith/HDD/Gaudi)
use RootCnv v1r22p2  (/home/jwsmith/HDD/Gaudi)
use GaudiAlg v15r1  (/home/jwsmith/HDD/Gaudi)
use GaudiProfiling v2r1  (/home/jwsmith/HDD/Gaudi)
use GaudiGSL v8r2  (/home/jwsmith/HDD/Gaudi)
use GaudiPython v13r2  (/home/jwsmith/HDD/Gaudi)
use GaudiMP v3r2  (/home/jwsmith/HDD/Gaudi)
use GaudiAud v10r1  (/home/jwsmith/HDD/Gaudi)
use GaudiCommonSvc v3r2  (/home/jwsmith/HDD/Gaudi)
use GaudiCoreSvc v3r1  (/home/jwsmith/HDD/Gaudi)
use GaudiSys v25r3  (/home/jwsmith/HDD/Gaudi)
use Gaudi v25r3  (/home/jwsmith/HDD/Gaudi)
use GaudiExamples v25r3  (/home/jwsmith/HDD/Gaudi)
----------> tags
...
container-package (from package GaudiRelease) applied [GaudiRelease]
container_package (from GAUDI in package GaudiRelease)
----------> CMTPATH
