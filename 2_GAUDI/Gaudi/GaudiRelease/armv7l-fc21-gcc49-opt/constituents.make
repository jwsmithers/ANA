...
#cmt_local_tagfile = $(GaudiRelease_tag).make
cmt_local_tagfile = $(bin)$(GaudiRelease_tag).make
...
generate_manifest_file_extratags = -tag_add=target_generate_manifest_file
...
not_generate_manifest_file_dependencies = { n=0; for p in $?; do m=0; for d in $(generate_manifest_file_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
generate_manifest_filedirs :
	@if test ! -d $(bin)generate_manifest_file; then $(mkdir) -p $(bin)generate_manifest_file; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)generate_manifest_file
else
generate_manifest_filedirs : ;
endif
...
ifndef QUICK
$(cmt_local_generate_manifest_file_makefile) : $(generate_manifest_file_dependencies) build_library_links
	$(echo) "(constituents.make) Building generate_manifest_file.make"; \
	  $(cmtexe) -tag=$(tags) $(generate_manifest_file_extratags) build constituent_config -out=$(cmt_local_generate_manifest_file_makefile) generate_manifest_file
else
$(cmt_local_generate_manifest_file_makefile) : $(generate_manifest_file_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_generate_manifest_file) ] || \
	  [ ! -f $(cmt_final_setup_generate_manifest_file) ] || \
	  $(not_generate_manifest_file_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building generate_manifest_file.make"; \
	  $(cmtexe) -tag=$(tags) $(generate_manifest_file_extratags) build constituent_config -out=$(cmt_local_generate_manifest_file_makefile) generate_manifest_file; \
	  fi
endif
...
$(cmt_local_generate_manifest_file_makefile) : $(generate_manifest_file_dependencies) build_library_links
	$(echo) "(constituents.make) Building generate_manifest_file.make"; \
	  $(cmtexe) -f=$(bin)generate_manifest_file.in -tag=$(tags) $(generate_manifest_file_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_generate_manifest_file_makefile) generate_manifest_file
else
$(cmt_local_generate_manifest_file_makefile) : $(generate_manifest_file_dependencies) $(cmt_build_library_linksstamp) $(bin)generate_manifest_file.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_generate_manifest_file) ] || \
	  [ ! -f $(cmt_final_setup_generate_manifest_file) ] || \
	  $(not_generate_manifest_file_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(generate_manifest_file_extratags) build constituent_makefile -out=$(cmt_local_generate_manifest_file_makefile) generate_manifest_file

generate_manifest_file :: $(generate_manifest_file_dependencies) $(cmt_local_generate_manifest_file_makefile) dirs generate_manifest_filedirs
	$(echo) "(constituents.make) Starting generate_manifest_file"
	@if test -f $(cmt_local_generate_manifest_file_makefile); then \
	  $(MAKE) -f $(cmt_local_generate_manifest_file_makefile) generate_manifest_file; \
	  fi
#	@$(MAKE) -f $(cmt_local_generate_manifest_file_makefile) generate_manifest_file
	$(echo) "(constituents.make) generate_manifest_file done"

clean :: generate_manifest_fileclean ;

generate_manifest_fileclean :: $(generate_manifest_fileclean_dependencies) ##$(cmt_local_generate_manifest_file_makefile)
	$(echo) "(constituents.make) Starting generate_manifest_fileclean"
	@-if test -f $(cmt_local_generate_manifest_file_makefile); then \
	  $(MAKE) -f $(cmt_local_generate_manifest_file_makefile) generate_manifest_fileclean; \
	fi
	$(echo) "(constituents.make) generate_manifest_fileclean done"
#	@-$(MAKE) -f $(cmt_local_generate_manifest_file_makefile) generate_manifest_fileclean

##	  /bin/rm -f $(cmt_local_generate_manifest_file_makefile) $(bin)generate_manifest_file_dependencies.make

install :: generate_manifest_fileinstall ;

generate_manifest_fileinstall :: $(generate_manifest_file_dependencies) $(cmt_local_generate_manifest_file_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_generate_manifest_file_makefile); then \
	  $(MAKE) -f $(cmt_local_generate_manifest_file_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_generate_manifest_file_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : generate_manifest_fileuninstall

$(foreach d,$(generate_manifest_file_dependencies),$(eval $(d)uninstall_dependencies += generate_manifest_fileuninstall))

generate_manifest_fileuninstall : $(generate_manifest_fileuninstall_dependencies) ##$(cmt_local_generate_manifest_file_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_generate_manifest_file_makefile); then \
	  $(MAKE) -f $(cmt_local_generate_manifest_file_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_generate_manifest_file_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: generate_manifest_fileuninstall ;
...
cmt_local_tagfile_make = $(bin)$(GaudiRelease_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(GaudiRelease_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(GaudiRelease_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(GaudiRelease_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(GaudiRelease_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(GaudiRelease_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(GaudiRelease_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(GaudiRelease_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(GaudiRelease_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(GaudiRelease_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(GaudiRelease_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(GaudiRelease_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(GaudiRelease_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(GaudiRelease_tag).make
