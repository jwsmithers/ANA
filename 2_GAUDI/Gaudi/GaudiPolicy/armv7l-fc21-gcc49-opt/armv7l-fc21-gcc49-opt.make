...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiPolicy_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
generate_manifest_file_applied=NullCommand
dummy_for_NullCommand=generate_manifest_file 
tag=armv7l-fc21-gcc49-opt
package=GaudiPolicy
version=v15r0
PACKAGE_ROOT=$(GAUDIPOLICYROOT)
srcdir=../src
bin=../$(GaudiPolicy_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiPolicy/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiPolicy_linkopts)  $(LCG_Settings_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(Reflex_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(Python_root)/cmt/requirements $(tcmalloc_root)/cmt/requirements $(libunwind_root)/cmt/requirements $(GCCXML_root)/cmt/requirements $(xrootd_root)/cmt/requirements $(LCG_Settings_root)/cmt/requirements $(LCG_Configuration_root)/cmt/requirements $(LCG_Platforms_root)/cmt/requirements 
use_includes= 
use_fincludes= $(use_includes)
use_stamps=  $(GaudiPolicy_stamps)  $(LCG_Settings_stamps) 
use_cflags=  $(GaudiPolicy_cflags)  $(LCG_Settings_cflags) 
use_pp_cflags=  $(GaudiPolicy_pp_cflags)  $(LCG_Settings_pp_cflags) 
use_cppflags=  $(GaudiPolicy_cppflags)  $(LCG_Settings_cppflags) 
use_pp_cppflags=  $(GaudiPolicy_pp_cppflags)  $(LCG_Settings_pp_cppflags) 
use_fflags=  $(GaudiPolicy_fflags)  $(LCG_Settings_fflags) 
use_pp_fflags=  $(GaudiPolicy_pp_fflags)  $(LCG_Settings_pp_fflags) 
use_libraries= $(Reflex_libraries)  $(ROOT_libraries)  $(Python_libraries)  $(tcmalloc_libraries)  $(libunwind_libraries)  $(GCCXML_libraries)  $(xrootd_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
