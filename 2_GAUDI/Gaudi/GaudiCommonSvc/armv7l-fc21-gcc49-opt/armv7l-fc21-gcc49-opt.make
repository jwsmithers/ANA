...
Boost_linkopts=-L$(Boost_home)/lib  $(Boost_linkopts_system) $(Boost_linkopts_filesystem) 
...
GaudiCommonSvc_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(GaudiCommonSvc_use_linkopts)  
...
GaudiCommonSvcMergeComponentsList_dependencies= GaudiCommonSvcComponentsList 
...
GaudiCommonSvcConf_dependencies= GaudiCommonSvc 
zip_GaudiCommonSvc_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiCommonSvc_python_modules_deps=FORCE
zip_GaudiCommonSvc_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiCommonSvc_python_modules_pattern_applied=CallCommand
zip_GaudiCommonSvc_python_modules_dependencies= GaudiCommonSvc_python_init  GaudiCommonSvcConfDbMerge 
GaudiCommonSvc_python_init_dependencies= GaudiCommonSvcConf 
merge_genconfDb_tag=--do-merge
GaudiCommonSvcConfDbMerge_dependencies= GaudiCommonSvcConf 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiCommonSvc_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
...
version=v3r2
PACKAGE_ROOT=$(GAUDICOMMONSVCROOT)
srcdir=../src
bin=../$(GaudiCommonSvc_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiCommonSvc/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiCommonSvc_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(GaudiCommonSvc_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(GaudiCommonSvc_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(GaudiCommonSvc_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(GaudiCommonSvc_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(GaudiCommonSvc_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(GaudiCommonSvc_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(GaudiCommonSvc_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(GaudiCoreSvc_libraries)  $(GaudiKernel_libraries)  $(GaudiPluginService_libraries)  $(GaudiPolicy_libraries)  $(Reflex_libraries)  $(ROOT_libraries)  $(Boost_libraries)  $(Python_libraries)  $(tcmalloc_libraries)  $(libunwind_libraries)  $(GCCXML_libraries)  $(xrootd_libraries)  $(AIDA_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
fincludes= $(includes)
GaudiCommonSvc_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiCommonSvc_use_linkopts=  $(GaudiCommonSvc_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
lib_GaudiCommonSvc_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../ROOT/v5-34-21/armv7l-fc21-gcc49-opt/include"  $(ROOT_cflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../xrootd/3.3.6/armv7l-fc21-gcc49-opt/include"  $(xrootd_cflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cflags) 
lib_GaudiCommonSvc_pp_cflags=  $(ROOT_pp_cflags)  $(xrootd_pp_cflags)  $(AIDA_pp_cflags) 
lib_GaudiCommonSvc_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../ROOT/v5-34-21/armv7l-fc21-gcc49-opt/include"  $(ROOT_cppflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../xrootd/3.3.6/armv7l-fc21-gcc49-opt/include"  $(xrootd_cppflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cppflags) 
lib_GaudiCommonSvc_pp_cppflags=  $(ROOT_pp_cppflags)  $(xrootd_pp_cppflags)  $(AIDA_pp_cppflags) 
lib_GaudiCommonSvc_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../ROOT/v5-34-21/armv7l-fc21-gcc49-opt/include"  $(ROOT_fflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../xrootd/3.3.6/armv7l-fc21-gcc49-opt/include"  $(xrootd_fflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_fflags) 
lib_GaudiCommonSvc_pp_fflags=  $(ROOT_pp_fflags)  $(xrootd_pp_fflags)  $(AIDA_pp_fflags) 
GaudiCommonSvc_stamps=  $(ROOT_stamps)  $(xrootd_stamps)  $(AIDA_stamps) 
GaudiCommonSvcComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiCommonSvcMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiCommonSvcConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiCommonSvc_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiCommonSvc_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiCommonSvcConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
...
constituents= GaudiCommonSvc GaudiCommonSvcComponentsList GaudiCommonSvcMergeComponentsList GaudiCommonSvcConf GaudiCommonSvc_python_init zip_GaudiCommonSvc_python_modules GaudiCommonSvcConfDbMerge 
all_constituents= $(constituents)
constituentsclean= GaudiCommonSvcConfDbMergeclean zip_GaudiCommonSvc_python_modulesclean GaudiCommonSvc_python_initclean GaudiCommonSvcConfclean GaudiCommonSvcMergeComponentsListclean GaudiCommonSvcComponentsListclean GaudiCommonSvcclean 
all_constituentsclean= $(constituentsclean)
GaudiCommonSvcprototype_dependencies= $(GaudiCommonSvccompile_dependencies)
