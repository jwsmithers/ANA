...
#====================================
#  Document GaudiExamples_python
#
#   Generated Mon Feb 16 20:50:00 2015  by jwsmith
#
#====================================
...
tags      = $(tag),$(CMTEXTRATAGS),target_GaudiExamples_python

GaudiExamples_tag = $(tag)

#cmt_local_tagfile_GaudiExamples_python = $(GaudiExamples_tag)_GaudiExamples_python.make
...
#cmt_local_tagfile_GaudiExamples_python = $(GaudiExamples_tag).make
cmt_local_tagfile_GaudiExamples_python = $(bin)$(GaudiExamples_tag).make

endif

include $(cmt_local_tagfile_GaudiExamples_python)
#-include $(cmt_local_tagfile_GaudiExamples_python)

ifdef cmt_GaudiExamples_python_has_target_tag

cmt_final_setup_GaudiExamples_python = $(bin)setup_GaudiExamples_python.make
cmt_dependencies_in_GaudiExamples_python = $(bin)dependencies_GaudiExamples_python.in
#cmt_final_setup_GaudiExamples_python = $(bin)GaudiExamples_GaudiExamples_pythonsetup.make
cmt_local_GaudiExamples_python_makefile = $(bin)GaudiExamples_python.make

else

cmt_final_setup_GaudiExamples_python = $(bin)setup.make
cmt_dependencies_in_GaudiExamples_python = $(bin)dependencies.in
#cmt_final_setup_GaudiExamples_python = $(bin)GaudiExamplessetup.make
cmt_local_GaudiExamples_python_makefile = $(bin)GaudiExamples_python.make
...
help ::
	$(echo) 'GaudiExamples_python'

binobj = 
ifdef STRUCTURED_OUTPUT
binobj = GaudiExamples_python/
#GaudiExamples_python::
...
GaudiExamples_python :: GaudiExamples_pythoninstall

install :: GaudiExamples_pythoninstall

GaudiExamples_pythoninstall :: $(install_python_dir)
	@if [ ! "$(installarea)" = "" ] ; then\
...
GaudiExamples_pythonclean :: GaudiExamples_pythonuninstall

uninstall :: GaudiExamples_pythonuninstall

GaudiExamples_pythonuninstall ::
...
ifndef PEDANTIC
.DEFAULT::
	$(echo) "(GaudiExamples_python.make) $@: No rule for such target" >&2
else
.DEFAULT::
	$(error PEDANTIC: $@: No rule for such target)
endif

GaudiExamples_pythonclean ::
