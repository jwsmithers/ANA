...
ROOT_linkopts=-L$(ROOT_home)/lib -lCore -lCint -lTree -lpthread  -lRIO -lHist 
...
cmt_actions_constituentsclean= QMTestGUIclean QMTestTestsDatabaseclean TestProjectclean TestPackageclean qmtest_summarizeclean qmtest_runclean new_rootsysclean makeclean 
...
includes= $(ppcmd)"$(GaudiExamples_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
...
use_GaudiPartProp_unless=GaudiPartProp *  -no_auto_imports
...
use_RootCnv_unless=RootCnv *  -no_auto_imports
RootCnv_tag=$(tag)
...
GaudiExamples_reflex_selection_file= $(GAUDIEXAMPLESROOT)/src/IO/dict.xml 
GaudiExamples_rootmap=$(CMTINSTALLAREA)/$(tag)/lib/GAUDIDict.rootmap
GaudiExamples_reflex_options=  $(includes)  -U_Instantiations -D_Instantiations=GaudiExamples_Instantiations $(gccxmlopts) --select=$(GAUDIEXAMPLESROOT)/src/IO/dict.xml  --gccxmlpath=$(GCCXML_home)/bin
GaudiExamplesDict_dependencies=$(GaudiExamples_linker_library) GaudiExamplesGen
GaudiExamplesDict_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiExamples_linkopts) $(GaudiExamplesDict_use_linkopts) 
GaudiExamplesDict_use_linkopts=$(use_linkopts)  $(GaudiExamples_linkopts)  $(Gaudi_linkopts)  $(GaudiSys_linkopts)  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(CLHEP_linkopts)  $(HepPDT_linkopts)  $(GSL_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts)  $(LCG_Settings_linkopts) 
do_genconfuser=real_genconfuser
GaudiExamplesGenConfUser_output=$(GaudiExamples_root)$(genconfDir)GaudiExamples/GaudiExamples_user.confdb
GaudiExamplesGenConfUser_python=$(GaudiExamples_root)/python
GaudiExamplesGenConfUser_deps=FORCE
GaudiExamplesGenConfUser_command=$(GenConfUser_script) --lockerpath $(GaudiPolicy_root)/scripts -r $(GaudiExamplesGenConfUser_python) -o $(GaudiExamplesGenConfUser_output) GaudiExamples $(GaudiExamplesConfUserModules)
GaudiExamples_python_init_dependencies= GaudiExamplesGenConfUser  GaudiExamples_python  GaudiExamplesConf 
GaudiExamplesConfUserDbMerge_dependencies= GaudiExamplesGenConfUser GaudiExamples_python 
zip_GaudiExamples_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiExamples_python_modules_deps=FORCE
zip_GaudiExamples_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiExamples_python_modules_pattern_applied=CallCommand
zip_GaudiExamples_python_modules_dependencies= GaudiExamples_python_init  GaudiExamples_python_init  GaudiExamplesConfDbMerge 
...
GaudiExamples_linkopts= -lGaudiExamplesLib 
GaudiExamplesLib_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiExamplesLib_use_linkopts) -Wl,-soname=$(library_prefix)GaudiExamplesLib.$(shlibsuffix) 
GaudiExamplesLib_use_linkopts=    $(Gaudi_linkopts)  $(GaudiSys_linkopts)  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(CLHEP_linkopts)  $(HepPDT_linkopts)  $(GSL_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts)  $(LCG_Settings_linkopts) 
GaudiExamples_stamps=${GAUDIEXAMPLESROOT}/${BINDIR}/GaudiExamplesLib.stamp 
GaudiExamples_linker_library=GaudiExamplesLib
lib_GaudiExamplesLib_pp_cppflags= -DGAUDI_LINKER_LIBRARY 
GaudiExamplesLibexportsymb=-export_all_symbols
GaudiExamplesLibinstalllib=yes
GaudiExamples_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(GaudiExamples_use_linkopts)  
GaudiExamples_dependencies=$(GaudiExamples_linker_library) 
GaudiExamplesComponentsList_dependencies= GaudiExamples 
merge_componentslist_tag=--do-merge
GaudiExamplesMergeComponentsList_dependencies= GaudiExamplesComponentsList 
run_genconfig_cmd=do_real_genconfig
GaudiExamplesConf_dependencies= GaudiExamples 
merge_genconfDb_tag=--do-merge
GaudiExamplesConfDbMerge_dependencies= GaudiExamplesConf 
PyExample_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(PyExample_use_linkopts)
PyExample_dependencies=   
PyExample_install_dir=$(CMTINSTALLAREA)/$(python_bin_module_dir)
PyExample_cppflags= -ftemplate-depth-64
PyExample_use_linkopts= $(Boost_linkopts_python)    $(Gaudi_linkopts)  $(GaudiSys_linkopts)  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(CLHEP_linkopts)  $(HepPDT_linkopts)  $(GSL_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts)  $(LCG_Settings_linkopts) 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiExamples_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
...
version=v25r3
PACKAGE_ROOT=$(GAUDIEXAMPLESROOT)
srcdir=../src
bin=../$(GaudiExamples_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiExamples/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(Gaudi_root)/cmt/requirements $(GaudiSys_root)/cmt/requirements $(GaudiCoreSvc_root)/cmt/requirements $(GaudiCommonSvc_root)/cmt/requirements $(GaudiAud_root)/cmt/requirements $(GaudiPython_root)/cmt/requirements $(GaudiGSL_root)/cmt/requirements $(GaudiAlg_root)/cmt/requirements $(RootCnv_root)/cmt/requirements $(GaudiUtils_root)/cmt/requirements $(GaudiPartProp_root)/cmt/requirements $(PartPropSvc_root)/cmt/requirements $(RootHistCnv_root)/cmt/requirements $(GaudiKernel_root)/cmt/requirements $(GaudiPluginService_root)/cmt/requirements $(GaudiPolicy_root)/cmt/requirements $(Reflex_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(GCCXML_root)/cmt/requirements $(Boost_root)/cmt/requirements $(pytools_root)/cmt/requirements $(Python_root)/cmt/requirements $(xrootd_root)/cmt/requirements $(RELAX_root)/cmt/requirements $(AIDA_root)/cmt/requirements $(tcmalloc_root)/cmt/requirements $(libunwind_root)/cmt/requirements $(uuid_root)/cmt/requirements $(XercesC_root)/cmt/requirements $(CLHEP_root)/cmt/requirements $(mysql_root)/cmt/requirements $(HepPDT_root)/cmt/requirements $(GSL_root)/cmt/requirements $(LCG_Configuration_root)/cmt/requirements $(LCG_Platforms_root)/cmt/requirements $(LCG_Settings_root)/cmt/requirements 
use_includes= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../ROOT/v5-34-21/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../ROOT/v5-34-21/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Boost/1.55.0_python2.7/armv7l-fc21-gcc49-opt/include/boost-1_55" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../xrootd/3.3.6/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../clhep/1.9.4.7/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../HepPDT/2.06.01/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../GSL/1.10/armv7l-fc21-gcc49-opt/include" $(ppcmd)"$(LCG_Platforms_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(GaudiExamples_stamps)  $(Gaudi_stamps)  $(GaudiSys_stamps)  $(GaudiGSL_stamps)  $(GaudiAlg_stamps)  $(GaudiUtils_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(ROOT_stamps)  $(Boost_stamps)  $(xrootd_stamps)  $(AIDA_stamps)  $(CLHEP_stamps)  $(HepPDT_stamps)  $(GSL_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps)  $(LCG_Settings_stamps) 
use_cflags=  $(GaudiExamples_cflags)  $(Gaudi_cflags)  $(GaudiSys_cflags)  $(GaudiGSL_cflags)  $(GaudiAlg_cflags)  $(GaudiUtils_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(ROOT_cflags)  $(Boost_cflags)  $(xrootd_cflags)  $(AIDA_cflags)  $(CLHEP_cflags)  $(HepPDT_cflags)  $(GSL_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags)  $(LCG_Settings_cflags) 
use_pp_cflags=  $(GaudiExamples_pp_cflags)  $(Gaudi_pp_cflags)  $(GaudiSys_pp_cflags)  $(GaudiGSL_pp_cflags)  $(GaudiAlg_pp_cflags)  $(GaudiUtils_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(ROOT_pp_cflags)  $(Boost_pp_cflags)  $(xrootd_pp_cflags)  $(AIDA_pp_cflags)  $(CLHEP_pp_cflags)  $(HepPDT_pp_cflags)  $(GSL_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags)  $(LCG_Settings_pp_cflags) 
use_cppflags=  $(GaudiExamples_cppflags)  $(Gaudi_cppflags)  $(GaudiSys_cppflags)  $(GaudiGSL_cppflags)  $(GaudiAlg_cppflags)  $(GaudiUtils_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(ROOT_cppflags)  $(Boost_cppflags)  $(xrootd_cppflags)  $(AIDA_cppflags)  $(CLHEP_cppflags)  $(HepPDT_cppflags)  $(GSL_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags)  $(LCG_Settings_cppflags) 
use_pp_cppflags=  $(GaudiExamples_pp_cppflags)  $(Gaudi_pp_cppflags)  $(GaudiSys_pp_cppflags)  $(GaudiGSL_pp_cppflags)  $(GaudiAlg_pp_cppflags)  $(GaudiUtils_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(ROOT_pp_cppflags)  $(Boost_pp_cppflags)  $(xrootd_pp_cppflags)  $(AIDA_pp_cppflags)  $(CLHEP_pp_cppflags)  $(HepPDT_pp_cppflags)  $(GSL_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags)  $(LCG_Settings_pp_cppflags) 
use_fflags=  $(GaudiExamples_fflags)  $(Gaudi_fflags)  $(GaudiSys_fflags)  $(GaudiGSL_fflags)  $(GaudiAlg_fflags)  $(GaudiUtils_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(ROOT_fflags)  $(Boost_fflags)  $(xrootd_fflags)  $(AIDA_fflags)  $(CLHEP_fflags)  $(HepPDT_fflags)  $(GSL_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags)  $(LCG_Settings_fflags) 
use_pp_fflags=  $(GaudiExamples_pp_fflags)  $(Gaudi_pp_fflags)  $(GaudiSys_pp_fflags)  $(GaudiGSL_pp_fflags)  $(GaudiAlg_pp_fflags)  $(GaudiUtils_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(ROOT_pp_fflags)  $(Boost_pp_fflags)  $(xrootd_pp_fflags)  $(AIDA_pp_fflags)  $(CLHEP_pp_fflags)  $(HepPDT_pp_fflags)  $(GSL_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags)  $(LCG_Settings_pp_fflags) 
use_libraries= $(Gaudi_libraries)  $(GaudiSys_libraries)  $(GaudiCoreSvc_libraries)  $(GaudiCommonSvc_libraries)  $(GaudiAud_libraries)  $(GaudiPython_libraries)  $(GaudiGSL_libraries)  $(GaudiAlg_libraries)  $(RootCnv_libraries)  $(GaudiUtils_libraries)  $(GaudiPartProp_libraries)  $(PartPropSvc_libraries)  $(RootHistCnv_libraries)  $(GaudiKernel_libraries)  $(GaudiPluginService_libraries)  $(GaudiPolicy_libraries)  $(Reflex_libraries)  $(ROOT_libraries)  $(GCCXML_libraries)  $(Boost_libraries)  $(pytools_libraries)  $(Python_libraries)  $(xrootd_libraries)  $(RELAX_libraries)  $(AIDA_libraries)  $(tcmalloc_libraries)  $(libunwind_libraries)  $(uuid_libraries)  $(XercesC_libraries)  $(CLHEP_libraries)  $(mysql_libraries)  $(HepPDT_libraries)  $(GSL_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries)  $(LCG_Settings_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamplesLib_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamples_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamples_use_linkopts=  $(GaudiExamples_linkopts)  $(Gaudi_linkopts)  $(GaudiSys_linkopts)  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(CLHEP_linkopts)  $(HepPDT_linkopts)  $(GSL_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts)  $(LCG_Settings_linkopts) 
GaudiExamplesGen_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamplesDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamples_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamplesGenConfUser_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamplesConfUserDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamples_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiExamples_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Allocator_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Allocator_use_linkopts=  $(GaudiExamples_linkopts)  $(Gaudi_linkopts)  $(GaudiSys_linkopts)  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(CLHEP_linkopts)  $(HepPDT_linkopts)  $(GSL_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts)  $(LCG_Settings_linkopts) 
GaudiExamplesComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamplesMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamplesConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiExamplesConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PyExample_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lib_PyExample_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_cflags) 
lib_PyExample_pp_cflags=  $(Python_pp_cflags) 
lib_PyExample_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_cppflags) 
lib_PyExample_pp_cppflags=  $(Python_pp_cppflags) 
lib_PyExample_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_fflags) 
lib_PyExample_pp_fflags=  $(Python_pp_fflags) 
PyExample_stamps=  $(Python_stamps) 
...
constituents= install_more_includes GaudiExamplesLib GaudiExamples GaudiExamplesGen GaudiExamplesDict GaudiExamples_python GaudiExamplesGenConfUser GaudiExamplesConfUserDbMerge GaudiExamples_python_init zip_GaudiExamples_python_modules Allocator GaudiExamplesComponentsList GaudiExamplesMergeComponentsList GaudiExamplesConf GaudiExamplesConfDbMerge PyExample 
all_constituents= $(constituents)
constituentsclean= PyExampleclean GaudiExamplesConfDbMergeclean GaudiExamplesConfclean GaudiExamplesMergeComponentsListclean GaudiExamplesComponentsListclean Allocatorclean zip_GaudiExamples_python_modulesclean GaudiExamples_python_initclean GaudiExamplesConfUserDbMergeclean GaudiExamplesGenConfUserclean GaudiExamples_pythonclean GaudiExamplesDictclean GaudiExamplesGenclean GaudiExamplesclean GaudiExamplesLibclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
GaudiExamplesLibprototype_dependencies= $(GaudiExamplesLibcompile_dependencies)
GaudiExamplescompile_dependencies= GaudiExamplesLibprototype
GaudiExamplesprototype_dependencies= $(GaudiExamplescompile_dependencies)
GaudiExamplesDictcompile_dependencies= GaudiExamplesLibprototype GaudiExamplesGen
GaudiExamplesDictprototype_dependencies= $(GaudiExamplesDictcompile_dependencies)
Allocatorcompile_dependencies= GaudiExamplesprototype
Allocatorprototype_dependencies= $(Allocatorcompile_dependencies)
PyExampleprototype_dependencies= $(PyExamplecompile_dependencies)
