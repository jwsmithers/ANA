...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=GaudiMonitor -version=v5r1 -path=/home/jwsmith/HDD/Gaudi  -no_cleanup $* >${cmtGaudiMonitortempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=GaudiMonitor -version=v5r1 -path=/home/jwsmith/HDD/Gaudi  -no_cleanup $* >${cmtGaudiMonitortempfile}"
