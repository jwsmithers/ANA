...
GaudiMonitor_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(GaudiMonitor_use_linkopts)  
...
GaudiMonitorMergeComponentsList_dependencies= GaudiMonitorComponentsList 
...
GaudiMonitorConf_dependencies= GaudiMonitor 
zip_GaudiMonitor_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiMonitor_python_modules_deps=FORCE
zip_GaudiMonitor_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiMonitor_python_modules_pattern_applied=CallCommand
zip_GaudiMonitor_python_modules_dependencies= GaudiMonitor_python_init  GaudiMonitorConfDbMerge 
GaudiMonitor_python_init_dependencies= GaudiMonitorConf 
merge_genconfDb_tag=--do-merge
GaudiMonitorConfDbMerge_dependencies= GaudiMonitorConf 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiMonitor_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
...
version=v5r1
PACKAGE_ROOT=$(GAUDIMONITORROOT)
srcdir=../src
bin=../$(GaudiMonitor_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiMonitor/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiMonitor_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(GaudiMonitor_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(GaudiMonitor_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(GaudiMonitor_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(GaudiMonitor_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(GaudiMonitor_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(GaudiMonitor_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(GaudiMonitor_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
...
fincludes= $(includes)
GaudiMonitor_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMonitor_use_linkopts=  $(GaudiMonitor_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
GaudiMonitorComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMonitorMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMonitorConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMonitor_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiMonitor_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMonitorConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
...
constituents= GaudiMonitor GaudiMonitorComponentsList GaudiMonitorMergeComponentsList GaudiMonitorConf GaudiMonitor_python_init zip_GaudiMonitor_python_modules GaudiMonitorConfDbMerge 
all_constituents= $(constituents)
constituentsclean= GaudiMonitorConfDbMergeclean zip_GaudiMonitor_python_modulesclean GaudiMonitor_python_initclean GaudiMonitorConfclean GaudiMonitorMergeComponentsListclean GaudiMonitorComponentsListclean GaudiMonitorclean 
all_constituentsclean= $(constituentsclean)
GaudiMonitorprototype_dependencies= $(GaudiMonitorcompile_dependencies)
