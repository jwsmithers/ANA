...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=GaudiCoreSvc -version=v3r1 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtGaudiCoreSvctempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=GaudiCoreSvc -version=v3r1 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtGaudiCoreSvctempfile}"
  cmtcleanupstatus=2
