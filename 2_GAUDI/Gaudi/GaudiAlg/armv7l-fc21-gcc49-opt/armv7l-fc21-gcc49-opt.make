...
includes= $(ppcmd)"$(GaudiAlg_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
...
Boost_linkopts=-L$(Boost_home)/lib  $(Boost_linkopts_regex) 
...
GaudiAlgLib_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiAlgLib_use_linkopts) -Wl,-soname=$(library_prefix)GaudiAlgLib.$(shlibsuffix) 
GaudiAlgLib_use_linkopts=    $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
GaudiAlg_stamps=${GAUDIALGROOT}/${BINDIR}/GaudiAlgLib.stamp   $(AIDA_stamps) 
GaudiAlg_linker_library=GaudiAlgLib
lib_GaudiAlgLib_pp_cppflags= -DGAUDI_LINKER_LIBRARY   $(AIDA_pp_cppflags) 
GaudiAlgLibexportsymb=-export_all_symbols
GaudiAlgLibinstalllib=yes
GaudiAlg_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(GaudiAlg_use_linkopts)  
...
GaudiAlgMergeComponentsList_dependencies= GaudiAlgComponentsList 
...
GaudiAlgConf_dependencies= GaudiAlg 
zip_GaudiAlg_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiAlg_python_modules_deps=FORCE
zip_GaudiAlg_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiAlg_python_modules_pattern_applied=CallCommand
zip_GaudiAlg_python_modules_dependencies= GaudiAlg_python_init  GaudiAlgConfDbMerge 
GaudiAlg_python_init_dependencies= GaudiAlgConf 
merge_genconfDb_tag=--do-merge
GaudiAlgConfDbMerge_dependencies= GaudiAlgConf 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiAlg_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
generate_manifest_file_applied=NullCommand
dummy_for_NullCommand=generate_manifest_file 
tag=armv7l-fc21-gcc49-opt
package=GaudiAlg
version=v15r1
PACKAGE_ROOT=$(GAUDIALGROOT)
srcdir=../src
bin=../$(GaudiAlg_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiAlg/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(GaudiAlg_stamps)  $(GaudiUtils_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(ROOT_stamps)  $(Boost_stamps)  $(xrootd_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(GaudiAlg_cflags)  $(GaudiUtils_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(ROOT_cflags)  $(Boost_cflags)  $(xrootd_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(GaudiAlg_pp_cflags)  $(GaudiUtils_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(ROOT_pp_cflags)  $(Boost_pp_cflags)  $(xrootd_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(GaudiAlg_cppflags)  $(GaudiUtils_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(ROOT_cppflags)  $(Boost_cppflags)  $(xrootd_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(GaudiAlg_pp_cppflags)  $(GaudiUtils_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(ROOT_pp_cppflags)  $(Boost_pp_cppflags)  $(xrootd_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(GaudiAlg_fflags)  $(GaudiUtils_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(ROOT_fflags)  $(Boost_fflags)  $(xrootd_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(GaudiAlg_pp_fflags)  $(GaudiUtils_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(ROOT_pp_fflags)  $(Boost_pp_fflags)  $(xrootd_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
...
GaudiAlgLib_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lib_GaudiAlgLib_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cflags) 
lib_GaudiAlgLib_pp_cflags=  $(AIDA_pp_cflags) 
lib_GaudiAlgLib_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cppflags) 
lib_GaudiAlgLib_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_fflags) 
lib_GaudiAlgLib_pp_fflags=  $(AIDA_pp_fflags) 
GaudiAlgLib_stamps=  $(AIDA_stamps) 
GaudiAlg_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiAlg_use_linkopts=  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
lib_GaudiAlg_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cflags) 
lib_GaudiAlg_pp_cflags=  $(AIDA_pp_cflags) 
lib_GaudiAlg_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cppflags) 
lib_GaudiAlg_pp_cppflags=  $(AIDA_pp_cppflags) 
lib_GaudiAlg_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_fflags) 
lib_GaudiAlg_pp_fflags=  $(AIDA_pp_fflags) 
GaudiAlgComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiAlgMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiAlgConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiAlg_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiAlg_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiAlgConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
...
constituents= install_more_includes GaudiAlgLib GaudiAlg GaudiAlgComponentsList GaudiAlgMergeComponentsList GaudiAlgConf GaudiAlg_python_init zip_GaudiAlg_python_modules GaudiAlgConfDbMerge 
all_constituents= $(constituents)
constituentsclean= GaudiAlgConfDbMergeclean zip_GaudiAlg_python_modulesclean GaudiAlg_python_initclean GaudiAlgConfclean GaudiAlgMergeComponentsListclean GaudiAlgComponentsListclean GaudiAlgclean GaudiAlgLibclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
GaudiAlgLibprototype_dependencies= $(GaudiAlgLibcompile_dependencies)
GaudiAlgcompile_dependencies= GaudiAlgLibprototype
GaudiAlgprototype_dependencies= $(GaudiAlgcompile_dependencies)
