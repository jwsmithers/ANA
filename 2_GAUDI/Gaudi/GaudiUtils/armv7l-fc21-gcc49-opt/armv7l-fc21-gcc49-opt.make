...
ROOT_linkopts=-L$(ROOT_home)/lib -lCore -lCint -lTree -lpthread  -lRIO -lHist -lXMLIO 
...
includes= $(ppcmd)"$(GaudiUtils_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
...
Boost_linkopts=-L$(Boost_home)/lib  $(Boost_linkopts_date_time) $(Boost_linkopts_system) 
...
GaudiUtilsLib_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiUtilsLib_use_linkopts) -Wl,-soname=$(library_prefix)GaudiUtilsLib.$(shlibsuffix) 
GaudiUtilsLib_use_linkopts=    $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
GaudiUtils_stamps=${GAUDIUTILSROOT}/${BINDIR}/GaudiUtilsLib.stamp   $(uuid_stamps)  $(XercesC_stamps) 
GaudiUtils_linker_library=GaudiUtilsLib
lib_GaudiUtilsLib_pp_cppflags= -DGAUDI_LINKER_LIBRARY   $(AIDA_pp_cppflags) 
GaudiUtilsLibexportsymb=-export_all_symbols
GaudiUtilsLibinstalllib=yes
GaudiUtils_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(GaudiUtils_use_linkopts)  
...
GaudiUtilsMergeComponentsList_dependencies= GaudiUtilsComponentsList 
...
GaudiUtilsConf_dependencies= GaudiUtils 
zip_GaudiUtils_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiUtils_python_modules_deps=FORCE
zip_GaudiUtils_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiUtils_python_modules_pattern_applied=CallCommand
zip_GaudiUtils_python_modules_dependencies= GaudiUtils_python_init  GaudiUtilsConfDbMerge 
GaudiUtils_python_init_dependencies= GaudiUtilsConf 
merge_genconfDb_tag=--do-merge
GaudiUtilsConfDbMerge_dependencies= GaudiUtilsConf 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiUtils_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
generate_manifest_file_applied=NullCommand
dummy_for_NullCommand=generate_manifest_file 
tag=armv7l-fc21-gcc49-opt
package=GaudiUtils
version=v5r2
PACKAGE_ROOT=$(GAUDIUTILSROOT)
srcdir=../src
bin=../$(GaudiUtils_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiUtils/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(GaudiUtils_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(ROOT_stamps)  $(Boost_stamps)  $(xrootd_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(GaudiUtils_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(ROOT_cflags)  $(Boost_cflags)  $(xrootd_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(GaudiUtils_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(ROOT_pp_cflags)  $(Boost_pp_cflags)  $(xrootd_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(GaudiUtils_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(ROOT_cppflags)  $(Boost_cppflags)  $(xrootd_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(GaudiUtils_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(ROOT_pp_cppflags)  $(Boost_pp_cppflags)  $(xrootd_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(GaudiUtils_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(ROOT_fflags)  $(Boost_fflags)  $(xrootd_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(GaudiUtils_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(ROOT_pp_fflags)  $(Boost_pp_fflags)  $(xrootd_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
...
GaudiUtilsLib_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lib_GaudiUtilsLib_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cflags) 
lib_GaudiUtilsLib_pp_cflags=  $(AIDA_pp_cflags) 
lib_GaudiUtilsLib_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cppflags) 
lib_GaudiUtilsLib_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_fflags) 
lib_GaudiUtilsLib_pp_fflags=  $(AIDA_pp_fflags) 
GaudiUtilsLib_stamps=  $(AIDA_stamps) 
GaudiUtils_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiUtils_use_linkopts=  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(uuid_linkopts)  $(XercesC_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
lib_GaudiUtils_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../uuid/1.42/armv7l-fc21-gcc49-opt/include"  $(uuid_cflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../XercesC/3.1.1p1/armv7l-fc21-gcc49-opt/include"  $(XercesC_cflags) 
lib_GaudiUtils_pp_cflags=  $(uuid_pp_cflags)  $(XercesC_pp_cflags) 
lib_GaudiUtils_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../uuid/1.42/armv7l-fc21-gcc49-opt/include"  $(uuid_cppflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../XercesC/3.1.1p1/armv7l-fc21-gcc49-opt/include"  $(XercesC_cppflags) 
lib_GaudiUtils_pp_cppflags=  $(uuid_pp_cppflags)  $(XercesC_pp_cppflags) 
lib_GaudiUtils_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../uuid/1.42/armv7l-fc21-gcc49-opt/include"  $(uuid_fflags) $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../XercesC/3.1.1p1/armv7l-fc21-gcc49-opt/include"  $(XercesC_fflags) 
lib_GaudiUtils_pp_fflags=  $(uuid_pp_fflags)  $(XercesC_pp_fflags) 
GaudiUtilsComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiUtilsMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiUtilsConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiUtils_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiUtils_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiUtilsConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
...
constituents= install_more_includes GaudiUtilsLib GaudiUtils GaudiUtilsComponentsList GaudiUtilsMergeComponentsList GaudiUtilsConf GaudiUtils_python_init zip_GaudiUtils_python_modules GaudiUtilsConfDbMerge 
all_constituents= $(constituents)
constituentsclean= GaudiUtilsConfDbMergeclean zip_GaudiUtils_python_modulesclean GaudiUtils_python_initclean GaudiUtilsConfclean GaudiUtilsMergeComponentsListclean GaudiUtilsComponentsListclean GaudiUtilsclean GaudiUtilsLibclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
GaudiUtilsLibprototype_dependencies= $(GaudiUtilsLibcompile_dependencies)
GaudiUtilscompile_dependencies= GaudiUtilsLibprototype
GaudiUtilsprototype_dependencies= $(GaudiUtilscompile_dependencies)
