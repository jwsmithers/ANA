...
includes= $(ppcmd)"$(GaudiMP_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
...
GaudiMPGenConfUser_output=$(GaudiMP_root)$(genconfDir)GaudiMP/GaudiMP_user.confdb
GaudiMPGenConfUser_python=$(GaudiMP_root)/python
GaudiMPGenConfUser_deps=FORCE
GaudiMPGenConfUser_command=$(GenConfUser_script) --lockerpath $(GaudiPolicy_root)/scripts -r $(GaudiMPGenConfUser_python) -o $(GaudiMPGenConfUser_output) GaudiMP $(GaudiMPConfUserModules)
GaudiMP_python_init_dependencies= GaudiMPGenConfUser  GaudiMP_python  GaudiMPConf 
GaudiMPConfUserDbMerge_dependencies= GaudiMPGenConfUser GaudiMP_python 
zip_GaudiMP_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiMP_python_modules_deps=FORCE
zip_GaudiMP_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiMP_python_modules_pattern_applied=CallCommand
zip_GaudiMP_python_modules_dependencies= GaudiMP_python_init  GaudiMP_python_init  GaudiMPConfDbMerge 
GaudiMP_linkopts= -lGaudiMPLib  $(GaudiMP_PyROOT_linkopts) $(Boost_linkopts_system) $(Boost_linkopts_filesystem) $(Boost_linkopts_regex) $(Boost_linkopts_thread)
GaudiMPLib_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiMPLib_use_linkopts) -Wl,-soname=$(library_prefix)GaudiMPLib.$(shlibsuffix) 
GaudiMPLib_use_linkopts=    $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
GaudiMP_stamps=${GAUDIMPROOT}/${BINDIR}/GaudiMPLib.stamp   $(Python_stamps) 
GaudiMP_linker_library=GaudiMPLib
lib_GaudiMPLib_pp_cppflags= -DGAUDI_LINKER_LIBRARY   $(Python_pp_cppflags) 
GaudiMPLibexportsymb=-export_all_symbols
GaudiMPLibinstalllib=yes
GaudiMP_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(GaudiMP_use_linkopts)  
GaudiMP_dependencies=$(GaudiMP_linker_library) 
GaudiMPComponentsList_dependencies= GaudiMP 
merge_componentslist_tag=--do-merge
GaudiMPMergeComponentsList_dependencies= GaudiMPComponentsList 
...
GaudiMPConf_dependencies= GaudiMP 
merge_genconfDb_tag=--do-merge
GaudiMPConfDbMerge_dependencies= GaudiMPConf 
GaudiMP_reflex_selection_file= ../dict/selection.xml 
GaudiMP_rootmap=$(CMTINSTALLAREA)/$(tag)/lib/GAUDIDict.rootmap
GaudiMP_reflex_options= --no_templatetypedefs -I$(Python_inc) -U_Instantiations -D_Instantiations=GaudiMP_Instantiations $(gccxmlopts) --select=../dict/selection.xml  --gccxmlpath=$(GCCXML_home)/bin
GaudiMPDict_dependencies=$(GaudiMP_linker_library) GaudiMPGen
GaudiMPDict_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiMP_linkopts) $(GaudiMPDict_use_linkopts) 
GaudiMP_PyROOT_linkopts= -L$(ROOT_home)/lib -lPyROOT
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiMP_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
generate_manifest_file_applied=NullCommand
dummy_for_NullCommand=generate_manifest_file 
tag=armv7l-fc21-gcc49-opt
package=GaudiMP
version=v3r2
PACKAGE_ROOT=$(GAUDIMPROOT)
srcdir=../src
bin=../$(GaudiMP_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiMP/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiMP_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(GaudiMP_stamps)  $(GaudiAlg_stamps)  $(GaudiUtils_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(ROOT_stamps)  $(Boost_stamps)  $(xrootd_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(GaudiMP_cflags)  $(GaudiAlg_cflags)  $(GaudiUtils_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(ROOT_cflags)  $(Boost_cflags)  $(xrootd_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(GaudiMP_pp_cflags)  $(GaudiAlg_pp_cflags)  $(GaudiUtils_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(ROOT_pp_cflags)  $(Boost_pp_cflags)  $(xrootd_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(GaudiMP_cppflags)  $(GaudiAlg_cppflags)  $(GaudiUtils_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(ROOT_cppflags)  $(Boost_cppflags)  $(xrootd_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(GaudiMP_pp_cppflags)  $(GaudiAlg_pp_cppflags)  $(GaudiUtils_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(ROOT_pp_cppflags)  $(Boost_pp_cppflags)  $(xrootd_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(GaudiMP_fflags)  $(GaudiAlg_fflags)  $(GaudiUtils_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(ROOT_fflags)  $(Boost_fflags)  $(xrootd_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(GaudiMP_pp_fflags)  $(GaudiAlg_pp_fflags)  $(GaudiUtils_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(ROOT_pp_fflags)  $(Boost_pp_fflags)  $(xrootd_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(GaudiPython_libraries)  $(GaudiAlg_libraries)  $(GaudiUtils_libraries)  $(GaudiCoreSvc_libraries)  $(GaudiKernel_libraries)  $(GaudiPluginService_libraries)  $(GaudiPolicy_libraries)  $(Reflex_libraries)  $(ROOT_libraries)  $(Boost_libraries)  $(Python_libraries)  $(tcmalloc_libraries)  $(libunwind_libraries)  $(GCCXML_libraries)  $(xrootd_libraries)  $(AIDA_libraries)  $(uuid_libraries)  $(XercesC_libraries)  $(CLHEP_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMP_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPGenConfUser_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPConfUserDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMP_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiMP_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_scripts_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPLib_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lib_GaudiMPLib_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_cflags) 
lib_GaudiMPLib_pp_cflags=  $(Python_pp_cflags) 
lib_GaudiMPLib_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_cppflags) 
lib_GaudiMPLib_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_fflags) 
lib_GaudiMPLib_pp_fflags=  $(Python_pp_fflags) 
GaudiMPLib_stamps=  $(Python_stamps) 
GaudiMP_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMP_use_linkopts=  $(GaudiMP_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
lib_GaudiMP_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_cflags) 
lib_GaudiMP_pp_cflags=  $(Python_pp_cflags) 
lib_GaudiMP_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_cppflags) 
lib_GaudiMP_pp_cppflags=  $(Python_pp_cppflags) 
lib_GaudiMP_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_fflags) 
lib_GaudiMP_pp_fflags=  $(Python_pp_fflags) 
GaudiMPComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPGen_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiMPDict_use_linkopts=  $(GaudiMP_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
lib_GaudiMPDict_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_cflags) 
lib_GaudiMPDict_pp_cflags=  $(Python_pp_cflags) 
lib_GaudiMPDict_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_cppflags) 
lib_GaudiMPDict_pp_cppflags=  $(Python_pp_cppflags) 
lib_GaudiMPDict_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7"  $(Python_fflags) 
lib_GaudiMPDict_pp_fflags=  $(Python_pp_fflags) 
GaudiMPDict_stamps=  $(Python_stamps) 
...
constituents= install_more_includes GaudiMP_python GaudiMPGenConfUser GaudiMPConfUserDbMerge GaudiMP_python_init zip_GaudiMP_python_modules install_scripts GaudiMPLib GaudiMP GaudiMPComponentsList GaudiMPMergeComponentsList GaudiMPConf GaudiMPConfDbMerge GaudiMPGen GaudiMPDict 
all_constituents= $(constituents)
constituentsclean= GaudiMPDictclean GaudiMPGenclean GaudiMPConfDbMergeclean GaudiMPConfclean GaudiMPMergeComponentsListclean GaudiMPComponentsListclean GaudiMPclean GaudiMPLibclean install_scriptsclean zip_GaudiMP_python_modulesclean GaudiMP_python_initclean GaudiMPConfUserDbMergeclean GaudiMPGenConfUserclean GaudiMP_pythonclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
GaudiMPLibprototype_dependencies= $(GaudiMPLibcompile_dependencies)
GaudiMPcompile_dependencies= GaudiMPLibprototype
GaudiMPprototype_dependencies= $(GaudiMPcompile_dependencies)
GaudiMPDictcompile_dependencies= GaudiMPLibprototype GaudiMPGen
GaudiMPDictprototype_dependencies= $(GaudiMPDictcompile_dependencies)
