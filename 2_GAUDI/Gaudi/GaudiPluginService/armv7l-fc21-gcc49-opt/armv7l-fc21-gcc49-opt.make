...
pp_cppflags=-D_GNU_SOURCE -DGAUDI_V20_COMPAT  -DBOOST_FILESYSTEM_VERSION=3  -DBOOST_SPIRIT_USE_PHOENIX_V3  $(CppSpecificFlags) -DHAVE_GAUDI_PLUGINSVC  -DGaudiPluginService_EXPORTS  -DGAUDI_REFLEX_COMPONENT_ALIASES 
...
includes= $(ppcmd)"$(GaudiPluginService_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
GaudiPluginService_linkopts= -lGaudiPluginService 
GaudiPluginService_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiPluginService_use_linkopts) -Wl,-soname=$(library_prefix)GaudiPluginService.$(shlibsuffix) 
GaudiPluginService_use_linkopts=    $(GaudiPolicy_linkopts)  $(LCG_Settings_linkopts) 
...
lib_GaudiPluginService_pp_cppflags= -DGAUDI_LINKER_LIBRARY 
GaudiPluginServiceexportsymb=-export_all_symbols
GaudiPluginServiceinstalllib=yes
do_genconfuser=fake_genconfuser
zip_GaudiPluginService_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiPluginService_python_modules_deps=FORCE
zip_GaudiPluginService_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiPluginService_python_modules_pattern_applied=CallCommand
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiPluginService_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
...
version=v1r2
PACKAGE_ROOT=$(GAUDIPLUGINSERVICEROOT)
srcdir=../src
bin=../$(GaudiPluginService_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiPluginService/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(LCG_Settings_linkopts) 
...
use_stamps=  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(LCG_Settings_stamps) 
use_cflags=  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(LCG_Settings_cflags) 
use_pp_cflags=  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(LCG_Settings_pp_cflags) 
use_cppflags=  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(LCG_Settings_cppflags) 
use_pp_cppflags=  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(LCG_Settings_pp_cppflags) 
use_fflags=  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(LCG_Settings_fflags) 
use_pp_fflags=  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(LCG_Settings_pp_fflags) 
...
GaudiPluginService_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiPluginService_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiPluginService_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiPluginService_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
listcomponents_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
listcomponents_use_linkopts=  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(LCG_Settings_linkopts) 
...
constituents= install_more_includes GaudiPluginService GaudiPluginService_python GaudiPluginService_python_init zip_GaudiPluginService_python_modules listcomponents 
all_constituents= $(constituents)
constituentsclean= listcomponentsclean zip_GaudiPluginService_python_modulesclean GaudiPluginService_python_initclean GaudiPluginService_pythonclean GaudiPluginServiceclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
GaudiPluginServiceprototype_dependencies= $(GaudiPluginServicecompile_dependencies)
listcomponentscompile_dependencies= GaudiPluginServiceprototype
listcomponentsprototype_dependencies= $(listcomponentscompile_dependencies)
