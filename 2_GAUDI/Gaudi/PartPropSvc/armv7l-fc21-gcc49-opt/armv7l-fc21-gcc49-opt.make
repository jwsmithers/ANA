...
includes= $(ppcmd)"$(PartPropSvc_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
...
PartPropSvc_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(PartPropSvc_use_linkopts)  
...
PartPropSvcMergeComponentsList_dependencies= PartPropSvcComponentsList 
...
PartPropSvcConf_dependencies= PartPropSvc 
zip_PartPropSvc_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_PartPropSvc_python_modules_deps=FORCE
zip_PartPropSvc_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_PartPropSvc_python_modules_pattern_applied=CallCommand
zip_PartPropSvc_python_modules_dependencies= PartPropSvc_python_init  PartPropSvcConfDbMerge 
PartPropSvc_python_init_dependencies= PartPropSvcConf 
merge_genconfDb_tag=--do-merge
PartPropSvcConfDbMerge_dependencies= PartPropSvcConf 
DATAPATH=/home/jwsmith/HDD/Gaudi/PartPropSvc/share
PartPropSvc_joboptions= -s=../share PartPropSvc.py 
constituents=install_more_includes PartPropSvc PartPropSvcComponentsList PartPropSvcMergeComponentsList PartPropSvcConf PartPropSvc_python_init zip_PartPropSvc_python_modules PartPropSvcConfDbMerge install_joboptions 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(PartPropSvc_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
generate_manifest_file_applied=NullCommand
dummy_for_NullCommand=generate_manifest_file 
tag=armv7l-fc21-gcc49-opt
package=PartPropSvc
version=v5r1
PACKAGE_ROOT=$(PARTPROPSVCROOT)
srcdir=../src
bin=../$(PartPropSvc_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/PartPropSvc/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(PartPropSvc_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(HepPDT_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(PartPropSvc_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(Boost_stamps)  $(HepPDT_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(PartPropSvc_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(Boost_cflags)  $(HepPDT_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(PartPropSvc_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(Boost_pp_cflags)  $(HepPDT_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(PartPropSvc_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(Boost_cppflags)  $(HepPDT_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(PartPropSvc_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(Boost_pp_cppflags)  $(HepPDT_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(PartPropSvc_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(Boost_fflags)  $(HepPDT_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(PartPropSvc_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(Boost_pp_fflags)  $(HepPDT_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(GaudiCoreSvc_libraries)  $(GaudiKernel_libraries)  $(GaudiPluginService_libraries)  $(GaudiPolicy_libraries)  $(Reflex_libraries)  $(ROOT_libraries)  $(Boost_libraries)  $(Python_libraries)  $(tcmalloc_libraries)  $(libunwind_libraries)  $(GCCXML_libraries)  $(xrootd_libraries)  $(HepPDT_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PartPropSvc_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PartPropSvc_use_linkopts=  $(PartPropSvc_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(HepPDT_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
PartPropSvcComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PartPropSvcMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PartPropSvcConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PartPropSvc_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_PartPropSvc_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PartPropSvcConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
...
constituentsclean= install_joboptionsclean PartPropSvcConfDbMergeclean zip_PartPropSvc_python_modulesclean PartPropSvc_python_initclean PartPropSvcConfclean PartPropSvcMergeComponentsListclean PartPropSvcComponentsListclean PartPropSvcclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
PartPropSvcprototype_dependencies= $(PartPropSvccompile_dependencies)
