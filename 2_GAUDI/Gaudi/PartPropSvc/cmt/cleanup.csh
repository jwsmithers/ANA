...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=PartPropSvc -version=v5r1 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtPartPropSvctempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=PartPropSvc -version=v5r1 -path=/home/jwsmith/HDD/Gaudi  $* >${cmtPartPropSvctempfile}"
