...
includes= $(ppcmd)"$(GaudiGSL_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
...
GSL_linkopts= -Wl,--no-as-needed -L$(GSL_home)/lib -lgsl -lgslcblas  -Wl,--as-needed 
...
GaudiGSLLib_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiGSLLib_use_linkopts) -Wl,-soname=$(library_prefix)GaudiGSLLib.$(shlibsuffix) 
GaudiGSLLib_use_linkopts=    $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
GaudiGSL_stamps=${GAUDIGSLROOT}/${BINDIR}/GaudiGSLLib.stamp   $(AIDA_stamps) 
GaudiGSL_linker_library=GaudiGSLLib
lib_GaudiGSLLib_pp_cppflags= -DGAUDI_LINKER_LIBRARY   $(AIDA_pp_cppflags) 
GaudiGSLLibexportsymb=-export_all_symbols
GaudiGSLLibinstalllib=yes
GaudiGSL_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(GaudiGSL_use_linkopts)  
...
GaudiGSLMergeComponentsList_dependencies= GaudiGSLComponentsList 
...
GaudiGSLConf_dependencies= GaudiGSL 
zip_GaudiGSL_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiGSL_python_modules_deps=FORCE
zip_GaudiGSL_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiGSL_python_modules_pattern_applied=CallCommand
zip_GaudiGSL_python_modules_dependencies= GaudiGSL_python_init  GaudiGSLConfDbMerge 
GaudiGSL_python_init_dependencies= GaudiGSLConf 
merge_genconfDb_tag=--do-merge
GaudiGSLConfDbMerge_dependencies= GaudiGSLConf 
GaudiGSLMath_reflex_selection_file= $(GAUDIGSLROOT)/dict/GaudiGSLMath.xml 
GaudiGSLMath_rootmap=$(CMTINSTALLAREA)/$(tag)/lib/GAUDIDict.rootmap
GaudiGSLMath_reflex_options= --split --reflex -U_Instantiations -D_Instantiations=GaudiGSLMath_Instantiations $(gccxmlopts) --select=$(GAUDIGSLROOT)/dict/GaudiGSLMath.xml  --gccxmlpath=$(GCCXML_home)/bin
GaudiGSLMathDict_dependencies=$(GaudiGSL_linker_library) GaudiGSLMathGen
GaudiGSLMathDict_shlibflags= $(GaudiGSL_linkopts) $(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiGSL_linkopts) $(GaudiGSLMathDict_use_linkopts) 
ExceptionsTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
DerivativeTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
SimpleFuncTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
IntegralInTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
Integral1Testlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
2DoubleFuncTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
3DoubleFuncTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
PFuncTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
InterpTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
GSLAdaptersTestlinkopts= $(GaudiGSL_linkopts) $(use_linkopts) 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiGSL_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
generate_manifest_file_applied=NullCommand
dummy_for_NullCommand=generate_manifest_file 
tag=armv7l-fc21-gcc49-opt
package=GaudiGSL
version=v8r2
PACKAGE_ROOT=$(GAUDIGSLROOT)
srcdir=../src
bin=../$(GaudiGSL_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiGSL/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_includes= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../ROOT/v5-34-21/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../ROOT/v5-34-21/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Boost/1.55.0_python2.7/armv7l-fc21-gcc49-opt/include/boost-1_55" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../xrootd/3.3.6/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../GSL/1.10/armv7l-fc21-gcc49-opt/include" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../clhep/1.9.4.7/armv7l-fc21-gcc49-opt/include" $(ppcmd)"$(LCG_Platforms_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(GaudiGSL_stamps)  $(GaudiAlg_stamps)  $(GaudiUtils_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(ROOT_stamps)  $(Boost_stamps)  $(xrootd_stamps)  $(GSL_stamps)  $(CLHEP_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(GaudiGSL_cflags)  $(GaudiAlg_cflags)  $(GaudiUtils_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(ROOT_cflags)  $(Boost_cflags)  $(xrootd_cflags)  $(GSL_cflags)  $(CLHEP_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(GaudiGSL_pp_cflags)  $(GaudiAlg_pp_cflags)  $(GaudiUtils_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(ROOT_pp_cflags)  $(Boost_pp_cflags)  $(xrootd_pp_cflags)  $(GSL_pp_cflags)  $(CLHEP_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(GaudiGSL_cppflags)  $(GaudiAlg_cppflags)  $(GaudiUtils_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(ROOT_cppflags)  $(Boost_cppflags)  $(xrootd_cppflags)  $(GSL_cppflags)  $(CLHEP_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(GaudiGSL_pp_cppflags)  $(GaudiAlg_pp_cppflags)  $(GaudiUtils_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(ROOT_pp_cppflags)  $(Boost_pp_cppflags)  $(xrootd_pp_cppflags)  $(GSL_pp_cppflags)  $(CLHEP_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(GaudiGSL_fflags)  $(GaudiAlg_fflags)  $(GaudiUtils_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(ROOT_fflags)  $(Boost_fflags)  $(xrootd_fflags)  $(GSL_fflags)  $(CLHEP_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(GaudiGSL_pp_fflags)  $(GaudiAlg_pp_fflags)  $(GaudiUtils_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(ROOT_pp_fflags)  $(Boost_pp_fflags)  $(xrootd_pp_fflags)  $(GSL_pp_fflags)  $(CLHEP_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(GaudiAlg_libraries)  $(GaudiUtils_libraries)  $(GaudiCoreSvc_libraries)  $(GaudiKernel_libraries)  $(GaudiPluginService_libraries)  $(GaudiPolicy_libraries)  $(Reflex_libraries)  $(ROOT_libraries)  $(Boost_libraries)  $(Python_libraries)  $(tcmalloc_libraries)  $(libunwind_libraries)  $(GCCXML_libraries)  $(xrootd_libraries)  $(AIDA_libraries)  $(uuid_libraries)  $(XercesC_libraries)  $(GSL_libraries)  $(CLHEP_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSLLib_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lib_GaudiGSLLib_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cflags) 
lib_GaudiGSLLib_pp_cflags=  $(AIDA_pp_cflags) 
lib_GaudiGSLLib_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cppflags) 
lib_GaudiGSLLib_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_fflags) 
lib_GaudiGSLLib_pp_fflags=  $(AIDA_pp_fflags) 
GaudiGSLLib_stamps=  $(AIDA_stamps) 
GaudiGSL_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSL_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(AIDA_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
lib_GaudiGSL_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cflags) 
lib_GaudiGSL_pp_cflags=  $(AIDA_pp_cflags) 
lib_GaudiGSL_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_cppflags) 
lib_GaudiGSL_pp_cppflags=  $(AIDA_pp_cppflags) 
lib_GaudiGSL_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../AIDA/3.2.1/armv7l-fc21-gcc49-opt/src/cpp"  $(AIDA_fflags) 
lib_GaudiGSL_pp_fflags=  $(AIDA_pp_fflags) 
GaudiGSLComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSLMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSLConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSL_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiGSL_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSLConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSLMathGen_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSLMathDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiGSLMathDict_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
ExceptionsTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
ExceptionsTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
DerivativeTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
DerivativeTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
SimpleFuncTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
SimpleFuncTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
IntegralInTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
IntegralInTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
Integral1Test_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Integral1Test_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
2DoubleFuncTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
2DoubleFuncTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
3DoubleFuncTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
3DoubleFuncTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
PFuncTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PFuncTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
InterpTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
InterpTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
GSLAdaptersTest_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GSLAdaptersTest_use_linkopts=  $(GaudiGSL_linkopts)  $(GaudiAlg_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(GSL_linkopts)  $(CLHEP_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituents= install_more_includes GaudiGSLLib GaudiGSL GaudiGSLComponentsList GaudiGSLMergeComponentsList GaudiGSLConf GaudiGSL_python_init zip_GaudiGSL_python_modules GaudiGSLConfDbMerge GaudiGSLMathGen GaudiGSLMathDict 
all_constituents= $(constituents)
constituentsclean= GaudiGSLMathDictclean GaudiGSLMathGenclean GaudiGSLConfDbMergeclean zip_GaudiGSL_python_modulesclean GaudiGSL_python_initclean GaudiGSLConfclean GaudiGSLMergeComponentsListclean GaudiGSLComponentsListclean GaudiGSLclean GaudiGSLLibclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
tests_constituents= ExceptionsTest DerivativeTest SimpleFuncTest IntegralInTest Integral1Test 2DoubleFuncTest 3DoubleFuncTest PFuncTest InterpTest GSLAdaptersTest 
tests_constituentsclean= GSLAdaptersTestclean InterpTestclean PFuncTestclean 3DoubleFuncTestclean 2DoubleFuncTestclean Integral1Testclean IntegralInTestclean SimpleFuncTestclean DerivativeTestclean ExceptionsTestclean 
GaudiGSLLibprototype_dependencies= $(GaudiGSLLibcompile_dependencies)
GaudiGSLcompile_dependencies= GaudiGSLLibprototype
GaudiGSLprototype_dependencies= $(GaudiGSLcompile_dependencies)
GaudiGSLMathDictcompile_dependencies= GaudiGSLLibprototype GaudiGSLMathGen
GaudiGSLMathDictprototype_dependencies= $(GaudiGSLMathDictcompile_dependencies)
ExceptionsTestprototype_dependencies= $(ExceptionsTestcompile_dependencies)
DerivativeTestprototype_dependencies= $(DerivativeTestcompile_dependencies)
SimpleFuncTestprototype_dependencies= $(SimpleFuncTestcompile_dependencies)
IntegralInTestprototype_dependencies= $(IntegralInTestcompile_dependencies)
Integral1Testprototype_dependencies= $(Integral1Testcompile_dependencies)
2DoubleFuncTestprototype_dependencies= $(2DoubleFuncTestcompile_dependencies)
3DoubleFuncTestprototype_dependencies= $(3DoubleFuncTestcompile_dependencies)
PFuncTestprototype_dependencies= $(PFuncTestcompile_dependencies)
InterpTestprototype_dependencies= $(InterpTestcompile_dependencies)
GSLAdaptersTestprototype_dependencies= $(GSLAdaptersTestcompile_dependencies)
