...
ROOT_linkopts=-L$(ROOT_home)/lib -lCore -lCint -lTree -lpthread  -lRIO -lTreePlayer -lMathCore 
...
includes= $(ppcmd)"$(RootCnv_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
...
RootCnv_reflex_selection_file= $(ROOTCNVROOT)/dict/RootCnv_dict.xml 
RootCnv_rootmap=$(CMTINSTALLAREA)/$(tag)/lib/GAUDIDict.rootmap
RootCnv_reflex_options=  -U_Instantiations -D_Instantiations=RootCnv_Instantiations $(gccxmlopts) --select=$(ROOTCNVROOT)/dict/RootCnv_dict.xml  --gccxmlpath=$(GCCXML_home)/bin
RootCnvDict_dependencies=$(RootCnv_linker_library) RootCnvGen
RootCnvDict_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(RootCnv_linkopts) $(RootCnvDict_use_linkopts) 
RootCnvLib_pp_cppflags= -D__POOL_COMPATIBILITY 
RootCnv_linkopts= -lRootCnvLib 
RootCnvLib_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(RootCnvLib_use_linkopts) -Wl,-soname=$(library_prefix)RootCnvLib.$(shlibsuffix) 
RootCnvLib_use_linkopts=    $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
RootCnv_stamps=${ROOTCNVROOT}/${BINDIR}/RootCnvLib.stamp 
RootCnv_linker_library=RootCnvLib
lib_RootCnvLib_pp_cppflags= -DGAUDI_LINKER_LIBRARY 
RootCnvLibexportsymb=-export_all_symbols
RootCnvLibinstalllib=yes
RootCnv_pp_cppflags= -D__POOL_COMPATIBILITY 
RootCnv_shlibflags=$(componentshr_linkopts) $(cmt_installarea_linkopts) $(RootCnv_use_linkopts)  
...
RootCnvMergeComponentsList_dependencies= RootCnvComponentsList 
...
RootCnvConf_dependencies= RootCnv 
zip_RootCnv_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_RootCnv_python_modules_deps=FORCE
zip_RootCnv_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_RootCnv_python_modules_pattern_applied=CallCommand
zip_RootCnv_python_modules_dependencies= RootCnv_python_init  RootCnvConfDbMerge 
RootCnv_python_init_dependencies= RootCnvConf 
merge_genconfDb_tag=--do-merge
RootCnvConfDbMerge_dependencies= RootCnvConf 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(RootCnv_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
generate_manifest_file_applied=NullCommand
dummy_for_NullCommand=generate_manifest_file 
tag=armv7l-fc21-gcc49-opt
package=RootCnv
version=v1r22p2
PACKAGE_ROOT=$(ROOTCNVROOT)
srcdir=../src
bin=../$(RootCnv_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/RootCnv/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(RootCnv_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(RootCnv_stamps)  $(GaudiUtils_stamps)  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(ROOT_stamps)  $(Boost_stamps)  $(xrootd_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(RootCnv_cflags)  $(GaudiUtils_cflags)  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(ROOT_cflags)  $(Boost_cflags)  $(xrootd_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(RootCnv_pp_cflags)  $(GaudiUtils_pp_cflags)  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(ROOT_pp_cflags)  $(Boost_pp_cflags)  $(xrootd_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(RootCnv_cppflags)  $(GaudiUtils_cppflags)  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(ROOT_cppflags)  $(Boost_cppflags)  $(xrootd_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(RootCnv_pp_cppflags)  $(GaudiUtils_pp_cppflags)  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(ROOT_pp_cppflags)  $(Boost_pp_cppflags)  $(xrootd_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(RootCnv_fflags)  $(GaudiUtils_fflags)  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(ROOT_fflags)  $(Boost_fflags)  $(xrootd_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(RootCnv_pp_fflags)  $(GaudiUtils_pp_fflags)  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(ROOT_pp_fflags)  $(Boost_pp_fflags)  $(xrootd_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(GaudiUtils_libraries)  $(GaudiCoreSvc_libraries)  $(GaudiKernel_libraries)  $(GaudiPluginService_libraries)  $(GaudiPolicy_libraries)  $(Reflex_libraries)  $(ROOT_libraries)  $(Boost_libraries)  $(Python_libraries)  $(tcmalloc_libraries)  $(libunwind_libraries)  $(GCCXML_libraries)  $(xrootd_libraries)  $(AIDA_libraries)  $(uuid_libraries)  $(XercesC_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnvGen_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnvDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnvDict_use_linkopts=  $(RootCnv_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
RootCnvLib_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnv_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnv_use_linkopts=  $(RootCnv_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
RootCnvComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnvMergeComponentsList_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnvConf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnv_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_RootCnv_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RootCnvConfDbMerge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
gaudi_merge_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
gaudi_merge_use_linkopts=  $(RootCnv_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
extract_event_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
extract_event_use_linkopts=  $(RootCnv_linkopts)  $(GaudiUtils_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(xrootd_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituents= install_more_includes RootCnvGen RootCnvDict RootCnvLib RootCnv RootCnvComponentsList RootCnvMergeComponentsList RootCnvConf RootCnv_python_init zip_RootCnv_python_modules RootCnvConfDbMerge gaudi_merge extract_event 
all_constituents= $(constituents)
constituentsclean= extract_eventclean gaudi_mergeclean RootCnvConfDbMergeclean zip_RootCnv_python_modulesclean RootCnv_python_initclean RootCnvConfclean RootCnvMergeComponentsListclean RootCnvComponentsListclean RootCnvclean RootCnvLibclean RootCnvDictclean RootCnvGenclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
RootCnvDictcompile_dependencies= RootCnvLibprototype RootCnvGen
RootCnvDictprototype_dependencies= $(RootCnvDictcompile_dependencies)
RootCnvLibprototype_dependencies= $(RootCnvLibcompile_dependencies)
RootCnvcompile_dependencies= RootCnvLibprototype RootCnvLibprototype
RootCnvprototype_dependencies= $(RootCnvcompile_dependencies)
gaudi_mergecompile_dependencies= RootCnvLibprototype
gaudi_mergeprototype_dependencies= $(gaudi_mergecompile_dependencies)
extract_eventcompile_dependencies= RootCnvLibprototype
extract_eventprototype_dependencies= $(extract_eventcompile_dependencies)
