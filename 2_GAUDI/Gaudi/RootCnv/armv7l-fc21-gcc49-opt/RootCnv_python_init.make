...
tags      = $(tag),$(CMTEXTRATAGS),target_RootCnv_python_init

RootCnv_tag = $(tag)

#cmt_local_tagfile_RootCnv_python_init = $(RootCnv_tag)_RootCnv_python_init.make
...
#cmt_local_tagfile_RootCnv_python_init = $(RootCnv_tag).make
cmt_local_tagfile_RootCnv_python_init = $(bin)$(RootCnv_tag).make

endif

include $(cmt_local_tagfile_RootCnv_python_init)
#-include $(cmt_local_tagfile_RootCnv_python_init)

ifdef cmt_RootCnv_python_init_has_target_tag

cmt_final_setup_RootCnv_python_init = $(bin)setup_RootCnv_python_init.make
cmt_dependencies_in_RootCnv_python_init = $(bin)dependencies_RootCnv_python_init.in
#cmt_final_setup_RootCnv_python_init = $(bin)RootCnv_RootCnv_python_initsetup.make
cmt_local_RootCnv_python_init_makefile = $(bin)RootCnv_python_init.make

else

cmt_final_setup_RootCnv_python_init = $(bin)setup.make
cmt_dependencies_in_RootCnv_python_init = $(bin)dependencies.in
#cmt_final_setup_RootCnv_python_init = $(bin)RootCnvsetup.make
cmt_local_RootCnv_python_init_makefile = $(bin)RootCnv_python_init.make
...
help ::
	$(echo) 'RootCnv_python_init'

binobj = 
ifdef STRUCTURED_OUTPUT
binobj = RootCnv_python_init/
#RootCnv_python_init::
...
install_python_dir = $(installarea)/python/RootCnv
init_file = $(install_python_dir)/__init__.py


RootCnv_python_init :: RootCnv_python_initinstall

install :: RootCnv_python_initinstall

RootCnv_python_initinstall :: $(init_file)
...
RootCnv_python_initclean :: RootCnv_python_inituninstall

uninstall :: RootCnv_python_inituninstall

RootCnv_python_inituninstall ::
...
ifndef PEDANTIC
.DEFAULT::
	$(echo) "(RootCnv_python_init.make) $@: No rule for such target" >&2
else
.DEFAULT::
	$(error PEDANTIC: $@: No rule for such target)
endif

RootCnv_python_initclean ::
