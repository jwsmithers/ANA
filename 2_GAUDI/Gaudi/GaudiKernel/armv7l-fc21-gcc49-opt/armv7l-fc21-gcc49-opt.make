...
includes= $(ppcmd)"$(GaudiKernel_root)"  $(ppcmd)"/home/jwsmith/HDD/Gaudi/InstallArea/armv7l-fc21-gcc49-opt/include" $(use_includes)
...
Boost_linkopts=-L$(Boost_home)/lib  $(Boost_linkopts_thread) $(Boost_linkopts_date_time) $(Boost_linkopts_system) $(Boost_linkopts_filesystem) 
...
GaudiKernel_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GaudiKernel_use_linkopts) -Wl,-soname=$(library_prefix)GaudiKernel.$(shlibsuffix) 
GaudiKernel_use_linkopts=    $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
GaudiKernel_stamps=${GAUDIKERNELROOT}/${BINDIR}/GaudiKernel.stamp 
GaudiKernel_linker_library=GaudiKernel
lib_GaudiKernel_pp_cppflags= -DGAUDI_LINKER_LIBRARY 
GaudiKernelexportsymb=-export_all_symbols
GaudiKernelinstalllib=yes
do_genconfuser=fake_genconfuser
zip_GaudiKernel_python_modules_output=$(CMTINSTALLAREA)$(shared_install_subdir)/python.zip
zip_GaudiKernel_python_modules_deps=FORCE
zip_GaudiKernel_python_modules_command=test -d $(CMTINSTALLAREA)$(shared_install_subdir)/python && python $(GaudiPolicy_root)/scripts/ZipPythonDir.py $(CMTINSTALLAREA)$(shared_install_subdir)/python || echo Nothing to zip.
zip_GaudiKernel_python_modules_pattern_applied=CallCommand
...
GaudiKernel_rootmap=$(CMTINSTALLAREA)/$(tag)/lib/GAUDIDict.rootmap
GaudiKernel_reflex_options=  -U_Instantiations -D_Instantiations=GaudiKernel_Instantiations $(gccxmlopts) --select=$(GAUDIKERNELROOT)/dict/dictionary.xml  --gccxmlpath=$(GCCXML_home)/bin
...
GaudiKernelDict_use_linkopts=$(use_linkopts)  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
GaudiKernelGen_dependencies=install_more_includes
genconfig_cmd=genconf.exe
genconflinkopts=-ldl $(GaudiKernel_linkopts) $(Boost_linkopts) $(Boost_linkopts_filesystem) $(Boost_linkopts_regex) $(Boost_linkopts_program_options)
genconf_dependencies=GaudiKernel
CppUnit_tag=$(tag)
...
app_test_SerializeSTL_cppflags= -Wno-unused-parameter  $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_GaudiTime_cppflags= -Wno-unused-parameter  $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_GaudiTiming_cppflags= -Wno-unused-parameter  $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
dictionary_dict_cpp_cppflags= -Wno-overloaded-virtual 
GaudiKernel_arflags= /expectedoutputsize:1000000000 
...
generate_manifest_file_command=python $(GaudiPolicy_root)/scripts/project_manifest.py -o $(generate_manifest_file_output) $(GaudiKernel_cmtpath)/CMakeLists.txt $(LCG_config_version) $(tag)
generate_manifest_file_applied=NullCommand
dummy_for_NullCommand=generate_manifest_file 
tag=armv7l-fc21-gcc49-opt
package=GaudiKernel
version=v31r0
PACKAGE_ROOT=$(GAUDIKERNELROOT)
srcdir=../src
bin=../$(GaudiKernel_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/Gaudi/GaudiKernel/armv7l-fc21-gcc49-opt/
project=GAUDI
...
use_linkopts= $(cmt_installarea_linkopts)   $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(GaudiPluginService_root)/cmt/requirements $(GaudiPolicy_root)/cmt/requirements $(Reflex_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(tcmalloc_root)/cmt/requirements $(libunwind_root)/cmt/requirements $(GCCXML_root)/cmt/requirements $(xrootd_root)/cmt/requirements $(CppUnit_root)/cmt/requirements $(LCG_Settings_root)/cmt/requirements $(LCG_Configuration_root)/cmt/requirements $(LCG_Platforms_root)/cmt/requirements 
...
use_stamps=  $(GaudiKernel_stamps)  $(GaudiPluginService_stamps)  $(GaudiPolicy_stamps)  $(Reflex_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(GaudiKernel_cflags)  $(GaudiPluginService_cflags)  $(GaudiPolicy_cflags)  $(Reflex_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(GaudiKernel_pp_cflags)  $(GaudiPluginService_pp_cflags)  $(GaudiPolicy_pp_cflags)  $(Reflex_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_cppflags=  $(GaudiKernel_cppflags)  $(GaudiPluginService_cppflags)  $(GaudiPolicy_cppflags)  $(Reflex_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
use_pp_cppflags=  $(GaudiKernel_pp_cppflags)  $(GaudiPluginService_pp_cppflags)  $(GaudiPolicy_pp_cppflags)  $(Reflex_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(GaudiKernel_fflags)  $(GaudiPluginService_fflags)  $(GaudiPolicy_fflags)  $(Reflex_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(GaudiKernel_pp_fflags)  $(GaudiPluginService_pp_fflags)  $(GaudiPolicy_pp_fflags)  $(Reflex_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(GaudiPluginService_libraries)  $(GaudiPolicy_libraries)  $(Reflex_libraries)  $(ROOT_libraries)  $(Boost_libraries)  $(Python_libraries)  $(tcmalloc_libraries)  $(libunwind_libraries)  $(GCCXML_libraries)  $(xrootd_libraries)  $(CppUnit_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiKernel_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_scripts_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiKernel_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiKernel_python_init_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
zip_GaudiKernel_python_modules_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiKernelGen_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GaudiKernelDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
genconf_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
genconf_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
DirSearchPath_test_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
DirSearchPath_test_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
PathResolver_test_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PathResolver_test_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
Memory_test_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Memory_test_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
Parsers_test_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Parsers_test_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
test_SerializeSTL_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_SerializeSTL_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_SerializeSTL_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_SerializeSTL_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_SerializeSTL_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_SerializeSTL_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_SerializeSTL_pp_fflags=  $(CppUnit_pp_fflags) 
test_SerializeSTL_stamps=  $(CppUnit_stamps) 
test_GaudiTime_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_GaudiTime_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_GaudiTime_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_GaudiTime_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_GaudiTime_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_GaudiTime_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_GaudiTime_pp_fflags=  $(CppUnit_pp_fflags) 
test_GaudiTime_stamps=  $(CppUnit_stamps) 
test_GaudiTiming_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_GaudiTiming_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_GaudiTiming_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_GaudiTiming_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_GaudiTiming_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_GaudiTiming_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_GaudiTiming_pp_fflags=  $(CppUnit_pp_fflags) 
test_GaudiTiming_stamps=  $(CppUnit_stamps) 
test_headers_build_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_headers_build_use_linkopts=  $(GaudiKernel_linkopts)  $(GaudiPluginService_linkopts)  $(GaudiPolicy_linkopts)  $(Reflex_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituents= install_more_includes GaudiKernel install_scripts GaudiKernel_python GaudiKernel_python_init zip_GaudiKernel_python_modules GaudiKernelGen GaudiKernelDict genconf 
all_constituents= $(constituents)
constituentsclean= genconfclean GaudiKernelDictclean GaudiKernelGenclean zip_GaudiKernel_python_modulesclean GaudiKernel_python_initclean GaudiKernel_pythonclean install_scriptsclean GaudiKernelclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
tests_constituents= DirSearchPath_test PathResolver_test Memory_test Parsers_test test_SerializeSTL test_GaudiTime test_GaudiTiming test_headers_build 
tests_constituentsclean= test_headers_buildclean test_GaudiTimingclean test_GaudiTimeclean test_SerializeSTLclean Parsers_testclean Memory_testclean PathResolver_testclean DirSearchPath_testclean 
GaudiKernelprototype_dependencies= $(GaudiKernelcompile_dependencies)
GaudiKernelDictcompile_dependencies= GaudiKernelprototype GaudiKernelGen
GaudiKernelDictprototype_dependencies= $(GaudiKernelDictcompile_dependencies)
genconfcompile_dependencies= GaudiKernelprototype
genconfprototype_dependencies= $(genconfcompile_dependencies)
DirSearchPath_testprototype_dependencies= $(DirSearchPath_testcompile_dependencies)
PathResolver_testprototype_dependencies= $(PathResolver_testcompile_dependencies)
Memory_testprototype_dependencies= $(Memory_testcompile_dependencies)
Parsers_testprototype_dependencies= $(Parsers_testcompile_dependencies)
test_SerializeSTLprototype_dependencies= $(test_SerializeSTLcompile_dependencies)
test_GaudiTimeprototype_dependencies= $(test_GaudiTimecompile_dependencies)
test_GaudiTimingprototype_dependencies= $(test_GaudiTimingcompile_dependencies)
test_headers_buildprototype_dependencies= $(test_headers_buildcompile_dependencies)
