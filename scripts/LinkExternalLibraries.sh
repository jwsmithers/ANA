...
ln -s $LCG_install/CppUnit/1.12.1_p1/$CMTCONFIG/lib/* $TopDir/AtlasCore/AtlasCore-18.9.0/InstallArea/$CMTCONFIG/lib/
ln -s $LCG_install/tbb/42_20140122/$CMTCONFIG/lib/*  $TopDir/AtlasCore/AtlasCore-18.9.0/InstallArea/$CMTCONFIG/lib/ 

ln -s $LCG_install/gperftools/2.2.1/$CMTCONFIG/include/google $TopDir/AtlasCore/AtlasCore-18.9.0/InstallArea/include
ln -s $LCG_install/gperftools/2.2.1/$CMTCONFIG/include/gperftools $TopDir/AtlasCore/AtlasCore-18.9.0/InstallArea/include
ln -s $LCG_install/CppUnit/1.12.1_p1/$CMTCONFIG/include/cppunit $TopDir/AtlasCore/AtlasCore-18.9.0/InstallArea/include
ln -s $LCG_install/valgrind/3.10.0/$CMTCONFIG/include/valgrind $TopDir/AtlasCore/AtlasCore-18.9.0/InstallArea/include
ln -s $LCG_install/tbb/42_20140122/$CMTCONFIG/include/tbb $TopDir/AtlasCore/AtlasCore-18.9.0/InstallArea/include
