  ...
  public:
      ...
      : CoralCppUnitTest()
    {
      ...
      if ( coralTestDb )
        ...
        connectionString = coralConnStringAdmin;
    }
    ...
    setUp()
    {
      ...
      schema.dropIfExistsTable( BuildUniqueTableName( TABLENAME1 ) );

      {
        //std::cout << "Describing new tables" << std::endl;
        coral::TableDescription description;
        description.setName( BuildUniqueTableName( TABLENAME1 ) );
      ...
      {
        //std::cout << "About to drop previous table" << std::endl;
        schema.dropIfExistsTable( BuildUniqueTableName( TABLENAME2 ) );

        //std::cout << "Describing new tables" << std::endl;
        coral::TableDescription description;
        description.setName( BuildUniqueTableName( TABLENAME2 ) );
        description.insertColumn( "ID",
                                  coral::AttributeSpecification::typeNameForId( typeid(int) ) );
        description.setPrimaryKey( "ID" );
        description.insertColumn( "X",
    ...
    test_setPrimaryKey()
    {
      ...
      coral::ITable& table = schema.tableHandle( BuildUniqueTableName( TABLENAME1 ) );
    ...
    test_createForeignKey()
    {
      ...
      schemaEditor.createForeignKey( "foreignKey1",
                                     "X",
                                     BuildUniqueTableName( TABLENAME2 ),
                                     "ID");
