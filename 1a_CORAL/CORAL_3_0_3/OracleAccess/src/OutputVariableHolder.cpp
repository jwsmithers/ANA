  ...
  m_ociDateTime( 0 )
{
  ...
  std::cout << "Create TimeOutputVariableHolder " << this << std::endl; // debug bug #98736
#endif
...
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Delete TimeOutputVariableHolder " << this << std::endl; // debug bug #98736
#endif
...
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Create NumberOutputVariableHolder " << this << std::endl; // debug bug #98736
#endif
}
...
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Delete NumberOutputVariableHolder " << this << std::endl; // debug bug #98736
#endif
  delete m_ociNumber;
}
...
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Create BlobOutputVariableHolder " << this << std::endl; // debug bug #98736
#endif
  void* temporaryPointer = 0;
  sword status = OCIDescriptorAlloc( m_sessionProperties->ociEnvHandle(),
                                     &temporaryPointer,
...
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Delete BlobOutputVariableHolder " << this << std::endl; // debug bug #98736
#endif
...
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Create ClobOutputVariableHolder " << this << std::endl; // debug bug #98736
#endif
  void* temporaryPointer = 0;
  sword status = OCIDescriptorAlloc( m_sessionProperties->ociEnvHandle(),
                                     &temporaryPointer,
...
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Delete ClobOutputVariableHolder " << this << std::endl; // debug bug #98736
#endif
  if (m_locator) OCIDescriptorFree(m_locator, OCI_DTYPE_LOB);
}
