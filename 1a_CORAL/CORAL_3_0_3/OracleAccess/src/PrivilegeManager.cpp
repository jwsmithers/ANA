  ...
  m_tableName( tableName )
{
  ...
  std::cout << "Create PrivilegeManager " << this << std::endl; // debug bug #98736
#endif
}


coral::OracleAccess::PrivilegeManager::~PrivilegeManager()
{
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
  std::cout << "Delete PrivilegeManager " << this << std::endl; // debug bug #98736
#endif
}
