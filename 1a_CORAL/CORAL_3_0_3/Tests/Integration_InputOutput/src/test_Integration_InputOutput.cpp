...
#include "CoralCommon/boost_random_headers.h"
...
void InputOutput::prepareSchema()
{
  ...
  description.insertColumn( "V_B", coral::AttributeSpecification::typeNameForId( typeid( bool ) ) );
  rowBuffer.extend<bool>( "V_B" );
  description.insertColumn( "V_UC", coral::AttributeSpecification::typeNameForId( typeid( unsigned char ) ) );
  rowBuffer.extend<unsigned char>( "V_UC" );
  description.insertColumn( "V_SC", coral::AttributeSpecification::typeNameForId( typeid( char ) ) );
  rowBuffer.extend<char>( "V_SC" );
  description.insertColumn( "V_US", coral::AttributeSpecification::typeNameForId( typeid( unsigned short ) ) );
  rowBuffer.extend<unsigned short>( "V_US" );
  description.insertColumn( "V_SS", coral::AttributeSpecification::typeNameForId( typeid( short ) ) );
  rowBuffer.extend<short>( "V_SS" );
  description.insertColumn( "V_UI", coral::AttributeSpecification::typeNameForId( typeid( unsigned int ) ) );
  rowBuffer.extend<unsigned int>( "V_UI" );
  description.insertColumn( "V_SI", coral::AttributeSpecification::typeNameForId( typeid( int ) ) );
  rowBuffer.extend<int>( "V_SI" );
  description.insertColumn( "V_UL", coral::AttributeSpecification::typeNameForId( typeid( unsigned long ) ) );
  rowBuffer.extend<unsigned long>( "V_UL" );
  description.insertColumn( "V_SL", coral::AttributeSpecification::typeNameForId( typeid( long ) ) );
  rowBuffer.extend<long>( "V_SL" );
  description.insertColumn( "V_ULL", coral::AttributeSpecification::typeNameForId( typeid( unsigned long long ) ) );
  rowBuffer.extend<unsigned long long>( "V_ULL" );
  description.insertColumn( "V_SLL", coral::AttributeSpecification::typeNameForId( typeid( long long ) ) );
  rowBuffer.extend<long long>( "V_SLL" );
  description.insertColumn( "V_F", coral::AttributeSpecification::typeNameForId( typeid( float ) ) );
  rowBuffer.extend<float>( "V_F" );
  description.insertColumn( "V_D", coral::AttributeSpecification::typeNameForId( typeid( double ) ) );
  rowBuffer.extend<double>( "V_D" );
  description.insertColumn( "V_LD", coral::AttributeSpecification::typeNameForId( typeid( double ) ) );
  rowBuffer.extend<double>( "V_LD" );
  description.insertColumn( "V_BLOB", coral::AttributeSpecification::typeNameForId( typeid( coral::Blob ) ) );
  rowBuffer.extend<coral::Blob>( "V_BLOB" );
  description.insertColumn( "V_DATE", coral::AttributeSpecification::typeNameForId( typeid( coral::Date ) ) );
  rowBuffer.extend<coral::Date>( "V_DATE" );
  description.insertColumn( "V_TIMESTAMP", coral::AttributeSpecification::typeNameForId( typeid( coral::TimeStamp ) ) );
  rowBuffer.extend<coral::TimeStamp>( "V_TIMESTAMP" );
  description.insertColumn( "V_SG", coral::AttributeSpecification::typeNameForId( typeid( std::string ) ) );
  rowBuffer.extend<std::string>( "V_SG" );
  description.insertColumn( "V_SF", coral::AttributeSpecification::typeNameForId( typeid( std::string ) ), 5 );
  rowBuffer.extend<std::string>( "V_SF" );
  description.insertColumn( "V_SV", coral::AttributeSpecification::typeNameForId( typeid( std::string ) ), 50, false );
...
void InputOutput::writeBulk()
{
  ...
  coral::ITableDataEditor& dataEditor = table.dataEditor();
  coral::AttributeList& rowBuffer = *m_rowBuffer;
  coral::IBulkOperation* bulkOperation = dataEditor.bulkInsert( rowBuffer, rowsWithSimpleInsert );
...
void InputOutput::read()
{
  ...
  {
    if ( ! cursor.next() ) // throws in bug #98345
...
InputOutput::prepareBigSchema()
{
  ...
  for(size_t i = 0; i < 20; i++ )
  {
    ...
    coral::boost_random_mt19937 rng;
    coral::boost_random_uniform_int rn256(0,255);
    for ( size_t j = 0; j < maxc; ++j, ++p )
      *p = rn256(rng);  // Fix Coverity SECURE_CODING (replace rand)
...
InputOutput::prepareTypes()
{
  ...
  attr01[17].data<coral::TimeStamp>() = coral::TimeStamp(1972, 1, 1, 12, 32, 34, 0);
  {
...
InputOutput::readTypes()
{
  ...
  if( cursor.next() )
  {
    ...
    if( alh[16].data<coral::Date>() != coral::Date(2001, 1, 1) )
      throw;
    if( alh[17].data<coral::TimeStamp>() != coral::TimeStamp(1972, 1, 1, 12, 32, 34, 0) )
      throw;
  }
  if( cursor.next() )
  {
