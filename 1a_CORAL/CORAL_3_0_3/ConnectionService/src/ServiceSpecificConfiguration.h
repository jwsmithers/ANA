...
#define CONNECTIONSERVICE_SERVICESPECIFICCONFIGURATION_H 1
...
namespace coral
{
  ...
  namespace ConnectionService
  {
    ...
    public:
      ...
      /**
       * Returns the rate of connection retrials
       * (time interval between two retrials).
       *///
...
#endif // CONNECTIONSERVICE_SERVICESPECIFICCONFIGURATION_H
