...
#define RELATIONALACCESS_IMONITORINGSERVICE_H 1
...
namespace coral
{
  ...
  namespace monitor
  {
    ...
    public:
      ...
      /**
       * Return the const reference to a reporting component which allows to
       * query and report the collected monitoring data
       *///
       ...
       * @param contextKey The session ID for which to make the report
       *///
      //virtual void reportToOutputStream( const std::string& contextKey,
