#ifndef FRONTIERACCESS_TABLEDESCRIPTIONPROXY_H
#define FRONTIERACCESS_TABLEDESCRIPTIONPROXY_H 1
...
namespace coral
{
  ...
  namespace FrontierAccess
  {
    ...
    private:
      ...
      TableDescriptionProxy( const TableDescriptionProxy& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      TableDescriptionProxy& operator=( const TableDescriptionProxy& rhs );
