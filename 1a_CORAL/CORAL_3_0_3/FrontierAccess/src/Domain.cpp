...
coral::FrontierAccess::Domain::Domain( const std::string& componentName )
  ...
  , m_domainProperties( new DomainProperties( this ) )
{
  this->setProperties();
}
...
void coral::FrontierAccess::Domain::setProperties()
{
  ...
  m_domainProperties->setTableSpaceForTables( tableSpaceForTables );
  m_domainProperties->setTableSpaceForIndices( tableSpaceForIndices );
  m_domainProperties->setTableSpaceForLobs( tableSpaceForLobs );
  m_domainProperties->setLobChunkSize( lobChunkSize );
}

coral::FrontierAccess::Domain::~Domain()
{
  delete m_domainProperties;
}
...
coral::FrontierAccess::Domain::newConnection( const std::string& uriString ) const
{
  ...
  return( new Connection( m_domainProperties->service()->name(), uriString ) );
}
