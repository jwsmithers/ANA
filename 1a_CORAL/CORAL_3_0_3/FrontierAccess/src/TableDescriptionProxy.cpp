...
coral::FrontierAccess::TableDescriptionProxy::TableDescriptionProxy(  boost::shared_ptr<const SessionProperties> properties,
...
void coral::FrontierAccess::TableDescriptionProxy::readColumnDescription()
{
  ...
  while( statement.fetchNext() )
  {
    ...
    else
    {
      ...
      throw coral::SchemaException( m_sessionProperties->domainServiceName(), msg.str(), "TableDescriptionProxy::readColumnDescription" );
    }
...
void coral::FrontierAccess::TableDescriptionProxy::refreshConstraints() const
{
  ...
  {
    throw coral::SchemaException( m_sessionProperties->domainServiceName(), "Could not retrieve the unique constraints defined in a table", "TableDescriptionProxy::refreshConstraints" );
  }
...
void coral::FrontierAccess::TableDescriptionProxy::refreshPrimaryKeyInfo() const
{
  ...
  if ( ! statement.execute( *bindData ) )
  {
    throw coral::SchemaException( m_sessionProperties->domainServiceName(), "Could not retrieve the primary key information defined in a table", "TableDescriptionProxy::refreshPrimaryKeyInfo" );
  }
...
void coral::FrontierAccess::TableDescriptionProxy::refreshIndexInfo() const
{
  ...
  if ( ! statement.execute( bindData ) )
    throw coral::SchemaException( m_sessionProperties->domainServiceName(), "Could not retrieve the index information defined in a table", "TableDescriptionProxy::refreshPrimaryKeyInfo" );
...
void coral::FrontierAccess::TableDescriptionProxy::refreshForeignKeyInfo() const
{
  ...
  if ( ! statement.execute( bindData ) )
  {
    throw coral::SchemaException( m_sessionProperties->domainServiceName(), "Could not retrieve the foreign key information defined in a table", "TableDescriptionProxy::refreshForeignKeyInfo" );
  }
...
std::string coral::FrontierAccess::TableDescriptionProxy::tableSpaceName() const
{
  ...
  if ( tableSpaceName.empty() )
  {
    ...
    if ( ! statement.execute( bindData ) )
    {
      throw coral::SchemaException( m_sessionProperties->domainServiceName(), "Could not retrieve the tablespace for a table", "ITableDescription::tableSpaceName" );
    }
