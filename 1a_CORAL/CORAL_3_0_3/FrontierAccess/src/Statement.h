#ifndef FRONTIERACCESS_STATEMENT_H
#define FRONTIERACCESS_STATEMENT_H 1
...
namespace coral
{
  ...
  namespace FrontierAccess
  {
    ...
    public:
       ...
       * Constructor
       *///
      Statement( boost::shared_ptr<const SessionProperties> properties,
       ...
       *///
#ifndef CORAL300WC
      bool execute( const coral::AttributeList& rowBuffer, bool forceReload=false );
#else
    ...
    private:
      ...
      frontier::Session* m_frontierSession;
