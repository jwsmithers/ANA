...
ConnectionService_cmtpath=/home/jwsmith/HDD
ConnectionService_offset=CORAL/CORAL-2-4-2
ConnectionService_project=jwsmith
ConnectionService_project_release=HDD
CoralCommon_tag=$(tag)
...
use_cppflags=  $(ConnectionService_cppflags)  $(CoralCommon_cppflags)  $(CoralKernel_cppflags)  $(RelationalAccess_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
lcg_ConnectionService_shlibflags=$(libraryshr_linkopts) $(use_linkopts) 
...
constituents= lcg_ConnectionService install_includes install_pythonmods 
CppUnit_tag=$(tag)
...
tests_constituents=lcg_mkdir  test_unit_ConnectionService_Connection 
test_unit_ConnectionService_Connection_dependencies=lcg_mkdir
test_unit_ConnectionService_Connectionlinkopts= $(ConnectionService_linkopts) $(ConnectionService_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
run_install_pythonmods=do_install_pythonmods
tag=armv7l-fc21-gcc49-opt
package=ConnectionService
version=ConnectionService-2-9-1
PACKAGE_ROOT=$(CONNECTIONSERVICEROOT)
srcdir=../src
bin=../$(ConnectionService_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/ConnectionService/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_stamps=  $(ConnectionService_stamps)  $(CoralCommon_stamps)  $(CoralKernel_stamps)  $(RelationalAccess_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(ConnectionService_cflags)  $(CoralCommon_cflags)  $(CoralKernel_cflags)  $(RelationalAccess_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(ConnectionService_pp_cflags)  $(CoralCommon_pp_cflags)  $(CoralKernel_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(ConnectionService_pp_cppflags)  $(CoralCommon_pp_cppflags)  $(CoralKernel_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(ConnectionService_fflags)  $(CoralCommon_fflags)  $(CoralKernel_fflags)  $(RelationalAccess_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(ConnectionService_pp_fflags)  $(CoralCommon_pp_fflags)  $(CoralKernel_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(CoralCommon_libraries)  $(CoralKernel_libraries)  $(RelationalAccess_libraries)  $(CoralBase_libraries)  $(LCG_Policy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(CppUnit_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/ConnectionService" $(use_includes)
fincludes= $(includes)
lcg_ConnectionService_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lcg_ConnectionService_use_linkopts=  $(ConnectionService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
test_unit_ConnectionService_Connection_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_ConnectionService_Connection_use_linkopts=  $(ConnectionService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_unit_ConnectionService_Connection_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_unit_ConnectionService_Connection_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_unit_ConnectionService_Connection_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_unit_ConnectionService_Connection_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_unit_ConnectionService_Connection_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_unit_ConnectionService_Connection_pp_fflags=  $(CppUnit_pp_fflags) 
test_unit_ConnectionService_Connection_stamps=  $(CppUnit_stamps) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_ConnectionServiceclean 
...
tests_constituentsclean= test_unit_ConnectionService_Connectionclean 
lcg_ConnectionServiceprototype_dependencies= $(lcg_ConnectionServicecompile_dependencies)
test_unit_ConnectionService_Connectioncompile_dependencies= lcg_mkdir
test_unit_ConnectionService_Connectionprototype_dependencies= $(test_unit_ConnectionService_Connectioncompile_dependencies)
