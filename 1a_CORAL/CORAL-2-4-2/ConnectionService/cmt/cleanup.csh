...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=ConnectionService -version=ConnectionService-2-9-1 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  $* >${cmtConnectionServicetempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=ConnectionService -version=ConnectionService-2-9-1 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  $* >${cmtConnectionServicetempfile}"
