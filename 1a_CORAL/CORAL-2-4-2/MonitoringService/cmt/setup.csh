...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=MonitoringService -version=MonitoringService-1-1-0 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtMonitoringServicetempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=MonitoringService -version=MonitoringService-1-1-0 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtMonitoringServicetempfile}"
