...
#cmt_local_tagfile = $(RelationalService_tag).make
cmt_local_tagfile = $(bin)$(RelationalService_tag).make
...
lcg_RelationalService_extratags = -tag_add=target_lcg_RelationalService
...
not_lcg_RelationalServicecompile_dependencies = { n=0; for p in $?; do m=0; for d in $(lcg_RelationalServicecompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
lcg_RelationalServicedirs :
	@if test ! -d $(bin)lcg_RelationalService; then $(mkdir) -p $(bin)lcg_RelationalService; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)lcg_RelationalService
else
lcg_RelationalServicedirs : ;
endif
...
ifndef QUICK
$(cmt_local_lcg_RelationalService_makefile) : $(lcg_RelationalServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_RelationalService.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_RelationalService_extratags) build constituent_config -out=$(cmt_local_lcg_RelationalService_makefile) lcg_RelationalService
else
$(cmt_local_lcg_RelationalService_makefile) : $(lcg_RelationalServicecompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_RelationalService) ] || \
	  [ ! -f $(cmt_final_setup_lcg_RelationalService) ] || \
	  $(not_lcg_RelationalServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building lcg_RelationalService.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_RelationalService_extratags) build constituent_config -out=$(cmt_local_lcg_RelationalService_makefile) lcg_RelationalService; \
	  fi
endif
...
$(cmt_local_lcg_RelationalService_makefile) : $(lcg_RelationalServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_RelationalService.make"; \
	  $(cmtexe) -f=$(bin)lcg_RelationalService.in -tag=$(tags) $(lcg_RelationalService_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_lcg_RelationalService_makefile) lcg_RelationalService
else
$(cmt_local_lcg_RelationalService_makefile) : $(lcg_RelationalServicecompile_dependencies) $(cmt_build_library_linksstamp) $(bin)lcg_RelationalService.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_RelationalService) ] || \
	  [ ! -f $(cmt_final_setup_lcg_RelationalService) ] || \
	  $(not_lcg_RelationalServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(lcg_RelationalService_extratags) build constituent_makefile -out=$(cmt_local_lcg_RelationalService_makefile) lcg_RelationalService

lcg_RelationalService :: lcg_RelationalServicecompile lcg_RelationalServiceinstall ;

ifdef cmt_lcg_RelationalService_has_prototypes

lcg_RelationalServiceprototype : $(lcg_RelationalServiceprototype_dependencies) $(cmt_local_lcg_RelationalService_makefile) dirs lcg_RelationalServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_RelationalService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalService_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_RelationalService_makefile) $@
	$(echo) "(constituents.make) $@ done"

lcg_RelationalServicecompile : lcg_RelationalServiceprototype

endif

lcg_RelationalServicecompile : $(lcg_RelationalServicecompile_dependencies) $(cmt_local_lcg_RelationalService_makefile) dirs lcg_RelationalServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_RelationalService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalService_makefile) $@; \
	  fi
...
lcg_RelationalServiceclean :: $(lcg_RelationalServiceclean_dependencies) ##$(cmt_local_lcg_RelationalService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_RelationalService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalService_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_lcg_RelationalService_makefile) lcg_RelationalServiceclean

##	  /bin/rm -f $(cmt_local_lcg_RelationalService_makefile) $(bin)lcg_RelationalService_dependencies.make

install :: lcg_RelationalServiceinstall ;

lcg_RelationalServiceinstall :: lcg_RelationalServicecompile $(lcg_RelationalService_dependencies) $(cmt_local_lcg_RelationalService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_RelationalService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalService_makefile) $@; \
	  fi
...
$(foreach d,$(lcg_RelationalService_dependencies),$(eval $(d)uninstall_dependencies += lcg_RelationalServiceuninstall))

lcg_RelationalServiceuninstall : $(lcg_RelationalServiceuninstall_dependencies) ##$(cmt_local_lcg_RelationalService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_RelationalService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalService_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_RelationalService_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: lcg_RelationalServiceuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ lcg_RelationalService"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ lcg_RelationalService done"
endif

#-- end of constituent_app_lib ------
#-- start of constituent_app_lib ------

cmt_test_unit_RelationalService_LoadService_has_no_target_tag = 1
cmt_test_unit_RelationalService_LoadService_has_prototypes = 1

#--------------------------------------

ifdef cmt_test_unit_RelationalService_LoadService_has_target_tag

cmt_local_tagfile_test_unit_RelationalService_LoadService = $(bin)$(RelationalService_tag)_test_unit_RelationalService_LoadService.make
cmt_final_setup_test_unit_RelationalService_LoadService = $(bin)setup_test_unit_RelationalService_LoadService.make
cmt_local_test_unit_RelationalService_LoadService_makefile = $(bin)test_unit_RelationalService_LoadService.make

test_unit_RelationalService_LoadService_extratags = -tag_add=target_test_unit_RelationalService_LoadService

else

cmt_local_tagfile_test_unit_RelationalService_LoadService = $(bin)$(RelationalService_tag).make
cmt_final_setup_test_unit_RelationalService_LoadService = $(bin)setup.make
cmt_local_test_unit_RelationalService_LoadService_makefile = $(bin)test_unit_RelationalService_LoadService.make

endif

not_test_unit_RelationalService_LoadServicecompile_dependencies = { n=0; for p in $?; do m=0; for d in $(test_unit_RelationalService_LoadServicecompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
test_unit_RelationalService_LoadServicedirs :
	@if test ! -d $(bin)test_unit_RelationalService_LoadService; then $(mkdir) -p $(bin)test_unit_RelationalService_LoadService; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)test_unit_RelationalService_LoadService
else
test_unit_RelationalService_LoadServicedirs : ;
endif
...
ifndef QUICK
$(cmt_local_test_unit_RelationalService_LoadService_makefile) : $(test_unit_RelationalService_LoadServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_RelationalService_LoadService.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_RelationalService_LoadService_extratags) build constituent_config -out=$(cmt_local_test_unit_RelationalService_LoadService_makefile) test_unit_RelationalService_LoadService
else
$(cmt_local_test_unit_RelationalService_LoadService_makefile) : $(test_unit_RelationalService_LoadServicecompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_RelationalService_LoadService) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_RelationalService_LoadService) ] || \
	  $(not_test_unit_RelationalService_LoadServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building test_unit_RelationalService_LoadService.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_RelationalService_LoadService_extratags) build constituent_config -out=$(cmt_local_test_unit_RelationalService_LoadService_makefile) test_unit_RelationalService_LoadService; \
	  fi
endif
...
$(cmt_local_test_unit_RelationalService_LoadService_makefile) : $(test_unit_RelationalService_LoadServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_RelationalService_LoadService.make"; \
	  $(cmtexe) -f=$(bin)test_unit_RelationalService_LoadService.in -tag=$(tags) $(test_unit_RelationalService_LoadService_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_test_unit_RelationalService_LoadService_makefile) test_unit_RelationalService_LoadService
else
$(cmt_local_test_unit_RelationalService_LoadService_makefile) : $(test_unit_RelationalService_LoadServicecompile_dependencies) $(cmt_build_library_linksstamp) $(bin)test_unit_RelationalService_LoadService.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_RelationalService_LoadService) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_RelationalService_LoadService) ] || \
	  $(not_test_unit_RelationalService_LoadServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(test_unit_RelationalService_LoadService_extratags) build constituent_makefile -out=$(cmt_local_test_unit_RelationalService_LoadService_makefile) test_unit_RelationalService_LoadService

test_unit_RelationalService_LoadService :: test_unit_RelationalService_LoadServicecompile test_unit_RelationalService_LoadServiceinstall ;

ifdef cmt_test_unit_RelationalService_LoadService_has_prototypes

test_unit_RelationalService_LoadServiceprototype : $(test_unit_RelationalService_LoadServiceprototype_dependencies) $(cmt_local_test_unit_RelationalService_LoadService_makefile) dirs test_unit_RelationalService_LoadServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_RelationalService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) $@
	$(echo) "(constituents.make) $@ done"

test_unit_RelationalService_LoadServicecompile : test_unit_RelationalService_LoadServiceprototype

endif

test_unit_RelationalService_LoadServicecompile : $(test_unit_RelationalService_LoadServicecompile_dependencies) $(cmt_local_test_unit_RelationalService_LoadService_makefile) dirs test_unit_RelationalService_LoadServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_RelationalService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) $@; \
	  fi
...
clean :: test_unit_RelationalService_LoadServiceclean ;

test_unit_RelationalService_LoadServiceclean :: $(test_unit_RelationalService_LoadServiceclean_dependencies) ##$(cmt_local_test_unit_RelationalService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_RelationalService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) test_unit_RelationalService_LoadServiceclean

##	  /bin/rm -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) $(bin)test_unit_RelationalService_LoadService_dependencies.make

install :: test_unit_RelationalService_LoadServiceinstall ;

test_unit_RelationalService_LoadServiceinstall :: test_unit_RelationalService_LoadServicecompile $(test_unit_RelationalService_LoadService_dependencies) $(cmt_local_test_unit_RelationalService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_RelationalService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) $@; \
	  fi
...
uninstall : test_unit_RelationalService_LoadServiceuninstall

$(foreach d,$(test_unit_RelationalService_LoadService_dependencies),$(eval $(d)uninstall_dependencies += test_unit_RelationalService_LoadServiceuninstall))

test_unit_RelationalService_LoadServiceuninstall : $(test_unit_RelationalService_LoadServiceuninstall_dependencies) ##$(cmt_local_test_unit_RelationalService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_RelationalService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_RelationalService_LoadService_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: test_unit_RelationalService_LoadServiceuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ test_unit_RelationalService_LoadService"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ test_unit_RelationalService_LoadService done"
endif
...
cmt_local_tagfile_install_includes = $(bin)$(RelationalService_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(RelationalService_tag).make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(RelationalService_tag)_install_pythonmods.make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(RelationalService_tag).make
...
cmt_local_tagfile_make = $(bin)$(RelationalService_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(RelationalService_tag).make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(RelationalService_tag)_lcg_mkdir.make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(RelationalService_tag).make
...
cmt_local_tagfile_utilities = $(bin)$(RelationalService_tag)_utilities.make
...
cmt_local_tagfile_utilities = $(bin)$(RelationalService_tag).make
...
cmt_local_tagfile_examples = $(bin)$(RelationalService_tag)_examples.make
...
cmt_local_tagfile_examples = $(bin)$(RelationalService_tag).make
