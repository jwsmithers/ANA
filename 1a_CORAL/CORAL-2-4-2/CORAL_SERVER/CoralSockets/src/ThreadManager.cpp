// $Id: ThreadManager.cpp,v 1.9.2.3.2.2 2013-01-01 18:27:26 avalassi Exp $
...
void ThreadManager::addThread( Runnable *runClass )
{
  try {
    ...
    coral::lock_guard lock( m_threadsMutex );
    ...
    //add the new thread to the stats
    //m_statsHandle->add();
  }
