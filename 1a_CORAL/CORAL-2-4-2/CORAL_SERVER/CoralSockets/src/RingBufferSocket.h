// $Id: RingBufferSocket.h,v 1.6.2.2.2.2 2012-06-28 12:12:45 avalassi Exp $
...
namespace coral {
  ...
  namespace CoralSockets {
    ...
    private:
      RingBufferSocket( RingBuffer& read, coral::mutex & readMutex,
                        RingBuffer& write, coral::mutex & writeMutex,
      ...
      RingBuffer &m_read;
      coral::mutex &m_readMutex;

      RingBuffer &m_write;
      coral::mutex &m_writeMutex;
    };
    ...
    private:
      ...
      coral::mutex m_forwardMutex;

      RingBuffer m_backward;
      coral::mutex m_backwardMutex;
