// $Id: test_SslSocket.cpp,v 1.5.2.5.2.2 2013-02-13 17:49:33 avalassi Exp $
...
namespace coral
{
  ...
  public:
    ...
    void test_basic()
    {
      ...
      SslSocketPtr listenSocket   = SslSocket::listenOn( "localhost", getTestPort() );
...
#define  largePacketLen 3000000
    ...
    public:
      ...
      void operator()() {
        ...
        try {
          ...
          SslSocketPtr connect=SslSocket::connectTo("localhost", getTestPort() );
    ...
    void test_read_write()
    {
      ...
      {
        SslSocketPtr listen=SslSocket::listenOn( "localhost", getTestPort() );
        ThreadManager thrManager;
    ...
    void test_secureTcpSocket()
    {
      //  (this needs threads)
      {
        ...
        TcpSocketPtr listen=SslSocket::listenOn( "localhost", getTestPort() );
        ThreadManager thrManager;
