// $Id: CoralServerFacade.h,v 1.31.2.1.2.2 2012-12-21 13:24:29 avalassi Exp $
...
namespace coral
{
  ...
  namespace CoralServer
  {
    ...
    private:
      ...
      CoralServerFacade( const CoralServerFacade& rhs );

      /// Assignment operator is private (fix Coverity MISSING_ASSIGN)
      CoralServerFacade& operator=( const CoralServerFacade& rhs );
