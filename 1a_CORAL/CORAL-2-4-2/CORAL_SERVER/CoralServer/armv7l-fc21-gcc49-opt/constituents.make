...
#cmt_local_tagfile = $(CoralServer_tag).make
cmt_local_tagfile = $(bin)$(CoralServer_tag).make
...
lcg_CoralServer_extratags = -tag_add=target_lcg_CoralServer
...
not_lcg_CoralServercompile_dependencies = { n=0; for p in $?; do m=0; for d in $(lcg_CoralServercompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
lcg_CoralServerdirs :
	@if test ! -d $(bin)lcg_CoralServer; then $(mkdir) -p $(bin)lcg_CoralServer; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)lcg_CoralServer
else
lcg_CoralServerdirs : ;
endif
...
ifndef QUICK
$(cmt_local_lcg_CoralServer_makefile) : $(lcg_CoralServercompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_CoralServer.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_CoralServer_extratags) build constituent_config -out=$(cmt_local_lcg_CoralServer_makefile) lcg_CoralServer
else
$(cmt_local_lcg_CoralServer_makefile) : $(lcg_CoralServercompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_CoralServer) ] || \
	  [ ! -f $(cmt_final_setup_lcg_CoralServer) ] || \
	  $(not_lcg_CoralServercompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building lcg_CoralServer.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_CoralServer_extratags) build constituent_config -out=$(cmt_local_lcg_CoralServer_makefile) lcg_CoralServer; \
	  fi
endif
...
$(cmt_local_lcg_CoralServer_makefile) : $(lcg_CoralServercompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_CoralServer.make"; \
	  $(cmtexe) -f=$(bin)lcg_CoralServer.in -tag=$(tags) $(lcg_CoralServer_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_lcg_CoralServer_makefile) lcg_CoralServer
else
$(cmt_local_lcg_CoralServer_makefile) : $(lcg_CoralServercompile_dependencies) $(cmt_build_library_linksstamp) $(bin)lcg_CoralServer.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_CoralServer) ] || \
	  [ ! -f $(cmt_final_setup_lcg_CoralServer) ] || \
	  $(not_lcg_CoralServercompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(lcg_CoralServer_extratags) build constituent_makefile -out=$(cmt_local_lcg_CoralServer_makefile) lcg_CoralServer

lcg_CoralServer :: lcg_CoralServercompile lcg_CoralServerinstall ;

ifdef cmt_lcg_CoralServer_has_prototypes

lcg_CoralServerprototype : $(lcg_CoralServerprototype_dependencies) $(cmt_local_lcg_CoralServer_makefile) dirs lcg_CoralServerdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_CoralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoralServer_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_CoralServer_makefile) $@
	$(echo) "(constituents.make) $@ done"

lcg_CoralServercompile : lcg_CoralServerprototype

endif

lcg_CoralServercompile : $(lcg_CoralServercompile_dependencies) $(cmt_local_lcg_CoralServer_makefile) dirs lcg_CoralServerdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_CoralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoralServer_makefile) $@; \
	  fi
...
lcg_CoralServerclean :: $(lcg_CoralServerclean_dependencies) ##$(cmt_local_lcg_CoralServer_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_CoralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoralServer_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_lcg_CoralServer_makefile) lcg_CoralServerclean

##	  /bin/rm -f $(cmt_local_lcg_CoralServer_makefile) $(bin)lcg_CoralServer_dependencies.make

install :: lcg_CoralServerinstall ;

lcg_CoralServerinstall :: lcg_CoralServercompile $(lcg_CoralServer_dependencies) $(cmt_local_lcg_CoralServer_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_CoralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoralServer_makefile) $@; \
	  fi
...
$(foreach d,$(lcg_CoralServer_dependencies),$(eval $(d)uninstall_dependencies += lcg_CoralServeruninstall))

lcg_CoralServeruninstall : $(lcg_CoralServeruninstall_dependencies) ##$(cmt_local_lcg_CoralServer_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_CoralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_CoralServer_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_CoralServer_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: lcg_CoralServeruninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ lcg_CoralServer"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ lcg_CoralServer done"
endif

#-- end of constituent_app_lib ------
#-- start of constituent_app_lib ------

cmt_coralServer_has_no_target_tag = 1
cmt_coralServer_has_prototypes = 1

#--------------------------------------

ifdef cmt_coralServer_has_target_tag

cmt_local_tagfile_coralServer = $(bin)$(CoralServer_tag)_coralServer.make
cmt_final_setup_coralServer = $(bin)setup_coralServer.make
cmt_local_coralServer_makefile = $(bin)coralServer.make

coralServer_extratags = -tag_add=target_coralServer

else

cmt_local_tagfile_coralServer = $(bin)$(CoralServer_tag).make
cmt_final_setup_coralServer = $(bin)setup.make
cmt_local_coralServer_makefile = $(bin)coralServer.make

endif

not_coralServercompile_dependencies = { n=0; for p in $?; do m=0; for d in $(coralServercompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
coralServerdirs :
	@if test ! -d $(bin)coralServer; then $(mkdir) -p $(bin)coralServer; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)coralServer
else
coralServerdirs : ;
endif
...
ifndef QUICK
$(cmt_local_coralServer_makefile) : $(coralServercompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building coralServer.make"; \
	  $(cmtexe) -tag=$(tags) $(coralServer_extratags) build constituent_config -out=$(cmt_local_coralServer_makefile) coralServer
else
$(cmt_local_coralServer_makefile) : $(coralServercompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_coralServer) ] || \
	  [ ! -f $(cmt_final_setup_coralServer) ] || \
	  $(not_coralServercompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building coralServer.make"; \
	  $(cmtexe) -tag=$(tags) $(coralServer_extratags) build constituent_config -out=$(cmt_local_coralServer_makefile) coralServer; \
	  fi
endif
...
$(cmt_local_coralServer_makefile) : $(coralServercompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building coralServer.make"; \
	  $(cmtexe) -f=$(bin)coralServer.in -tag=$(tags) $(coralServer_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_coralServer_makefile) coralServer
else
$(cmt_local_coralServer_makefile) : $(coralServercompile_dependencies) $(cmt_build_library_linksstamp) $(bin)coralServer.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_coralServer) ] || \
	  [ ! -f $(cmt_final_setup_coralServer) ] || \
	  $(not_coralServercompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(coralServer_extratags) build constituent_makefile -out=$(cmt_local_coralServer_makefile) coralServer

coralServer :: coralServercompile coralServerinstall ;

ifdef cmt_coralServer_has_prototypes

coralServerprototype : $(coralServerprototype_dependencies) $(cmt_local_coralServer_makefile) dirs coralServerdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_coralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_coralServer_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_coralServer_makefile) $@
	$(echo) "(constituents.make) $@ done"

coralServercompile : coralServerprototype

endif

coralServercompile : $(coralServercompile_dependencies) $(cmt_local_coralServer_makefile) dirs coralServerdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_coralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_coralServer_makefile) $@; \
	  fi
...
clean :: coralServerclean ;

coralServerclean :: $(coralServerclean_dependencies) ##$(cmt_local_coralServer_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_coralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_coralServer_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_coralServer_makefile) coralServerclean

##	  /bin/rm -f $(cmt_local_coralServer_makefile) $(bin)coralServer_dependencies.make

install :: coralServerinstall ;

coralServerinstall :: coralServercompile $(coralServer_dependencies) $(cmt_local_coralServer_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_coralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_coralServer_makefile) $@; \
	  fi
...
uninstall : coralServeruninstall

$(foreach d,$(coralServer_dependencies),$(eval $(d)uninstall_dependencies += coralServeruninstall))

coralServeruninstall : $(coralServeruninstall_dependencies) ##$(cmt_local_coralServer_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_coralServer_makefile); then \
	  $(MAKE) -f $(cmt_local_coralServer_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_coralServer_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: coralServeruninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ coralServer"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ coralServer done"
endif
...
cmt_local_tagfile_install_includes = $(bin)$(CoralServer_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(CoralServer_tag).make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(CoralServer_tag)_install_pythonmods.make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(CoralServer_tag).make
...
cmt_local_tagfile_make = $(bin)$(CoralServer_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(CoralServer_tag).make
...
cmt_local_tagfile_tests = $(bin)$(CoralServer_tag)_tests.make
...
cmt_local_tagfile_tests = $(bin)$(CoralServer_tag).make
...
cmt_local_tagfile_examples = $(bin)$(CoralServer_tag)_examples.make
...
cmt_local_tagfile_examples = $(bin)$(CoralServer_tag).make
