...
CoralServer_tag=$(tag)
CORALSERVERROOT=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServer
CoralServer_root=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServer
CORALSERVERVERSION=v1
CoralServer_cmtpath=/home/jwsmith/HDD
CoralServer_offset=CORAL/CORAL-2-4-2/CORAL_SERVER
CoralServer_project=jwsmith
CoralServer_project_release=HDD
...
use_cppflags=  $(CoralServer_cppflags)  $(CoralSockets_cppflags)  $(CoralStubs_cppflags)  $(CoralServerBase_cppflags)  $(CoralCommon_cppflags)  $(RelationalAccess_cppflags)  $(CoralMonitor_cppflags)  $(CoralKernel_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
lcg_CoralServer_shlibflags=$(libraryshr_linkopts) $(use_linkopts) 
use_linkopts= $(cmt_installarea_linkopts)         $(CoralServerBase_linkopts)  $(CoralCommon_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralKernel_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
constituents= lcg_CoralServer  install_pythonmods 
coralServerlinkopts= $(CoralServer_linkopts) $(CoralServer_utilities_linkopts) $(gcov_linkopts) $(icc_linkopts)  -llcg_CoralServer  $(CoralSockets_linkopts) $(CoralStubs_linkopts)
...
CoralSockets_cmtpath=/home/jwsmith/HDD/CORAL/CORAL-2-4-2
CoralSockets_offset=CORAL_SERVER
CoralSockets_project=CORAL
CoralSockets_project_release=CORAL-2-4-2
CoralSockets_linkopts= -llcg_CoralSockets  $(Boost_linkopts_thread)
lcg_CoralSockets_shlibflags= $(Boost_linkopts_thread)
CoralStubs_tag=$(tag)
...
CoralStubs_cmtpath=/home/jwsmith/HDD/CORAL/CORAL-2-4-2
CoralStubs_offset=CORAL_SERVER
CoralStubs_project=CORAL
CoralStubs_project_release=CORAL-2-4-2
CoralCommon_tag=$(tag)
...
package=CoralServer
version=v1
PACKAGE_ROOT=$(CORALSERVERROOT)
srcdir=../src
bin=../$(CoralServer_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServer/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(CoralSockets_root)/cmt/requirements $(CoralStubs_root)/cmt/requirements $(CoralServerBase_root)/cmt/requirements $(CoralCommon_root)/cmt/requirements $(RelationalAccess_root)/cmt/requirements $(CoralMonitor_root)/cmt/requirements $(CoralKernel_root)/cmt/requirements $(CoralBase_root)/cmt/requirements $(LCG_Policy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(LCG_Settings_root)/cmt/requirements $(LCG_Configuration_root)/cmt/requirements $(LCG_Platforms_root)/cmt/requirements 
use_includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralSockets" $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralStubs" $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServerBase" $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CoralCommon" $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/RelationalAccess" $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralMonitor" $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CoralKernel" $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CoralBase" $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../Boost/1.55.0_python2.7/armv7l-fc21-gcc49-opt/include/boost-1_55" $(ppcmd)"$(LCG_Platforms_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(CoralServer_stamps)  $(CoralSockets_stamps)  $(CoralStubs_stamps)  $(CoralServerBase_stamps)  $(CoralCommon_stamps)  $(RelationalAccess_stamps)  $(CoralMonitor_stamps)  $(CoralKernel_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(CoralServer_cflags)  $(CoralSockets_cflags)  $(CoralStubs_cflags)  $(CoralServerBase_cflags)  $(CoralCommon_cflags)  $(RelationalAccess_cflags)  $(CoralMonitor_cflags)  $(CoralKernel_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(CoralServer_pp_cflags)  $(CoralSockets_pp_cflags)  $(CoralStubs_pp_cflags)  $(CoralServerBase_pp_cflags)  $(CoralCommon_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralMonitor_pp_cflags)  $(CoralKernel_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(CoralServer_pp_cppflags)  $(CoralSockets_pp_cppflags)  $(CoralStubs_pp_cppflags)  $(CoralServerBase_pp_cppflags)  $(CoralCommon_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralMonitor_pp_cppflags)  $(CoralKernel_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(CoralServer_fflags)  $(CoralSockets_fflags)  $(CoralStubs_fflags)  $(CoralServerBase_fflags)  $(CoralCommon_fflags)  $(RelationalAccess_fflags)  $(CoralMonitor_fflags)  $(CoralKernel_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(CoralServer_pp_fflags)  $(CoralSockets_pp_fflags)  $(CoralStubs_pp_fflags)  $(CoralServerBase_pp_fflags)  $(CoralCommon_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralMonitor_pp_fflags)  $(CoralKernel_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(CoralSockets_libraries)  $(CoralStubs_libraries)  $(CoralServerBase_libraries)  $(CoralCommon_libraries)  $(RelationalAccess_libraries)  $(CoralMonitor_libraries)  $(CoralKernel_libraries)  $(CoralBase_libraries)  $(LCG_Policy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServer" $(use_includes)
fincludes= $(includes)
lcg_CoralServer_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lcg_CoralServer_use_linkopts=  $(CoralServer_linkopts)  $(CoralSockets_linkopts)  $(CoralStubs_linkopts)  $(CoralServerBase_linkopts)  $(CoralCommon_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralKernel_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
coralServer_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
coralServer_use_linkopts=  $(CoralServer_linkopts)  $(CoralSockets_linkopts)  $(CoralStubs_linkopts)  $(CoralServerBase_linkopts)  $(CoralCommon_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralKernel_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_CoralServerclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituentsclean= examplesclean testsclean makeclean 
utilities_constituents= coralServer 
utilities_constituentsclean= coralServerclean 
lcg_CoralServerprototype_dependencies= $(lcg_CoralServercompile_dependencies)
coralServerprototype_dependencies= $(coralServercompile_dependencies)
