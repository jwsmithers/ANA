// $Id: ThreadMonitorReporter.h,v 1.1.2.3.2.1 2012-12-21 15:13:42 avalassi Exp $
#ifndef CORALSERVER_THREADMONITORREPORTER_H
#define CORALSERVER_THREADMONITORREPORTER_H 1
    ...
    private:
      ...
      public:
        ...
        void operator()()
        {
          ...
          // NB Do not use ReporterThread::m_isActive: coral::mutex creates
