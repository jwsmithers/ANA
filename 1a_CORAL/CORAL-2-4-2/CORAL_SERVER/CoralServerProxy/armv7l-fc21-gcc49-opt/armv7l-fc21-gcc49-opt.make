...
CORALSERVERPROXYROOT=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServerProxy
CoralServerProxy_root=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServerProxy
CORALSERVERPROXYVERSION=v1
CoralServerProxy_cmtpath=/home/jwsmith/HDD
CoralServerProxy_offset=CORAL/CORAL-2-4-2/CORAL_SERVER
CoralServerProxy_project=jwsmith
CoralServerProxy_project_release=HDD
...
use_cppflags=  $(CoralServerProxy_cppflags)  $(CoralServerBase_cppflags)  $(RelationalAccess_cppflags)  $(CoralMonitor_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
CoralServerProxy_linkopts= -llcg_CoralServerProxy 
lcg_CoralServerProxy_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(lcg_CoralServerProxy_use_linkopts) 
lcg_CoralServerProxy_use_linkopts=    $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
constituents= lcg_CoralServerProxy  install_pythonmods 
CppUnit_tag=$(tag)
...
tests_constituents=lcg_mkdir  test_unit_CoralServerProxy_Packet 
test_unit_CoralServerProxy_Packet_dependencies=lcg_mkdir
test_unit_CoralServerProxy_Packetlinkopts= $(CoralServerProxy_linkopts) $(CoralServerProxy_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
coralServerProxylinkopts= $(CoralServerProxy_linkopts) $(CoralServerProxy_utilities_linkopts) $(gcov_linkopts) $(icc_linkopts)  -llcg_CoralServerProxy 
run_install_pythonmods=do_install_pythonmods
tag=armv7l-fc21-gcc49-opt
package=CoralServerProxy
version=v1
PACKAGE_ROOT=$(CORALSERVERPROXYROOT)
srcdir=../src
bin=../$(CoralServerProxy_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServerProxy/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_linkopts= $(cmt_installarea_linkopts)   $(CoralServerProxy_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
use_stamps=  $(CoralServerProxy_stamps)  $(CoralServerBase_stamps)  $(RelationalAccess_stamps)  $(CoralMonitor_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(CoralServerProxy_cflags)  $(CoralServerBase_cflags)  $(RelationalAccess_cflags)  $(CoralMonitor_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(CoralServerProxy_pp_cflags)  $(CoralServerBase_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralMonitor_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(CoralServerProxy_pp_cppflags)  $(CoralServerBase_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralMonitor_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(CoralServerProxy_fflags)  $(CoralServerBase_fflags)  $(RelationalAccess_fflags)  $(CoralMonitor_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(CoralServerProxy_pp_fflags)  $(CoralServerBase_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralMonitor_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
...
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralServerProxy" $(use_includes)
fincludes= $(includes)
lcg_CoralServerProxy_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralServerProxy_Packet_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_CoralServerProxy_Packet_use_linkopts=  $(CoralServerProxy_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_unit_CoralServerProxy_Packet_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_unit_CoralServerProxy_Packet_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_unit_CoralServerProxy_Packet_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_unit_CoralServerProxy_Packet_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_unit_CoralServerProxy_Packet_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_unit_CoralServerProxy_Packet_pp_fflags=  $(CppUnit_pp_fflags) 
test_unit_CoralServerProxy_Packet_stamps=  $(CppUnit_stamps) 
coralServerProxy_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
coralServerProxy_use_linkopts=  $(CoralServerProxy_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_CoralServerProxyclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituentsclean= examplesclean lcg_mkdirclean makeclean 
tests_constituentsclean= test_unit_CoralServerProxy_Packetclean 
utilities_constituents= coralServerProxy 
utilities_constituentsclean= coralServerProxyclean 
test_unit_CoralServerProxy_Packetcompile_dependencies= lcg_mkdir
test_unit_CoralServerProxy_Packetprototype_dependencies= $(test_unit_CoralServerProxy_Packetcompile_dependencies)
coralServerProxyprototype_dependencies= $(coralServerProxycompile_dependencies)
