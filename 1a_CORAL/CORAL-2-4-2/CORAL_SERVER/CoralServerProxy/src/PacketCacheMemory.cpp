...
// 	$Id: PacketCacheMemory.cpp,v 1.2.2.1.2.1 2012-11-21 10:59:01 avalassi Exp $
//
// Description:
...
PacketCacheMemory::purgeOne()
{
  ...
  PXY_DEBUG ( "PacketCacheMemory::purge: new cache size: " << m_cacheMap.size() ) ;
  PXY_DEBUG ( "PacketCacheMemory::purge: new cache volume: " << m_cacheSize/(1024*1024) << "MB" ) ;
