...
// 	$Id: RoutingTables.cpp,v 1.3.2.1.2.1 2012-11-21 10:59:02 avalassi Exp $
//
// Description:
//	Class RoutingTables...
//
...
{
  coral::lock_guard slock ( m_mutex ) ;
...
// delete all routing info
void 
RoutingTables::clear()
{
  coral::lock_guard slock ( m_mutex ) ;
  m_client2server.clear();
  m_server2client.clear();
}
