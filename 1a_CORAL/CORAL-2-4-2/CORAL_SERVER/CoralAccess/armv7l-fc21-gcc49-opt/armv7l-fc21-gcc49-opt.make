...
CoralAccess_tag=$(tag)
CORALACCESSROOT=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralAccess
CoralAccess_root=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralAccess
CORALACCESSVERSION=v1
CoralAccess_cmtpath=/home/jwsmith/HDD
CoralAccess_offset=CORAL/CORAL-2-4-2/CORAL_SERVER
CoralAccess_project=jwsmith
CoralAccess_project_release=HDD
CoralCommon_tag=$(tag)
...
use_cppflags=  $(CoralAccess_cppflags)  $(CoralStubs_cppflags)  $(CoralCommon_cppflags)  $(CoralKernel_cppflags)  $(CoralSockets_cppflags)  $(CoralServerBase_cppflags)  $(RelationalAccess_cppflags)  $(CoralMonitor_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
lcg_CoralAccess_shlibflags=$(libraryshr_linkopts) $(use_linkopts) 
use_linkopts= $(cmt_installarea_linkopts)     $(CoralStubs_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(CoralSockets_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
constituents= lcg_CoralAccess install_includes install_pythonmods 
run_install_pythonmods=do_install_pythonmods
tag=armv7l-fc21-gcc49-opt
package=CoralAccess
version=v1
PACKAGE_ROOT=$(CORALACCESSROOT)
srcdir=../src
bin=../$(CoralAccess_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralAccess/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(CoralStubs_root)/cmt/requirements $(CoralCommon_root)/cmt/requirements $(CoralKernel_root)/cmt/requirements $(CoralSockets_root)/cmt/requirements $(CoralServerBase_root)/cmt/requirements $(RelationalAccess_root)/cmt/requirements $(CoralMonitor_root)/cmt/requirements $(CoralBase_root)/cmt/requirements $(LCG_Policy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(LCG_Settings_root)/cmt/requirements $(LCG_Configuration_root)/cmt/requirements $(LCG_Platforms_root)/cmt/requirements 
...
use_stamps=  $(CoralAccess_stamps)  $(CoralStubs_stamps)  $(CoralCommon_stamps)  $(CoralKernel_stamps)  $(CoralSockets_stamps)  $(CoralServerBase_stamps)  $(RelationalAccess_stamps)  $(CoralMonitor_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(CoralAccess_cflags)  $(CoralStubs_cflags)  $(CoralCommon_cflags)  $(CoralKernel_cflags)  $(CoralSockets_cflags)  $(CoralServerBase_cflags)  $(RelationalAccess_cflags)  $(CoralMonitor_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(CoralAccess_pp_cflags)  $(CoralStubs_pp_cflags)  $(CoralCommon_pp_cflags)  $(CoralKernel_pp_cflags)  $(CoralSockets_pp_cflags)  $(CoralServerBase_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralMonitor_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(CoralAccess_pp_cppflags)  $(CoralStubs_pp_cppflags)  $(CoralCommon_pp_cppflags)  $(CoralKernel_pp_cppflags)  $(CoralSockets_pp_cppflags)  $(CoralServerBase_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralMonitor_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(CoralAccess_fflags)  $(CoralStubs_fflags)  $(CoralCommon_fflags)  $(CoralKernel_fflags)  $(CoralSockets_fflags)  $(CoralServerBase_fflags)  $(RelationalAccess_fflags)  $(CoralMonitor_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(CoralAccess_pp_fflags)  $(CoralStubs_pp_fflags)  $(CoralCommon_pp_fflags)  $(CoralKernel_pp_fflags)  $(CoralSockets_pp_fflags)  $(CoralServerBase_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralMonitor_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
use_libraries= $(CoralStubs_libraries)  $(CoralCommon_libraries)  $(CoralKernel_libraries)  $(CoralSockets_libraries)  $(CoralServerBase_libraries)  $(RelationalAccess_libraries)  $(CoralMonitor_libraries)  $(CoralBase_libraries)  $(LCG_Policy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(LCG_Settings_libraries)  $(LCG_Configuration_libraries)  $(LCG_Platforms_libraries) 
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/CORAL_SERVER/CoralAccess" $(use_includes)
fincludes= $(includes)
lcg_CoralAccess_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lcg_CoralAccess_use_linkopts=  $(CoralAccess_linkopts)  $(CoralStubs_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(CoralSockets_linkopts)  $(CoralServerBase_linkopts)  $(RelationalAccess_linkopts)  $(CoralMonitor_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_CoralAccessclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituentsclean= examplesclean utilitiesclean testsclean makeclean 
lcg_CoralAccessprototype_dependencies= $(lcg_CoralAccesscompile_dependencies)
