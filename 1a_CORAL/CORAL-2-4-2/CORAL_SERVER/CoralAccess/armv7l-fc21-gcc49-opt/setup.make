...
#     use CoralBase v*  (no_version_directory)
# use CoralServerBase v* CORAL_SERVER (no_version_directory)
#   use RelationalAccess v*  (no_version_directory)
#   use CoralMonitor v* CORAL_SERVER (no_version_directory)
#     use CoralBase v*  (no_version_directory)
# use CoralSockets v* CORAL_SERVER (no_version_directory)
#   use CoralServerBase v* CORAL_SERVER (no_version_directory)
# use CoralStubs v* CORAL_SERVER (no_version_directory)
#   use CoralCommon v*  (no_version_directory)
#   use CoralServerBase v* CORAL_SERVER (no_version_directory)
#   use CoralMonitor v* CORAL_SERVER (no_version_directory)
#
...
use CoralMonitor v1 CORAL_SERVER (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use RelationalAccess RelationalAccess-1-8-1  (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use CoralServerBase v1 CORAL_SERVER (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
use CoralSockets v1 CORAL_SERVER (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
...
use CoralStubs v1 CORAL_SERVER (/home/jwsmith/HDD/CORAL/CORAL-2-4-2)
----------> tags
...
target-fc21 (from package LCG_Platforms)
