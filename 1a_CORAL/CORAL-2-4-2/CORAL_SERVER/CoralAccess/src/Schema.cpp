// $Id: Schema.cpp,v 1.15.2.1.2.2 2013-02-05 09:24:03 avalassi Exp $
...
{
  SCOPED_TIMER( "CoralAccess::Schema::listTables" );
...
{
  SCOPED_TIMER( "CoralAccess::Schema::existsTable" );
...
{
  SCOPED_TIMER( "CoralAccess::Schema::existsView" );
...
{
  SCOPED_TIMER( "CoralAccess::Schema::listViews" );
...
coral::ISequence&
Schema::createSequence( const coral::ISequenceDescription& )
{
  // Temporary
  throw coral::Exception( "not implemented yet", "CoralAccess", "Schema::createSequence" );
}

//-----------------------------------------------------------------------------

bool
Schema::existsSequence( const std::string& /*sequenceName*/ ) const
{
  // Temporary
  throw coral::Exception( "not implemented yet", "CoralAccess", "Schema::existsSequence" );
}

//-----------------------------------------------------------------------------

coral::ISequence&
Schema::sequenceHandle( const std::string& /*sequenceName*/ )
{
  // Temporary
  throw coral::Exception( "not implemented yet", "CoralAccess", "Schema::sequenceHandle" );
}

//-----------------------------------------------------------------------------

void
Schema::dropSequence( const std::string& /*sequenceName*/ )
{
  // Temporary
  throw coral::Exception( "not implemented yet", "CoralAccess", "Schema::dropSequence" );
}

//-----------------------------------------------------------------------------

void
Schema::dropIfExistsSequence( const std::string& /*sequenceName*/ )
{
  // Temporary
  throw coral::Exception( "not implemented yet", "CoralAccess", "Schema::dropIfExistsSequence" );
}

//-----------------------------------------------------------------------------

std::set<std::string>
Schema::listSequences() const
{
  // Temporary
  throw coral::Exception( "not implemented yet", "CoralAccess", "Schema::listSequences" );
}
