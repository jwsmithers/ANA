// $Id: CALOpcode.h,v 1.4.2.1.2.2 2013-02-05 12:56:44 avalassi Exp $
...
namespace coral
{
  ...
  namespace CALOpcodes
  {
    ...
    // New in 24 protocol: CoralSockets ctrl msg to match secure/data channels
    static const CALOpcode SocketsCtlMsg       = 0x08;
