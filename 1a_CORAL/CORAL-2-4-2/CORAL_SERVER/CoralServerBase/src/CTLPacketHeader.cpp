// $Id: CTLPacketHeader.cpp,v 1.33.2.2.2.1 2013-02-06 14:46:12 avalassi Exp $
...
uint32_t
CTLPacketHeader::computeChecksum( const unsigned char* pData, size_t nData )
{
  ScopedTimer timer( myStatsTypeTimer );
