...
#define RELATIONALACCESS_DATABASESERVICEDESCRIPTION_H 1
...
namespace coral
{
  ...
  private:
    ...
    /// Assignment op is private (fix Coverity COPY_WITHOUT_ASSIGN bug #95357)
    DatabaseServiceDescription& operator=( const DatabaseServiceDescription& rhs );
