...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=CoralCommon -version=CoralCommon-1-6-X-back -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtCoralCommontempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=CoralCommon -version=CoralCommon-1-6-X-back -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtCoralCommontempfile}"
