...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=CoralKernel -version=CoralKernel-0-0-5 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtCoralKerneltempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=CoralKernel -version=CoralKernel-0-0-5 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtCoralKerneltempfile}"
  cmtsetupstatus=2
