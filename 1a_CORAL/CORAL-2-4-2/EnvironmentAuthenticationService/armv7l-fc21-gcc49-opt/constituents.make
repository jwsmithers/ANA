...
#cmt_local_tagfile = $(EnvironmentAuthenticationService_tag).make
cmt_local_tagfile = $(bin)$(EnvironmentAuthenticationService_tag).make
...
lcg_EnvironmentAuthenticationService_extratags = -tag_add=target_lcg_EnvironmentAuthenticationService
...
not_lcg_EnvironmentAuthenticationServicecompile_dependencies = { n=0; for p in $?; do m=0; for d in $(lcg_EnvironmentAuthenticationServicecompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
lcg_EnvironmentAuthenticationServicedirs :
	@if test ! -d $(bin)lcg_EnvironmentAuthenticationService; then $(mkdir) -p $(bin)lcg_EnvironmentAuthenticationService; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)lcg_EnvironmentAuthenticationService
else
lcg_EnvironmentAuthenticationServicedirs : ;
endif
...
ifndef QUICK
$(cmt_local_lcg_EnvironmentAuthenticationService_makefile) : $(lcg_EnvironmentAuthenticationServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_EnvironmentAuthenticationService.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_EnvironmentAuthenticationService_extratags) build constituent_config -out=$(cmt_local_lcg_EnvironmentAuthenticationService_makefile) lcg_EnvironmentAuthenticationService
else
$(cmt_local_lcg_EnvironmentAuthenticationService_makefile) : $(lcg_EnvironmentAuthenticationServicecompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_EnvironmentAuthenticationService) ] || \
	  [ ! -f $(cmt_final_setup_lcg_EnvironmentAuthenticationService) ] || \
	  $(not_lcg_EnvironmentAuthenticationServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building lcg_EnvironmentAuthenticationService.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_EnvironmentAuthenticationService_extratags) build constituent_config -out=$(cmt_local_lcg_EnvironmentAuthenticationService_makefile) lcg_EnvironmentAuthenticationService; \
	  fi
endif
...
$(cmt_local_lcg_EnvironmentAuthenticationService_makefile) : $(lcg_EnvironmentAuthenticationServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_EnvironmentAuthenticationService.make"; \
	  $(cmtexe) -f=$(bin)lcg_EnvironmentAuthenticationService.in -tag=$(tags) $(lcg_EnvironmentAuthenticationService_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_lcg_EnvironmentAuthenticationService_makefile) lcg_EnvironmentAuthenticationService
else
$(cmt_local_lcg_EnvironmentAuthenticationService_makefile) : $(lcg_EnvironmentAuthenticationServicecompile_dependencies) $(cmt_build_library_linksstamp) $(bin)lcg_EnvironmentAuthenticationService.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_EnvironmentAuthenticationService) ] || \
	  [ ! -f $(cmt_final_setup_lcg_EnvironmentAuthenticationService) ] || \
	  $(not_lcg_EnvironmentAuthenticationServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(lcg_EnvironmentAuthenticationService_extratags) build constituent_makefile -out=$(cmt_local_lcg_EnvironmentAuthenticationService_makefile) lcg_EnvironmentAuthenticationService

lcg_EnvironmentAuthenticationService :: lcg_EnvironmentAuthenticationServicecompile lcg_EnvironmentAuthenticationServiceinstall ;

ifdef cmt_lcg_EnvironmentAuthenticationService_has_prototypes

lcg_EnvironmentAuthenticationServiceprototype : $(lcg_EnvironmentAuthenticationServiceprototype_dependencies) $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) dirs lcg_EnvironmentAuthenticationServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) $@
	$(echo) "(constituents.make) $@ done"

lcg_EnvironmentAuthenticationServicecompile : lcg_EnvironmentAuthenticationServiceprototype

endif

lcg_EnvironmentAuthenticationServicecompile : $(lcg_EnvironmentAuthenticationServicecompile_dependencies) $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) dirs lcg_EnvironmentAuthenticationServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) $@; \
	  fi
...
lcg_EnvironmentAuthenticationServiceclean :: $(lcg_EnvironmentAuthenticationServiceclean_dependencies) ##$(cmt_local_lcg_EnvironmentAuthenticationService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) lcg_EnvironmentAuthenticationServiceclean

##	  /bin/rm -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) $(bin)lcg_EnvironmentAuthenticationService_dependencies.make

install :: lcg_EnvironmentAuthenticationServiceinstall ;

lcg_EnvironmentAuthenticationServiceinstall :: lcg_EnvironmentAuthenticationServicecompile $(lcg_EnvironmentAuthenticationService_dependencies) $(cmt_local_lcg_EnvironmentAuthenticationService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) $@; \
	  fi
...
$(foreach d,$(lcg_EnvironmentAuthenticationService_dependencies),$(eval $(d)uninstall_dependencies += lcg_EnvironmentAuthenticationServiceuninstall))

lcg_EnvironmentAuthenticationServiceuninstall : $(lcg_EnvironmentAuthenticationServiceuninstall_dependencies) ##$(cmt_local_lcg_EnvironmentAuthenticationService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_EnvironmentAuthenticationService_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: lcg_EnvironmentAuthenticationServiceuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ lcg_EnvironmentAuthenticationService"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ lcg_EnvironmentAuthenticationService done"
endif

#-- end of constituent_app_lib ------
#-- start of constituent_app_lib ------

cmt_test_unit_EnvironmentAuthenticationService_LoadService_has_no_target_tag = 1
cmt_test_unit_EnvironmentAuthenticationService_LoadService_has_prototypes = 1

#--------------------------------------

ifdef cmt_test_unit_EnvironmentAuthenticationService_LoadService_has_target_tag

cmt_local_tagfile_test_unit_EnvironmentAuthenticationService_LoadService = $(bin)$(EnvironmentAuthenticationService_tag)_test_unit_EnvironmentAuthenticationService_LoadService.make
cmt_final_setup_test_unit_EnvironmentAuthenticationService_LoadService = $(bin)setup_test_unit_EnvironmentAuthenticationService_LoadService.make
cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile = $(bin)test_unit_EnvironmentAuthenticationService_LoadService.make

test_unit_EnvironmentAuthenticationService_LoadService_extratags = -tag_add=target_test_unit_EnvironmentAuthenticationService_LoadService

else

cmt_local_tagfile_test_unit_EnvironmentAuthenticationService_LoadService = $(bin)$(EnvironmentAuthenticationService_tag).make
cmt_final_setup_test_unit_EnvironmentAuthenticationService_LoadService = $(bin)setup.make
cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile = $(bin)test_unit_EnvironmentAuthenticationService_LoadService.make

endif

not_test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies = { n=0; for p in $?; do m=0; for d in $(test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
test_unit_EnvironmentAuthenticationService_LoadServicedirs :
	@if test ! -d $(bin)test_unit_EnvironmentAuthenticationService_LoadService; then $(mkdir) -p $(bin)test_unit_EnvironmentAuthenticationService_LoadService; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)test_unit_EnvironmentAuthenticationService_LoadService
else
test_unit_EnvironmentAuthenticationService_LoadServicedirs : ;
endif
...
ifndef QUICK
$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) : $(test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_EnvironmentAuthenticationService_LoadService.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_EnvironmentAuthenticationService_LoadService_extratags) build constituent_config -out=$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) test_unit_EnvironmentAuthenticationService_LoadService
else
$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) : $(test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_EnvironmentAuthenticationService_LoadService) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_EnvironmentAuthenticationService_LoadService) ] || \
	  $(not_test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building test_unit_EnvironmentAuthenticationService_LoadService.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_EnvironmentAuthenticationService_LoadService_extratags) build constituent_config -out=$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) test_unit_EnvironmentAuthenticationService_LoadService; \
	  fi
endif
...
$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) : $(test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_EnvironmentAuthenticationService_LoadService.make"; \
	  $(cmtexe) -f=$(bin)test_unit_EnvironmentAuthenticationService_LoadService.in -tag=$(tags) $(test_unit_EnvironmentAuthenticationService_LoadService_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) test_unit_EnvironmentAuthenticationService_LoadService
else
$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) : $(test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies) $(cmt_build_library_linksstamp) $(bin)test_unit_EnvironmentAuthenticationService_LoadService.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_EnvironmentAuthenticationService_LoadService) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_EnvironmentAuthenticationService_LoadService) ] || \
	  $(not_test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(test_unit_EnvironmentAuthenticationService_LoadService_extratags) build constituent_makefile -out=$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) test_unit_EnvironmentAuthenticationService_LoadService

test_unit_EnvironmentAuthenticationService_LoadService :: test_unit_EnvironmentAuthenticationService_LoadServicecompile test_unit_EnvironmentAuthenticationService_LoadServiceinstall ;

ifdef cmt_test_unit_EnvironmentAuthenticationService_LoadService_has_prototypes

test_unit_EnvironmentAuthenticationService_LoadServiceprototype : $(test_unit_EnvironmentAuthenticationService_LoadServiceprototype_dependencies) $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) dirs test_unit_EnvironmentAuthenticationService_LoadServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) $@
	$(echo) "(constituents.make) $@ done"

test_unit_EnvironmentAuthenticationService_LoadServicecompile : test_unit_EnvironmentAuthenticationService_LoadServiceprototype

endif

test_unit_EnvironmentAuthenticationService_LoadServicecompile : $(test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies) $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) dirs test_unit_EnvironmentAuthenticationService_LoadServicedirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) $@; \
	  fi
...
clean :: test_unit_EnvironmentAuthenticationService_LoadServiceclean ;

test_unit_EnvironmentAuthenticationService_LoadServiceclean :: $(test_unit_EnvironmentAuthenticationService_LoadServiceclean_dependencies) ##$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) test_unit_EnvironmentAuthenticationService_LoadServiceclean

##	  /bin/rm -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) $(bin)test_unit_EnvironmentAuthenticationService_LoadService_dependencies.make

install :: test_unit_EnvironmentAuthenticationService_LoadServiceinstall ;

test_unit_EnvironmentAuthenticationService_LoadServiceinstall :: test_unit_EnvironmentAuthenticationService_LoadServicecompile $(test_unit_EnvironmentAuthenticationService_LoadService_dependencies) $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) $@; \
	  fi
...
uninstall : test_unit_EnvironmentAuthenticationService_LoadServiceuninstall

$(foreach d,$(test_unit_EnvironmentAuthenticationService_LoadService_dependencies),$(eval $(d)uninstall_dependencies += test_unit_EnvironmentAuthenticationService_LoadServiceuninstall))

test_unit_EnvironmentAuthenticationService_LoadServiceuninstall : $(test_unit_EnvironmentAuthenticationService_LoadServiceuninstall_dependencies) ##$(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_EnvironmentAuthenticationService_LoadService_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: test_unit_EnvironmentAuthenticationService_LoadServiceuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ test_unit_EnvironmentAuthenticationService_LoadService"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ test_unit_EnvironmentAuthenticationService_LoadService done"
endif
...
cmt_local_tagfile_install_includes = $(bin)$(EnvironmentAuthenticationService_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(EnvironmentAuthenticationService_tag).make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(EnvironmentAuthenticationService_tag)_install_pythonmods.make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(EnvironmentAuthenticationService_tag).make
...
cmt_local_tagfile_make = $(bin)$(EnvironmentAuthenticationService_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(EnvironmentAuthenticationService_tag).make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(EnvironmentAuthenticationService_tag)_lcg_mkdir.make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(EnvironmentAuthenticationService_tag).make
...
cmt_local_tagfile_utilities = $(bin)$(EnvironmentAuthenticationService_tag)_utilities.make
...
cmt_local_tagfile_utilities = $(bin)$(EnvironmentAuthenticationService_tag).make
...
cmt_local_tagfile_examples = $(bin)$(EnvironmentAuthenticationService_tag)_examples.make
...
cmt_local_tagfile_examples = $(bin)$(EnvironmentAuthenticationService_tag).make
