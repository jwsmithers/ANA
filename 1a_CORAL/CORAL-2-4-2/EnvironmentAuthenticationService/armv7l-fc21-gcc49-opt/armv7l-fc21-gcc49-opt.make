...
EnvironmentAuthenticationService_cmtpath=/home/jwsmith/HDD
EnvironmentAuthenticationService_offset=CORAL/CORAL-2-4-2
EnvironmentAuthenticationService_project=jwsmith
EnvironmentAuthenticationService_project_release=HDD
CoralCommon_tag=$(tag)
...
use_cppflags=  $(EnvironmentAuthenticationService_cppflags)  $(CoralCommon_cppflags)  $(CoralKernel_cppflags)  $(RelationalAccess_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
lcg_EnvironmentAuthenticationService_shlibflags=$(libraryshr_linkopts) $(use_linkopts) 
...
constituents= lcg_EnvironmentAuthenticationService install_includes install_pythonmods 
tests_constituents=lcg_mkdir  test_unit_EnvironmentAuthenticationService_LoadService 
test_unit_EnvironmentAuthenticationService_LoadService_dependencies=lcg_mkdir
test_unit_EnvironmentAuthenticationService_LoadServicelinkopts= $(EnvironmentAuthenticationService_linkopts) $(EnvironmentAuthenticationService_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
run_install_pythonmods=do_install_pythonmods
tag=armv7l-fc21-gcc49-opt
package=EnvironmentAuthenticationService
version=EnvironmentAuthenticationService-1-2-0
PACKAGE_ROOT=$(ENVIRONMENTAUTHENTICATIONSERVICEROOT)
srcdir=../src
bin=../$(EnvironmentAuthenticationService_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/EnvironmentAuthenticationService/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_stamps=  $(EnvironmentAuthenticationService_stamps)  $(CoralCommon_stamps)  $(CoralKernel_stamps)  $(RelationalAccess_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(EnvironmentAuthenticationService_cflags)  $(CoralCommon_cflags)  $(CoralKernel_cflags)  $(RelationalAccess_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(EnvironmentAuthenticationService_pp_cflags)  $(CoralCommon_pp_cflags)  $(CoralKernel_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(EnvironmentAuthenticationService_pp_cppflags)  $(CoralCommon_pp_cppflags)  $(CoralKernel_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(EnvironmentAuthenticationService_fflags)  $(CoralCommon_fflags)  $(CoralKernel_fflags)  $(RelationalAccess_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(EnvironmentAuthenticationService_pp_fflags)  $(CoralCommon_pp_fflags)  $(CoralKernel_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
...
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/EnvironmentAuthenticationService" $(use_includes)
fincludes= $(includes)
lcg_EnvironmentAuthenticationService_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lcg_EnvironmentAuthenticationService_use_linkopts=  $(EnvironmentAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
test_unit_EnvironmentAuthenticationService_LoadService_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_EnvironmentAuthenticationService_LoadService_use_linkopts=  $(EnvironmentAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_EnvironmentAuthenticationServiceclean 
...
tests_constituentsclean= test_unit_EnvironmentAuthenticationService_LoadServiceclean 
lcg_EnvironmentAuthenticationServiceprototype_dependencies= $(lcg_EnvironmentAuthenticationServicecompile_dependencies)
test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies= lcg_mkdir
test_unit_EnvironmentAuthenticationService_LoadServiceprototype_dependencies= $(test_unit_EnvironmentAuthenticationService_LoadServicecompile_dependencies)
