...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=EnvironmentAuthenticationService -version=EnvironmentAuthenticationService-1-2-0 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtEnvironmentAuthenticationServicetempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=EnvironmentAuthenticationService -version=EnvironmentAuthenticationService-1-2-0 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtEnvironmentAuthenticationServicetempfile}"
