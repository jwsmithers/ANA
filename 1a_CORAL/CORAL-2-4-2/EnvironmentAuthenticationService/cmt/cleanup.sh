...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=EnvironmentAuthenticationService -version=EnvironmentAuthenticationService-1-2-0 -path=/home/jwsmith/HDD/CORAL/CORAL-2-4-2  $* >${cmtEnvironmentAuthenticationServicetempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=EnvironmentAuthenticationService -version=EnvironmentAuthenticationService-1-2-0 -path=/home/jwsmith/HDD/CORAL/CORAL-2-4-2  $* >${cmtEnvironmentAuthenticationServicetempfile}"
  cmtcleanupstatus=2
