...
#     use CoralBase v*  (no_version_directory)
# use mysql * LCG_Interfaces (no_version_directory) (native_version=5.5.27)
#   use LCG_Configuration v*  (no_version_directory)
#   use LCG_Settings v*  (no_version_directory)
#
# Selection :
...
use mysql v1 LCG_Interfaces (/home/jwsmith/HDD/ANA/ANA/1_LCGSoftware/lcgcmake_install-armv7l-fc21-gcc49-opt-71/LCGCMT/LCGCMT_71)
...
target-c11 (from package MySQLAccess) excludes [RELAX] activated LCG_Platforms
