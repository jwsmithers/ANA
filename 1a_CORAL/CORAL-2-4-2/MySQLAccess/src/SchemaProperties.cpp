// $Id: SchemaProperties.cpp,v 1.10 2012-03-06 16:20:40 avalassi Exp $
...
namespace coral
{
  ...
  {
    SchemaProperties::SchemaProperties( boost::shared_ptr<const SessionProperties> sessprops, const std::string& schemaName, Schema& schema )
