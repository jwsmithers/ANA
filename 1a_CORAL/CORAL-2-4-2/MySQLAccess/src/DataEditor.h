// $Id: DataEditor.h,v 1.5 2012-03-06 16:20:39 avalassi Exp $
...
namespace coral
{
  ...
  namespace MySQLAccess
  {
    ...
    public:
      /// Constructor
      DataEditor( boost::shared_ptr<const SessionProperties> properties, const coral::ITableDescription& description );
