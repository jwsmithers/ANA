...
namespace coral
{
  namespace MySQLAccess
  {
    ...
    void Connection::connect()
    {
      ...
      //           coral::MessageStream log( m_domainProperties.service(), m_domainServiceName, coral::Debug );
      ...
      //             {
      //               throw coral::ConnectionException( m_domainServiceName, errorHandler.message(), "coral::MySQLAccess::connect" );
      //             }
      //             else
      //             {
      //               log << coral::Error << errorHandler.message() << std::endl << coral::MessageStream::endmsg;
      //               throw coral::DatabaseNotAccessibleException( m_domainServiceName, "IConnection::connect" );
      //             }
    ...
    std::string Connection::serverVersion() const
    {
      ...
      if ( ! this->m_connected )
        throw coral::ConnectionNotActiveException( m_domainServiceName, "coral::MySQLAccess::Connection::serverVersion" );
