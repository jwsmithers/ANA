...
#cmt_local_tagfile = $(RelationalAccess_tag).make
cmt_local_tagfile = $(bin)$(RelationalAccess_tag).make
...
lcg_RelationalAccess_extratags = -tag_add=target_lcg_RelationalAccess
...
not_lcg_RelationalAccesscompile_dependencies = { n=0; for p in $?; do m=0; for d in $(lcg_RelationalAccesscompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
lcg_RelationalAccessdirs :
	@if test ! -d $(bin)lcg_RelationalAccess; then $(mkdir) -p $(bin)lcg_RelationalAccess; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)lcg_RelationalAccess
else
lcg_RelationalAccessdirs : ;
endif
...
ifndef QUICK
$(cmt_local_lcg_RelationalAccess_makefile) : $(lcg_RelationalAccesscompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_RelationalAccess.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_RelationalAccess_extratags) build constituent_config -out=$(cmt_local_lcg_RelationalAccess_makefile) lcg_RelationalAccess
else
$(cmt_local_lcg_RelationalAccess_makefile) : $(lcg_RelationalAccesscompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_RelationalAccess) ] || \
	  [ ! -f $(cmt_final_setup_lcg_RelationalAccess) ] || \
	  $(not_lcg_RelationalAccesscompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building lcg_RelationalAccess.make"; \
	  $(cmtexe) -tag=$(tags) $(lcg_RelationalAccess_extratags) build constituent_config -out=$(cmt_local_lcg_RelationalAccess_makefile) lcg_RelationalAccess; \
	  fi
endif
...
$(cmt_local_lcg_RelationalAccess_makefile) : $(lcg_RelationalAccesscompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building lcg_RelationalAccess.make"; \
	  $(cmtexe) -f=$(bin)lcg_RelationalAccess.in -tag=$(tags) $(lcg_RelationalAccess_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_lcg_RelationalAccess_makefile) lcg_RelationalAccess
else
$(cmt_local_lcg_RelationalAccess_makefile) : $(lcg_RelationalAccesscompile_dependencies) $(cmt_build_library_linksstamp) $(bin)lcg_RelationalAccess.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_lcg_RelationalAccess) ] || \
	  [ ! -f $(cmt_final_setup_lcg_RelationalAccess) ] || \
	  $(not_lcg_RelationalAccesscompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(lcg_RelationalAccess_extratags) build constituent_makefile -out=$(cmt_local_lcg_RelationalAccess_makefile) lcg_RelationalAccess

lcg_RelationalAccess :: lcg_RelationalAccesscompile lcg_RelationalAccessinstall ;

ifdef cmt_lcg_RelationalAccess_has_prototypes

lcg_RelationalAccessprototype : $(lcg_RelationalAccessprototype_dependencies) $(cmt_local_lcg_RelationalAccess_makefile) dirs lcg_RelationalAccessdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_RelationalAccess_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalAccess_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_RelationalAccess_makefile) $@
	$(echo) "(constituents.make) $@ done"

lcg_RelationalAccesscompile : lcg_RelationalAccessprototype

endif

lcg_RelationalAccesscompile : $(lcg_RelationalAccesscompile_dependencies) $(cmt_local_lcg_RelationalAccess_makefile) dirs lcg_RelationalAccessdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_RelationalAccess_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalAccess_makefile) $@; \
	  fi
...
lcg_RelationalAccessclean :: $(lcg_RelationalAccessclean_dependencies) ##$(cmt_local_lcg_RelationalAccess_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_RelationalAccess_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalAccess_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_lcg_RelationalAccess_makefile) lcg_RelationalAccessclean

##	  /bin/rm -f $(cmt_local_lcg_RelationalAccess_makefile) $(bin)lcg_RelationalAccess_dependencies.make

install :: lcg_RelationalAccessinstall ;

lcg_RelationalAccessinstall :: lcg_RelationalAccesscompile $(lcg_RelationalAccess_dependencies) $(cmt_local_lcg_RelationalAccess_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_lcg_RelationalAccess_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalAccess_makefile) $@; \
	  fi
...
$(foreach d,$(lcg_RelationalAccess_dependencies),$(eval $(d)uninstall_dependencies += lcg_RelationalAccessuninstall))

lcg_RelationalAccessuninstall : $(lcg_RelationalAccessuninstall_dependencies) ##$(cmt_local_lcg_RelationalAccess_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_lcg_RelationalAccess_makefile); then \
	  $(MAKE) -f $(cmt_local_lcg_RelationalAccess_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_lcg_RelationalAccess_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: lcg_RelationalAccessuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ lcg_RelationalAccess"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ lcg_RelationalAccess done"
endif

#-- end of constituent_app_lib ------
#-- start of constituent_app_lib ------

cmt_test_unit_RelationalAccess_TableDescription_has_no_target_tag = 1
cmt_test_unit_RelationalAccess_TableDescription_has_prototypes = 1

#--------------------------------------

ifdef cmt_test_unit_RelationalAccess_TableDescription_has_target_tag

cmt_local_tagfile_test_unit_RelationalAccess_TableDescription = $(bin)$(RelationalAccess_tag)_test_unit_RelationalAccess_TableDescription.make
cmt_final_setup_test_unit_RelationalAccess_TableDescription = $(bin)setup_test_unit_RelationalAccess_TableDescription.make
cmt_local_test_unit_RelationalAccess_TableDescription_makefile = $(bin)test_unit_RelationalAccess_TableDescription.make

test_unit_RelationalAccess_TableDescription_extratags = -tag_add=target_test_unit_RelationalAccess_TableDescription

else

cmt_local_tagfile_test_unit_RelationalAccess_TableDescription = $(bin)$(RelationalAccess_tag).make
cmt_final_setup_test_unit_RelationalAccess_TableDescription = $(bin)setup.make
cmt_local_test_unit_RelationalAccess_TableDescription_makefile = $(bin)test_unit_RelationalAccess_TableDescription.make

endif

not_test_unit_RelationalAccess_TableDescriptioncompile_dependencies = { n=0; for p in $?; do m=0; for d in $(test_unit_RelationalAccess_TableDescriptioncompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
test_unit_RelationalAccess_TableDescriptiondirs :
	@if test ! -d $(bin)test_unit_RelationalAccess_TableDescription; then $(mkdir) -p $(bin)test_unit_RelationalAccess_TableDescription; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)test_unit_RelationalAccess_TableDescription
else
test_unit_RelationalAccess_TableDescriptiondirs : ;
endif
...
ifndef QUICK
$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) : $(test_unit_RelationalAccess_TableDescriptioncompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_RelationalAccess_TableDescription.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_RelationalAccess_TableDescription_extratags) build constituent_config -out=$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) test_unit_RelationalAccess_TableDescription
else
$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) : $(test_unit_RelationalAccess_TableDescriptioncompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_RelationalAccess_TableDescription) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_RelationalAccess_TableDescription) ] || \
	  $(not_test_unit_RelationalAccess_TableDescriptioncompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building test_unit_RelationalAccess_TableDescription.make"; \
	  $(cmtexe) -tag=$(tags) $(test_unit_RelationalAccess_TableDescription_extratags) build constituent_config -out=$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) test_unit_RelationalAccess_TableDescription; \
	  fi
endif
...
$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) : $(test_unit_RelationalAccess_TableDescriptioncompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building test_unit_RelationalAccess_TableDescription.make"; \
	  $(cmtexe) -f=$(bin)test_unit_RelationalAccess_TableDescription.in -tag=$(tags) $(test_unit_RelationalAccess_TableDescription_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) test_unit_RelationalAccess_TableDescription
else
$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) : $(test_unit_RelationalAccess_TableDescriptioncompile_dependencies) $(cmt_build_library_linksstamp) $(bin)test_unit_RelationalAccess_TableDescription.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_test_unit_RelationalAccess_TableDescription) ] || \
	  [ ! -f $(cmt_final_setup_test_unit_RelationalAccess_TableDescription) ] || \
	  $(not_test_unit_RelationalAccess_TableDescriptioncompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(test_unit_RelationalAccess_TableDescription_extratags) build constituent_makefile -out=$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) test_unit_RelationalAccess_TableDescription

test_unit_RelationalAccess_TableDescription :: test_unit_RelationalAccess_TableDescriptioncompile test_unit_RelationalAccess_TableDescriptioninstall ;

ifdef cmt_test_unit_RelationalAccess_TableDescription_has_prototypes

test_unit_RelationalAccess_TableDescriptionprototype : $(test_unit_RelationalAccess_TableDescriptionprototype_dependencies) $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) dirs test_unit_RelationalAccess_TableDescriptiondirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) $@
	$(echo) "(constituents.make) $@ done"

test_unit_RelationalAccess_TableDescriptioncompile : test_unit_RelationalAccess_TableDescriptionprototype

endif

test_unit_RelationalAccess_TableDescriptioncompile : $(test_unit_RelationalAccess_TableDescriptioncompile_dependencies) $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) dirs test_unit_RelationalAccess_TableDescriptiondirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) $@; \
	  fi
...
clean :: test_unit_RelationalAccess_TableDescriptionclean ;

test_unit_RelationalAccess_TableDescriptionclean :: $(test_unit_RelationalAccess_TableDescriptionclean_dependencies) ##$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) test_unit_RelationalAccess_TableDescriptionclean

##	  /bin/rm -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) $(bin)test_unit_RelationalAccess_TableDescription_dependencies.make

install :: test_unit_RelationalAccess_TableDescriptioninstall ;

test_unit_RelationalAccess_TableDescriptioninstall :: test_unit_RelationalAccess_TableDescriptioncompile $(test_unit_RelationalAccess_TableDescription_dependencies) $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) $@; \
	  fi
...
uninstall : test_unit_RelationalAccess_TableDescriptionuninstall

$(foreach d,$(test_unit_RelationalAccess_TableDescription_dependencies),$(eval $(d)uninstall_dependencies += test_unit_RelationalAccess_TableDescriptionuninstall))

test_unit_RelationalAccess_TableDescriptionuninstall : $(test_unit_RelationalAccess_TableDescriptionuninstall_dependencies) ##$(cmt_local_test_unit_RelationalAccess_TableDescription_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile); then \
	  $(MAKE) -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_test_unit_RelationalAccess_TableDescription_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: test_unit_RelationalAccess_TableDescriptionuninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ test_unit_RelationalAccess_TableDescription"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ test_unit_RelationalAccess_TableDescription done"
endif
...
cmt_local_tagfile_install_includes = $(bin)$(RelationalAccess_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(RelationalAccess_tag).make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(RelationalAccess_tag)_install_pythonmods.make
...
cmt_local_tagfile_install_pythonmods = $(bin)$(RelationalAccess_tag).make
...
cmt_local_tagfile_make = $(bin)$(RelationalAccess_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(RelationalAccess_tag).make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(RelationalAccess_tag)_lcg_mkdir.make
...
cmt_local_tagfile_lcg_mkdir = $(bin)$(RelationalAccess_tag).make
...
cmt_local_tagfile_utilities = $(bin)$(RelationalAccess_tag)_utilities.make
...
cmt_local_tagfile_utilities = $(bin)$(RelationalAccess_tag).make
...
cmt_local_tagfile_examples = $(bin)$(RelationalAccess_tag)_examples.make
...
cmt_local_tagfile_examples = $(bin)$(RelationalAccess_tag).make
