...
coral::MsgReporter::report(int lvl, const std::string& src, const std::string& msg)
{
  ...
  else if( format == 2 /*atlas format*/ )
  {
    ...
    char b01[25];
    snprintf(b01, 25, "%u-%02u-%02u %02u:%02u:%02u.000", (l01->tm_year + 1900), (l01->tm_mon + 1), l01->tm_mday, l01->tm_hour, l01->tm_min, l01->tm_sec); // Fix Coverity SECURE_CODING
    ...
    char b02[10];
    snprintf(b02, 10, "%li", tspec.tv_nsec); // Fix Coverity SECURE_CODING

    char b01[25];
    snprintf(b01, 25, "%i-%02i-%02i %02i:%02i:%02i.%.3s", (l01->tm_year + 1900), (l01->tm_mon + 1), l01->tm_mday, l01->tm_hour, l01->tm_min, l01->tm_sec, b02); // Fix Coverity SECURE_CODING
