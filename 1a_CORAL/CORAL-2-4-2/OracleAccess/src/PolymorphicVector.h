...
namespace coral
{
  ...
  namespace OracleAccess
  {
    ...
    public:
      ...
      /// Constructor
      explicit PolymorphicTVector( size_t cacheSize ) : PolymorphicVector( cacheSize ), m_data(), m_majorServerVersion( 0 ), m_cacheSize( cacheSize )
      {}

      /// Constructor
      PolymorphicTVector( size_t cacheSize,
                          int majorServerVersion ) :
        PolymorphicVector( cacheSize ), m_data(), m_majorServerVersion( majorServerVersion ), m_cacheSize( cacheSize )
      {
      ...
      /// Returns the oracle type
      ub2 dty() const { if ( m_majorServerVersion > 9 ) return SQLT_BFLOAT; else return SQLT_FLT; };
    ...
    template<> ub2
    PolymorphicTVector<double>::dty() const { if ( m_majorServerVersion > 9 ) return SQLT_BDOUBLE; else return SQLT_FLT; }

    template<> ub2
    PolymorphicTVector<long double>::dty() const { if ( m_majorServerVersion > 9 ) return SQLT_BDOUBLE; else return SQLT_FLT; }
    ...
    public:
      /// Constructor
      PolymorphicTVector( size_t cacheSize, boost::shared_ptr<const SessionProperties> properties ) :
        PolymorphicVector( cacheSize ),
        m_data(),
        m_cacheSize( cacheSize ),
        m_sessionProperties( properties )
      {
        ...
        std::cout << "Create PolymorphicTVector<coral::TimeStamp> " << this << std::endl; // debug bug #98736
#endif
      }
      ...
      {
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
        std::cout << "Delete PolymorphicTVector<coral::TimeStamp> " << this << std::endl; // debug bug #98736
#endif
        this->clear();
      }
      ...
      void push_back( const void* dataPointer,
        ...
        OCIDescriptorAlloc( m_sessionProperties->ociEnvHandle(),
        ...
        OCIDateTimeConstruct( m_sessionProperties->ociEnvHandle(),
    ...
    public:
      ...
      {
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
        std::cout << "Create PolymorphicTVector<coral::Blob> " << this << std::endl; // debug bug #98736
#endif
      }
      ...
      {
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
        std::cout << "Delete PolymorphicTVector<coral::Blob> " << this << std::endl; // debug bug #98736
#endif
        this->clear();
      }
      ...
      void push_back( const void* dataPointer,
        ...
        OCILobCreateTemporary( m_sessionProperties->ociSvcCtxHandle(),
                               m_sessionProperties->ociErrorHandle(),
                               theData,
        ...
        OCILobWriteAppend( m_sessionProperties->ociSvcCtxHandle(),
                           m_sessionProperties->ociErrorHandle(),
                           theData, &amtp,
    ...
    public:
      ...
      {
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
        std::cout << "Create PolymorphicTVector<long long> " << this << std::endl; // debug bug #98736
#endif
      }
      ...
      {
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
        std::cout << "Delete PolymorphicTVector<long long> " << this << std::endl; // debug bug #98736
#endif
      }
      ...
      void push_back( const void* dataPointer,
        ...
        OCINumber data;
        m_data.push_back( data );
        OCINumberFromInt( m_sessionProperties->ociErrorHandle(), dataPointer,
                          sizeof(long long),
    ...
    public:
      ...
      {
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
        std::cout << "Create PolymorphicTVector<unsigned long long> " << this << std::endl; // debug bug #98736
#endif
      }
      ...
      {
#ifdef ORACLE_CONNECTION_PROPERTIES_DEBUG
        std::cout << "Delete PolymorphicTVector<unsigned long long> " << this << std::endl; // debug bug #98736
#endif
      }
