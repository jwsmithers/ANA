...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=OracleAccess -version=OracleAccess-1-7-3 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtOracleAccesstempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=OracleAccess -version=OracleAccess-1-7-3 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtOracleAccesstempfile}"
  cmtsetupstatus=2
