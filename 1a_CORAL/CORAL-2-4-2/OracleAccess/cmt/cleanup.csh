...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=OracleAccess -version=OracleAccess-1-7-3 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  $* >${cmtOracleAccesstempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=OracleAccess -version=OracleAccess-1-7-3 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  $* >${cmtOracleAccesstempfile}"
