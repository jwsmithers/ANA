...
source /home/jwsmith/HDD/lcgcmake-install-gcc49/cmt/v1r26p20140131/armv7l-fc21-gcc49-opt/CMT/v1r26p20140131/mgr/setup.sh
source $TopDir/lcgcmake-install-gcc49/ROOT/5.34.24/armv7l-fc21-gcc49-opt/bin/thisroot.sh
export LC_ALL=C
export MYPATH=$TopDir/CORAL/CORAL-2-4-2
...
#Python
export LD_LIBRARY_PATH=$TopDir/lcgcmake-install-gcc49/Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7:$LD_LIBRARY_PATH
export CPLUS_INCLUDE_PATH=$TopDir/lcgcmake-install-gcc49/Python/2.7.6/armv7l-fc21-gcc49-opt/include/python2.7:$CPLUS_INCLUDE_PATH
