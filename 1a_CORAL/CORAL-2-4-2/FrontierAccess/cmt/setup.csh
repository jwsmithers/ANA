...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=FrontierAccess -version=FrontierAccess-1-8-1 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtFrontierAccesstempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=FrontierAccess -version=FrontierAccess-1-8-1 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  -no_cleanup $* >${cmtFrontierAccesstempfile}"
