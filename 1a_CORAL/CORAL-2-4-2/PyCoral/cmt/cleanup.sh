...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=PyCoral -version=PyCoral-1-1-1 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  $* >${cmtPyCoraltempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=PyCoral -version=PyCoral-1-1-1 -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  $* >${cmtPyCoraltempfile}"
  cmtcleanupstatus=2
