...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=XMLAuthenticationService -version=XMLAuthenticationService-1-2-X-back -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  $* >${cmtXMLAuthenticationServicetempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=XMLAuthenticationService -version=XMLAuthenticationService-1-2-X-back -path=/home/jwsmith/HDD/ANA/ANA/1a_CORAL/CORAL-2-4-2  $* >${cmtXMLAuthenticationServicetempfile}"
  cmtcleanupstatus=2
