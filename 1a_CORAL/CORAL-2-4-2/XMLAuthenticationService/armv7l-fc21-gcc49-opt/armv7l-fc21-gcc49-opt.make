...
XMLAuthenticationService_cmtpath=/home/jwsmith/HDD
XMLAuthenticationService_offset=CORAL/CORAL-2-4-2
XMLAuthenticationService_project=jwsmith
XMLAuthenticationService_project_release=HDD
CoralCommon_tag=$(tag)
...
use_cppflags=  $(XMLAuthenticationService_cppflags)  $(CoralCommon_cppflags)  $(CoralKernel_cppflags)  $(RelationalAccess_cppflags)  $(CoralBase_cppflags)  $(LCG_Policy_cppflags)  $(Boost_cppflags)  $(XercesC_cppflags)  $(LCG_Settings_cppflags)  $(LCG_Configuration_cppflags)  $(LCG_Platforms_cppflags) 
...
lcg_XMLAuthenticationService_shlibflags=$(libraryshr_linkopts) $(use_linkopts) 
use_linkopts= $(cmt_installarea_linkopts)     $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
constituents= lcg_XMLAuthenticationService install_includes install_pythonmods 
CppUnit_tag=$(tag)
...
tests_constituents=lcg_mkdir  test_unit_XMLAuthenticationService_LoadService 
test_unit_XMLAuthenticationService_LoadService_dependencies=lcg_mkdir
test_unit_XMLAuthenticationService_LoadServicelinkopts= $(XMLAuthenticationService_linkopts) $(XMLAuthenticationService_tests_linkopts) $(gcov_linkopts) $(icc_linkopts)  -L$(CMTINSTALLAREA)/$(CMTCONFIG)/tests/lib 
run_install_pythonmods=do_install_pythonmods
tag=armv7l-fc21-gcc49-opt
package=XMLAuthenticationService
version=XMLAuthenticationService-1-2-X-back
PACKAGE_ROOT=$(XMLAUTHENTICATIONSERVICEROOT)
srcdir=../src
bin=../$(XMLAuthenticationService_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/home/jwsmith/HDD/CORAL/CORAL-2-4-2/XMLAuthenticationService/armv7l-fc21-gcc49-opt/
project=jwsmith
...
use_stamps=  $(XMLAuthenticationService_stamps)  $(CoralCommon_stamps)  $(CoralKernel_stamps)  $(RelationalAccess_stamps)  $(CoralBase_stamps)  $(LCG_Policy_stamps)  $(Boost_stamps)  $(XercesC_stamps)  $(LCG_Settings_stamps)  $(LCG_Configuration_stamps)  $(LCG_Platforms_stamps) 
use_cflags=  $(XMLAuthenticationService_cflags)  $(CoralCommon_cflags)  $(CoralKernel_cflags)  $(RelationalAccess_cflags)  $(CoralBase_cflags)  $(LCG_Policy_cflags)  $(Boost_cflags)  $(XercesC_cflags)  $(LCG_Settings_cflags)  $(LCG_Configuration_cflags)  $(LCG_Platforms_cflags) 
use_pp_cflags=  $(XMLAuthenticationService_pp_cflags)  $(CoralCommon_pp_cflags)  $(CoralKernel_pp_cflags)  $(RelationalAccess_pp_cflags)  $(CoralBase_pp_cflags)  $(LCG_Policy_pp_cflags)  $(Boost_pp_cflags)  $(XercesC_pp_cflags)  $(LCG_Settings_pp_cflags)  $(LCG_Configuration_pp_cflags)  $(LCG_Platforms_pp_cflags) 
use_pp_cppflags=  $(XMLAuthenticationService_pp_cppflags)  $(CoralCommon_pp_cppflags)  $(CoralKernel_pp_cppflags)  $(RelationalAccess_pp_cppflags)  $(CoralBase_pp_cppflags)  $(LCG_Policy_pp_cppflags)  $(Boost_pp_cppflags)  $(XercesC_pp_cppflags)  $(LCG_Settings_pp_cppflags)  $(LCG_Configuration_pp_cppflags)  $(LCG_Platforms_pp_cppflags) 
use_fflags=  $(XMLAuthenticationService_fflags)  $(CoralCommon_fflags)  $(CoralKernel_fflags)  $(RelationalAccess_fflags)  $(CoralBase_fflags)  $(LCG_Policy_fflags)  $(Boost_fflags)  $(XercesC_fflags)  $(LCG_Settings_fflags)  $(LCG_Configuration_fflags)  $(LCG_Platforms_fflags) 
use_pp_fflags=  $(XMLAuthenticationService_pp_fflags)  $(CoralCommon_pp_fflags)  $(CoralKernel_pp_fflags)  $(RelationalAccess_pp_fflags)  $(CoralBase_pp_fflags)  $(LCG_Policy_pp_fflags)  $(Boost_pp_fflags)  $(XercesC_pp_fflags)  $(LCG_Settings_pp_fflags)  $(LCG_Configuration_pp_fflags)  $(LCG_Platforms_pp_fflags) 
...
includes= $(ppcmd)"/home/jwsmith/HDD/CORAL/CORAL-2-4-2/XMLAuthenticationService" $(use_includes)
fincludes= $(includes)
lcg_XMLAuthenticationService_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
lcg_XMLAuthenticationService_use_linkopts=  $(XMLAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
test_unit_XMLAuthenticationService_LoadService_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_unit_XMLAuthenticationService_LoadService_use_linkopts=  $(XMLAuthenticationService_linkopts)  $(CoralCommon_linkopts)  $(CoralKernel_linkopts)  $(RelationalAccess_linkopts)  $(CoralBase_linkopts)  $(LCG_Policy_linkopts)  $(Boost_linkopts)  $(XercesC_linkopts)  $(CppUnit_linkopts)  $(LCG_Settings_linkopts)  $(LCG_Configuration_linkopts)  $(LCG_Platforms_linkopts) 
app_test_unit_XMLAuthenticationService_LoadService_cflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cflags) 
app_test_unit_XMLAuthenticationService_LoadService_pp_cflags=  $(CppUnit_pp_cflags) 
app_test_unit_XMLAuthenticationService_LoadService_cppflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_cppflags) 
app_test_unit_XMLAuthenticationService_LoadService_pp_cppflags=  $(CppUnit_pp_cppflags) 
app_test_unit_XMLAuthenticationService_LoadService_fflags= $(ppcmd)"/home/jwsmith/HDD/lcgcmake-install-gcc49/LCGCMT/LCGCMT_71/LCG_Settings/../../../CppUnit/1.12.1_p1/armv7l-fc21-gcc49-opt/include"  $(CppUnit_fflags) 
app_test_unit_XMLAuthenticationService_LoadService_pp_fflags=  $(CppUnit_pp_fflags) 
test_unit_XMLAuthenticationService_LoadService_stamps=  $(CppUnit_stamps) 
...
constituentsclean= install_pythonmodsclean install_includesclean lcg_XMLAuthenticationServiceclean 
...
tests_constituentsclean= test_unit_XMLAuthenticationService_LoadServiceclean 
lcg_XMLAuthenticationServiceprototype_dependencies= $(lcg_XMLAuthenticationServicecompile_dependencies)
test_unit_XMLAuthenticationService_LoadServicecompile_dependencies= lcg_mkdir
test_unit_XMLAuthenticationService_LoadServiceprototype_dependencies= $(test_unit_XMLAuthenticationService_LoadServicecompile_dependencies)
