...
###set icc_home=/afs/cern.ch/sw/IntelSoftware/linux/x86_64/xe2013
set intelplat=`cmt show set_value intelplat`
set intel_home=`cmt show set_value intel_home`
set icc_home=`cmt show set_value icc_home`
...
set arch = $intelplat # Workaround for bug #103950 in Intel scripts
source ${icc_home}/bin/iccvars.csh ${intelplat}
unset arch # Workaround for bug #103950 in Intel scripts
