...
public:
  ...
  void test_default_constructor() {
    ...
    CPPUNIT_ASSERT_EQUAL( cool_ChannelSelection_Order::channelBeforeSince, s.order() );
  ...
  void test_order() {
    ChannelSelection s( cool_ChannelSelection_Order::sinceBeforeChannel );
    CPPUNIT_ASSERT_EQUAL( (ChannelId)0, s.firstChannel() );
    CPPUNIT_ASSERT_EQUAL( (ChannelId)4294967295ul, s.lastChannel() );
    CPPUNIT_ASSERT_EQUAL( cool_ChannelSelection_Order::sinceBeforeChannel, s.order() );
    CPPUNIT_ASSERT( s.allChannels() );
    CPPUNIT_ASSERT( s.isNumeric() );
  }
  ...
  void test_range_order() {
    ChannelSelection s( 5, 10, cool_ChannelSelection_Order::sinceBeforeChannel );
    CPPUNIT_ASSERT_EQUAL( (ChannelId)5, s.firstChannel() );
    CPPUNIT_ASSERT_EQUAL( (ChannelId)10, s.lastChannel() );
    CPPUNIT_ASSERT_EQUAL( cool_ChannelSelection_Order::sinceBeforeChannel, s.order() );
    CPPUNIT_ASSERT( ! s.allChannels() );
