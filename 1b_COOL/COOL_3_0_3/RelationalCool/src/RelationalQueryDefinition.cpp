                                          ...
                                          const std::string& alias )
{
  ...
  if ( m_optimizeClobs &&
       ( type == cool_StorageType_TypeId::String64k || type == cool_StorageType_TypeId::String16M ) &&
       !fromAlias.empty() )
  {
         ...
         m_clobStringOptList.end() )
    {
      ...
      addSelectItem( "ROWIDTOCHAR("+fromAlias+".ROWID)",
                     cool_StorageType_TypeId::String4k, PREFIX+fromAlias+EXT_ROWID );
                                             ...
                                             RelationalQueryMgr* queryMgr )
{
        ...
        it != m_clobStringOptList.end(); ++it )
  {
    ...
    if ( def.get() != 0 )
    {
      ...
      bindVarSpec.extend("rowid", cool_StorageType_TypeId::String4k);
