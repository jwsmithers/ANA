...
#define RELATIONALCOOL_RELATIONALCHANNELTABLE_H 1
...
namespace cool
{
  ...
  public:
    ...
    struct columnTypeIds {
      ...
      static const StorageType::TypeId lastObjectId = cool_StorageType_TypeId::UInt32;
      static const StorageType::TypeId hasNewData   = cool_StorageType_TypeId::Bool;
      static const StorageType::TypeId channelName  = cool_StorageType_TypeId::String255;
      static const StorageType::TypeId description  = cool_StorageType_TypeId::String255;
    };
