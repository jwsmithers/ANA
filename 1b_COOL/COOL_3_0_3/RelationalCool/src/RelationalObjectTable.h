...
#define RELATIONALCOOL_RELATIONALOBJECTTABLE_H 1
...
namespace cool
{
  ...
  public:
    ...
    struct columnTypeIds
    {
      ...
      static const StorageType::TypeId userTagId   = cool_StorageType_TypeId::UInt32;
      ...
      static const StorageType::TypeId originalId  = cool_StorageType_TypeId::UInt32;
      static const StorageType::TypeId newHeadId   = cool_StorageType_TypeId::UInt32;
      // SEPARATEPAYLOAD mode
      ...
      // VECTORPAYLOAD mode
      static const StorageType::TypeId payloadSize = cool_StorageType_TypeId::UInt32;
    };
  ...
  public:
    ...
    ( const coral::AttributeList& payload,
      PayloadMode::Mode mode = cool_PayloadMode_Mode::INLINEPAYLOAD );
