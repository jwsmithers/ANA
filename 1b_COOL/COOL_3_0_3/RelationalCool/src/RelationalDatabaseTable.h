...
namespace cool
{
  ...
  namespace RelationalDatabaseTable
  {
    ...
    {
      static const StorageType::TypeId attributeName = cool_StorageType_TypeId::String255;
      static const StorageType::TypeId attributeValue = cool_StorageType_TypeId::String4k;
    }
