...
namespace cool
{
  ...
  public:
    ...
    struct columnTypeIds {
      ...
      // vector payload mode
      static const StorageType::TypeId payloadItemId= cool_StorageType_TypeId::UInt32;
      static const StorageType::TypeId p_sysInsTime = cool_StorageType_TypeId::String255;
    };
