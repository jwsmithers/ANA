...
( RelationalObjectIterator& iterator,
  ...
  , m_objectId( aList[RelationalObjectTable::columnNames::objectId()]
                .data<unsigned int>() )
  , m_payloadId0( 0 )
  , m_payloadId( pMode == cool_PayloadMode_Mode::SEPARATEPAYLOAD ?
                 aList[RelationalObjectTable::columnNames::payloadId()].data<unsigned int>() :
                 m_payloadId0 )
  , m_payloadSetId( pMode == cool_PayloadMode_Mode::VECTORPAYLOAD ?
                    aList[RelationalObjectTable::columnNames::payloadSetId()].data<unsigned int>() :
                    m_payloadId0 )
  , m_payloadSize1( 1 )
  , m_payloadSize( pMode == cool_PayloadMode_Mode::VECTORPAYLOAD ?
