// $Id: RalSchemaValidation.cpp,v 1.19 2010-08-05 11:53:27 mwache Exp $
...
void RalSchemaValidation::i_checkNodes_28x()
{
...

  {
    ...
    if ( version201 !=
         std::string( RelationalFolder::folderSchemaVersion( PayloadMode::INLINEPAYLOAD ) ) )
    {
      std::stringstream msg;
      msg << "PANIC! Folder schema version for this software release is '"
          << RelationalFolder::folderSchemaVersion( PayloadMode::INLINEPAYLOAD )
    ...
    if ( version280 !=
         std::string( RelationalFolder::folderSchemaVersion( PayloadMode::SEPARATEPAYLOAD ) ) )
    {
      std::stringstream msg;
      msg << "PANIC! Folder schema version for this software release is '"
          << RelationalFolder::folderSchemaVersion( PayloadMode::SEPARATEPAYLOAD )
