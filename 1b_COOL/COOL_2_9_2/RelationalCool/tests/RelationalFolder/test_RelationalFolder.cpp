// $Id: test_RelationalFolder.cpp,v 1.307 2013-03-08 11:44:44 avalassi Exp $
...
public:
  ...
  {
    test_countObjects_channelName_MV_userTag( PayloadMode::INLINEPAYLOAD );
  }

  void test_countObjects_channelName_MV_userTag_sepPayload()
  {
    test_countObjects_channelName_MV_userTag( PayloadMode::SEPARATEPAYLOAD );
  }

  void test_countObjects_channelName_MV_userTag_vector()
  {
    test_countObjects_channelName_MV_userTag( PayloadMode::VECTORPAYLOAD );
  }
  ...
  {
    test_countObjects_channelName_MV_tag( PayloadMode::INLINEPAYLOAD );
  };

  void test_countObjects_channelName_MV_tag_sepPayload()
  {
    test_countObjects_channelName_MV_tag( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_countObjects_channelName_MV_tag_vector()
  {
    test_countObjects_channelName_MV_tag( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_countObjects_channelName_MV_all( PayloadMode::INLINEPAYLOAD );
  };

  void test_countObjects_channelName_MV_all_sepPayload()
  {
    test_countObjects_channelName_MV_all( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_countObjects_channelName_MV_all_vector()
  {
    test_countObjects_channelName_MV_all( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_findObjects_channelName_MV_userTag( PayloadMode::INLINEPAYLOAD );
  };

  void test_findObjects_channelName_MV_userTag_sepPayload()
  {
    test_findObjects_channelName_MV_userTag( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_findObjects_channelName_MV_userTag_vector()
  {
    test_findObjects_channelName_MV_userTag( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_findObjects_channelName_MV_tag( PayloadMode::INLINEPAYLOAD );
  };

  void test_findObjects_channelName_MV_tag_sepPayload()
  {
    test_findObjects_channelName_MV_tag( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_findObjects_channelName_MV_tag_vector()
  {
    test_findObjects_channelName_MV_tag( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_findObjects_channelName_MV( PayloadMode::INLINEPAYLOAD );
  };

  void test_findObjects_channelName_MV_sepPayload()
  {
    test_findObjects_channelName_MV( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_findObjects_channelName_MV_vector()
  {
    test_findObjects_channelName_MV( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_browseObjects_channelName_MV_userTag( PayloadMode::INLINEPAYLOAD );
  };

  void test_browseObjects_channelName_MV_userTag_sepPayload()
  {
    test_browseObjects_channelName_MV_userTag( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_browseObjects_channelName_MV_userTag_vector()
  {
    test_browseObjects_channelName_MV_userTag( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_browseObjects_channelName_MV_tag( PayloadMode::INLINEPAYLOAD );
  }

  void test_browseObjects_channelName_MV_tag_sepPayload()
  {
    test_browseObjects_channelName_MV_tag( PayloadMode::SEPARATEPAYLOAD );
  }

  void test_browseObjects_channelName_MV_tag_vector()
  {
    test_browseObjects_channelName_MV_tag( PayloadMode::VECTORPAYLOAD );
  }
  ...
  {
    test_browseObjects_channelName_MV_all( PayloadMode::INLINEPAYLOAD );
  };

  void test_browseObjects_channelName_MV_all_sepPayload()
  {
    test_browseObjects_channelName_MV_all( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_browseObjects_channelName_MV_all_vector()
  {
    test_browseObjects_channelName_MV_all( PayloadMode::VECTORPAYLOAD );
  };
  ...
  void test_storeObject_emptyRecord()
  {
    ...
    RecordSpecification payload40Spec; // reshuffle the order
    {
      ...
      payload40Spec.extend("S",StorageType::String4k);
    }
  ...
  void test_attribute_name_order_string()
  {
    ...
    spec.extend( "order", StorageType::String4k );
    FolderSpecification fSpec( FolderVersioning::SINGLE_VERSION, spec );
  ...
  {
    test_cloneHeadTag( PayloadMode::INLINEPAYLOAD );
  };

  void test_cloneHeadTag_sepPayload( )
  {
    test_cloneHeadTag( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_cloneHeadTag_vector( )
  {
    test_cloneHeadTag( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_userTag_example1( PayloadMode::INLINEPAYLOAD );
  };

  void test_userTag_example1_sepPayload()
  {
    test_userTag_example1( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_userTag_example1_vector()
  {
    test_userTag_example1( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_browseObjects_userTag( PayloadMode::INLINEPAYLOAD );
  };

  void test_browseObjects_userTag_sepPayload()
  {
    test_browseObjects_userTag( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_browseObjects_userTag_vector()
  {
    test_browseObjects_userTag( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_userTag_browseObjects_HEAD_insulation( PayloadMode::INLINEPAYLOAD );
  };

  void test_userTag_browseObjects_HEAD_insulation_sepPayload()
  {
    test_userTag_browseObjects_HEAD_insulation( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_userTag_browseObjects_HEAD_insulation_vector()
  {
    test_userTag_browseObjects_HEAD_insulation( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_objectCount_MV( PayloadMode::INLINEPAYLOAD );
  };

  void test_objectCount_MV_sepPayload()
  {
    test_objectCount_MV( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_objectCount_MV_vector()
  {
    test_objectCount_MV( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_browseObjects_MV_tag( PayloadMode::INLINEPAYLOAD );
  };

  void test_browseObjects_MV_tag_sepPayload()
  {
    test_browseObjects_MV_tag( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_browseObjects_MV_tag_vector()
  {
    test_browseObjects_MV_tag( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_browseObjects_MV( PayloadMode::INLINEPAYLOAD );
  };

  void test_browseObjects_MV_sepPayload()
  {
    test_browseObjects_MV( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_browseObjects_MV_vector()
  {
    test_browseObjects_MV( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_browseObjects_all_channels_MV( PayloadMode::INLINEPAYLOAD );
  };

  void test_browseObjects_all_channels_MV_sepPayload()
  {
    test_browseObjects_all_channels_MV( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_browseObjects_all_channels_MV_vector()
  {
    test_browseObjects_all_channels_MV( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_browseObjects_channel_range_MV( PayloadMode::INLINEPAYLOAD );
  };

  void test_browseObjects_channel_range_MV_sepPayload()
  {
    test_browseObjects_channel_range_MV( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_browseObjects_channel_range_MV_vector()
  {
    test_browseObjects_channel_range_MV( PayloadMode::VECTORPAYLOAD );
  };
  ...
  void test_browseObjects_SV_lowercasePayload()
  {
    ...
    FolderSpecification fSpec( FolderVersioning::SINGLE_VERSION, payloadSpecNew );
  ...
  void test_tagNameScope()
  {
    ...
    try {
      CPPUNIT_ASSERT_EQUAL_MESSAGE
        ( "tag1A scope", IHvsNode::LEAF_NODE, s_db->tagNameScope( tag1A ) );
      CPPUNIT_ASSERT_EQUAL_MESSAGE
        ( "tag1B scope", IHvsNode::LEAF_NODE, s_db->tagNameScope( tag1B ) );
      CPPUNIT_ASSERT_EQUAL_MESSAGE
        ( "tag1C scope", IHvsNode::LEAF_NODE, s_db->tagNameScope( tag1C ) );
      CPPUNIT_ASSERT_EQUAL_MESSAGE
        ( "tag2A scope", IHvsNode::LEAF_NODE, s_db->tagNameScope( tag2A ) );
      CPPUNIT_ASSERT_EQUAL_MESSAGE
        ( "tag2B scope", IHvsNode::LEAF_NODE, s_db->tagNameScope( tag2B ) );
      CPPUNIT_ASSERT_EQUAL_MESSAGE
        ( "tag2C scope", IHvsNode::LEAF_NODE, s_db->tagNameScope( tag2C ) );
    }
    catch ( std::exception& e ) {
      std::cout << "Exception caught: " << e.what() << std::endl;
      throw;
  ...
  {
    test_deleteTag_andRetag( PayloadMode::INLINEPAYLOAD );
  }

  void test_deleteTag_andRetag_sepPayload()
  {
    test_deleteTag_andRetag( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_deleteTag_andRetag_vector()
  {
    test_deleteTag_andRetag( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_MV_tag_and_retrieve( PayloadMode::INLINEPAYLOAD );
  };

  void test_MV_tag_and_retrieve_sepPayload()
  {
    test_MV_tag_and_retrieve( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_MV_tag_and_retrieve_vector()
  {
    test_MV_tag_and_retrieve( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_storeObject_bulk_MV( PayloadMode::INLINEPAYLOAD );
  };

  void test_storeObject_bulk_MV_sepPayload()
  {
    test_storeObject_bulk_MV( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_storeObject_bulk_MV_vector()
  {
    test_storeObject_bulk_MV( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_findObject_after_dropNode_MV( PayloadMode::INLINEPAYLOAD );
  };

  /// NB: INVOLVES DDL (SCHEMA MODIFICATIONS) DURING THE TEST.
  void test_findObject_after_dropNode_MV_sepPayload()
  {
    test_findObject_after_dropNode_MV( PayloadMode::SEPARATEPAYLOAD );
  };

  /// NB: INVOLVES DDL (SCHEMA MODIFICATIONS) DURING THE TEST.
  void test_findObject_after_dropNode_MV_vector()
  {
    test_findObject_after_dropNode_MV( PayloadMode::VECTORPAYLOAD );
  };
  ...
  {
    test_findObject_MV( PayloadMode::INLINEPAYLOAD );
  }

  void test_findObject_MV_sepPayload()
  {
    test_findObject_MV( PayloadMode::SEPARATEPAYLOAD );
  }

  void test_findObject_MV_vector()
  {
    test_findObject_MV( PayloadMode::VECTORPAYLOAD );
  }
  ...
  {
    test_renamePayload( PayloadMode::INLINEPAYLOAD );
  }

  /// NB: INVOLVES DDL (SCHEMA MODIFICATIONS) DURING THE TEST.
  void test_renamePayload_sepPayload()
  {
    test_renamePayload( PayloadMode::SEPARATEPAYLOAD );
  }

  void test_renamePayload_vector()
  {
    test_renamePayload( PayloadMode::VECTORPAYLOAD );
  }
  ...
  {
    test_extendPayloadSpecification( PayloadMode::INLINEPAYLOAD );
  };

  /// NB: INVOLVES DDL (SCHEMA MODIFICATIONS) DURING THE TEST.
  void test_extendPayloadSpecification_sepPayload()
  {
    test_extendPayloadSpecification( PayloadMode::SEPARATEPAYLOAD );
  };

  /// NB: INVOLVES DDL (SCHEMA MODIFICATIONS) DURING THE TEST.
  void test_extendPayloadSpecification_vector()
  {
    test_extendPayloadSpecification( PayloadMode::VECTORPAYLOAD );
  };
  ...
  void test_RecordSelectionBrowseObjects() {
    test_RecordSelectionBrowseObjects( PayloadMode::INLINEPAYLOAD );
  };

  void test_RecordSelectionBrowseObjects_sepPayload() {
    test_RecordSelectionBrowseObjects( PayloadMode::SEPARATEPAYLOAD );
  };

  void test_RecordSelectionBrowseObjects_vector() {
    //test_RecordSelectionBrowseObjects( PayloadMode::VECTORPAYLOAD );
  ...
  void test_clobOptimization()
  {
    ...
    spec.extend( "CLOB", StorageType::String64k ); // CLOB
    FolderSpecification fSpec( FolderVersioning::SINGLE_VERSION, spec );
    IFolderPtr f = s_db->createFolder( "/f", fSpec );
    CPPUNIT_ASSERT( s_db->existsFolder( "/f" ) );
    Record payload( spec );
  ...
  void test_clobShortWithLongName_bug64710()
  {
    ...
    try
    {
      RecordSpecification spec;
      spec.extend( "I", StorageType::Int32 );
      spec.extend( clobName, StorageType::String4k ); // String
      FolderSpecification fSpec( FolderVersioning::SINGLE_VERSION, spec );
    ...
    try
    {
      RecordSpecification spec;
      spec.extend( "I", StorageType::Int32 );
      spec.extend( clobName, StorageType::String64k ); // CLOB
      FolderSpecification fSpec( FolderVersioning::SINGLE_VERSION, spec );
  ...
  RelationalFolderTest() : CoolDBUnitTest(), payloadSpec()
  {
    ...
    payloadSpec.extend( "S", StorageType::String4k );
...
private:
...
#ifdef COOL290VP
    FolderSpecification fmSp( FolderVersioning::MULTI_VERSION, payloadSpec, PayloadMode::SEPARATEPAYLOAD );
#else
    FolderSpecification fmSp( FolderVersioning::MULTI_VERSION, payloadSpec, true );
#endif
    s_db->createFolder( "/fMVp", fmSp, "MV folder with payload table" );
    // Create the MV folder with vector payload
#ifdef COOL290VP
    FolderSpecification fmSv( FolderVersioning::MULTI_VERSION, payloadSpec, PayloadMode::VECTORPAYLOAD );
#else
    FolderSpecification fmSv( FolderVersioning::MULTI_VERSION, payloadSpec, true );
#endif
  ...
  std::string payloadMode2Folder( PayloadMode::Mode pMode )
  {
    if ( pMode == PayloadMode::INLINEPAYLOAD )
      return "/fMV";
    else if ( pMode == PayloadMode::SEPARATEPAYLOAD )
      return "/fMVp";
    else if ( pMode == PayloadMode::VECTORPAYLOAD )
      return "/fMVv";
    return "";
