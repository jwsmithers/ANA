// $Id: test_RalDatabase.cpp,v 1.326 2013-05-07 15:09:38 avalassi Exp $
...
public:
  ...
  void test_useFolder_2_0_0()
  {
    ...
    PayloadMode::Mode pMode = PayloadMode::INLINEPAYLOAD; // no payload table (default)
...
#pragma GCC diagnostic pop
#endif
    CPPUNIT_ASSERT_THROW( FolderSpecification( FolderVersioning::NONE, payloadSpec ), InvalidFolderSpecification ); // test bug #103343
  ...
  void test_createFolder_MV_sepPayload()
  {
    setupDb();
#ifdef COOL290VP
    FolderSpecification folderSpec( FolderVersioning::MULTI_VERSION, payloadSpec, PayloadMode::SEPARATEPAYLOAD );
#else
    FolderSpecification folderSpec( FolderVersioning::MULTI_VERSION, payloadSpec );
...
#ifdef COOL290VP
    setupDb();
    FolderSpecification folderSpec( FolderVersioning::MULTI_VERSION,
                                    payloadSpec,
