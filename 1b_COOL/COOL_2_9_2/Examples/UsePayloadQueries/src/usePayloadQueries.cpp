// $Id: usePayloadQueries.cpp,v 1.4 2009-12-17 18:55:03 avalassi Exp $
  ...
  void readExampleWithPayloadQueries()
  {
    try {
      ...
      FieldSelection selectXGreater0999(
                                        "X",StorageType::Float, FieldSelection::GT, (float)0.999);
      ...
      FieldSelection selectXLess0999(
                                     "X",StorageType::Float, FieldSelection::LT, (float)-0.999);

      CompositeSelection selectGreaterOrLess0999( &selectXGreater0999,
                                                  CompositeSelection::OR, &selectXLess0999);
