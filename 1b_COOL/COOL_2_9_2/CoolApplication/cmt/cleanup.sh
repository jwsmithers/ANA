# echo "cleanup CoolApplication v1 in /home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2"
...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=CoolApplication -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2  $* >${cmtCoolApplicationtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=CoolApplication -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2  $* >${cmtCoolApplicationtempfile}"
  cmtcleanupstatus=2
