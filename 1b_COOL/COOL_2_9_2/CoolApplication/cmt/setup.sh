...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=CoolApplication -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2  -no_cleanup $* >${cmtCoolApplicationtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=CoolApplication -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2  -no_cleanup $* >${cmtCoolApplicationtempfile}"
  cmtsetupstatus=2
