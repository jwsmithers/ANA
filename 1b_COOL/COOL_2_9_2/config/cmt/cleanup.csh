# echo "cleanup config v1 in /home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2"
...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=config -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2  $* >${cmtconfigtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=config -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2  $* >${cmtconfigtempfile}"
