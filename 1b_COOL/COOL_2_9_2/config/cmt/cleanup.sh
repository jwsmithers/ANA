...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=config -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2  $* >${cmtconfigtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=config -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2  $* >${cmtconfigtempfile}"
  cmtcleanupstatus=2
