...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=CoolDBDiscovery -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2/Utilities  $* >${cmtCoolDBDiscoverytempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=CoolDBDiscovery -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2/Utilities  $* >${cmtCoolDBDiscoverytempfile}"
  cmtcleanupstatus=2
