...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=ACE -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2/Utilities  -no_cleanup $* >${cmtACEtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=ACE -version=v1 -path=/home/jwsmith/HDD/ANA/ANA/1b_COOL/COOL_2_9_2/Utilities  -no_cleanup $* >${cmtACEtempfile}"
  cmtsetupstatus=2
